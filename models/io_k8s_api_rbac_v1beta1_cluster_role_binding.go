...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) validateRoleRef(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) validateSubjects(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1ClusterRoleBinding) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1beta1ClusterRoleBinding
