...
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIFlowcontrolV1alpha1FlowSchemaList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIFlowcontrolV1alpha1FlowSchemaList
