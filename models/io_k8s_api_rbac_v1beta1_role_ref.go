...
func (m *IoK8sAPIRbacV1beta1RoleRef) validateAPIGroup(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1RoleRef) validateKind(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1RoleRef) validateName(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1RoleRef) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1beta1RoleRef
