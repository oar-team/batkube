...
func (m *IoK8sAPIRbacV1RoleList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1RoleList
