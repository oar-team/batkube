...
func (m *IoK8sAPICoreV1ConfigMapList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ConfigMapList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ConfigMapList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ConfigMapList
