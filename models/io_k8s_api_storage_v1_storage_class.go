...
func (m *IoK8sAPIStorageV1StorageClass) validateAllowedTopologies(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1StorageClass) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1StorageClass) validateProvisioner(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1StorageClass) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1StorageClass
