...
func (m *IoK8sAPISchedulingV1PriorityClass) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPISchedulingV1PriorityClass) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPISchedulingV1PriorityClass) validateValue(formats strfmt.Registry) error {
...
func (m *IoK8sAPISchedulingV1PriorityClass) UnmarshalBinary(b []byte) error {
	var res IoK8sAPISchedulingV1PriorityClass
