...
// IoK8sAPIRbacV1alpha1Role Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 Role, and will no longer be served in v1.20.
//
...
func (m *IoK8sAPIRbacV1alpha1Role) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1Role) validateRules(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1Role) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1alpha1Role
