...
func (m *IoK8sAPICoreV1Pod) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Pod) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Pod) validateStatus(formats strfmt.Registry) error {
