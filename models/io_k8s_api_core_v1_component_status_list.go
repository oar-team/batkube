...
// IoK8sAPICoreV1ComponentStatusList Status of all the conditions for the component as a list of ComponentStatus objects.
//
...
func (m *IoK8sAPICoreV1ComponentStatusList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ComponentStatusList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ComponentStatusList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ComponentStatusList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ComponentStatusList
