...
func (m *IoK8sAPIAppsV1ReplicaSetList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1ReplicaSetList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1ReplicaSetList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1ReplicaSetList
