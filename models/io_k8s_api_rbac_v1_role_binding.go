...
func (m *IoK8sAPIRbacV1RoleBinding) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleBinding) validateRoleRef(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleBinding) validateSubjects(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleBinding) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1RoleBinding
