...
func (m *IoK8sAPICoordinationV1Lease) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1Lease) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1Lease) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoordinationV1Lease
