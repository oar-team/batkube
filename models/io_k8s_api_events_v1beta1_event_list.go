...
func (m *IoK8sAPIEventsV1beta1EventList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1beta1EventList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIEventsV1beta1EventList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIEventsV1beta1EventList
