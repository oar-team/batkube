...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceValidation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceValidation) validateOpenAPIV3Schema(formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceValidation) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceValidation) UnmarshalBinary(b []byte) error {
	var res IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceValidation
