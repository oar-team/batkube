...
func (m *IoK8sAPICoreV1CinderVolumeSource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1CinderVolumeSource) validateSecretRef(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1CinderVolumeSource) validateVolumeID(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1CinderVolumeSource) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1CinderVolumeSource
