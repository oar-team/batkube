...
func (m *IoK8sAPICoreV1ServiceAccountList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ServiceAccountList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ServiceAccountList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ServiceAccountList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ServiceAccountList
