...
func (m *IoK8sAPIRbacV1RoleRef) validateAPIGroup(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleRef) validateKind(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleRef) validateName(formats strfmt.Registry) error {
