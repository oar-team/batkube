...
func (m *IoK8sAPICoreV1NodeCondition) validateLastHeartbeatTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeCondition) validateLastTransitionTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeCondition) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeCondition) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1NodeCondition
