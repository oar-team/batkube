...
func (m *IoK8sAPIExtensionsV1beta1IngressRule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIExtensionsV1beta1IngressRule) validateHTTP(formats strfmt.Registry) error {
...
func (m *IoK8sAPIExtensionsV1beta1IngressRule) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIExtensionsV1beta1IngressRule
