...
func (m *IoK8sAPIStorageV1beta1VolumeAttachmentList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachmentList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachmentList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachmentList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1beta1VolumeAttachmentList
