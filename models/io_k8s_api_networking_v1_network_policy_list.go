...
func (m *IoK8sAPINetworkingV1NetworkPolicyList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1NetworkPolicyList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1NetworkPolicyList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1NetworkPolicyList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPINetworkingV1NetworkPolicyList
