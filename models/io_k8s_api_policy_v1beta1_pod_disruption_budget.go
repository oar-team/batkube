...
func (m *IoK8sAPIPolicyV1beta1PodDisruptionBudget) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIPolicyV1beta1PodDisruptionBudget) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIPolicyV1beta1PodDisruptionBudget) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIPolicyV1beta1PodDisruptionBudget) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIPolicyV1beta1PodDisruptionBudget) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIPolicyV1beta1PodDisruptionBudget
