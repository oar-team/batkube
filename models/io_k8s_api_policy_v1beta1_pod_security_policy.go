...
func (m *IoK8sAPIPolicyV1beta1PodSecurityPolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIPolicyV1beta1PodSecurityPolicy) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIPolicyV1beta1PodSecurityPolicy) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIPolicyV1beta1PodSecurityPolicy) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIPolicyV1beta1PodSecurityPolicy
