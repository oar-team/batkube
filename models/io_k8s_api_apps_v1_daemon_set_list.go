...
func (m *IoK8sAPIAppsV1DaemonSetList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSetList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSetList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1DaemonSetList
