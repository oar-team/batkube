...
// IoK8sAPIRbacV1alpha1ClusterRole ClusterRole is a cluster level, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding or ClusterRoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 ClusterRole, and will no longer be served in v1.20.
//
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) validateAggregationRule(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) validateRules(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1ClusterRole) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1alpha1ClusterRole
