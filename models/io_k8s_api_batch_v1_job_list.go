...
func (m *IoK8sAPIBatchV1JobList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIBatchV1JobList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIBatchV1JobList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIBatchV1JobList
