...
func (m *IoK8sAPIAppsV1DeploymentCondition) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1DeploymentCondition) validateLastTransitionTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentCondition) validateLastUpdateTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentCondition) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentCondition) validateType(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentCondition) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1DeploymentCondition
