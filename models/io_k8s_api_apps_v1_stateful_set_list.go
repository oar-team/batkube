...
func (m *IoK8sAPIAppsV1StatefulSetList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1StatefulSetList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1StatefulSetList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1StatefulSetList
