...
func (m *IoK8sAPICoreV1ResourceQuotaList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ResourceQuotaList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceQuotaList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceQuotaList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ResourceQuotaList
