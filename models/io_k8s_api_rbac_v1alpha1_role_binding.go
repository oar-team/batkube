...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) validateRoleRef(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) validateSubjects(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleBinding) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1alpha1RoleBinding
