...
func (m *IoK8sAPICoreV1ConfigMapVolumeSource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ConfigMapVolumeSource) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ConfigMapVolumeSource) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ConfigMapVolumeSource
