...
func (m *IoK8sAPIAppsV1ControllerRevisionList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1ControllerRevisionList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1ControllerRevisionList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1ControllerRevisionList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1ControllerRevisionList
