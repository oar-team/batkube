...
func (m *IoK8sAPICoreV1PodList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PodList) validateMetadata(formats strfmt.Registry) error {
