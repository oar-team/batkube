...
func (m *IoK8sAPIAutoscalingV2beta2MetricSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta2MetricSpec) validateExternal(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2MetricSpec) validateObject(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2MetricSpec) validatePods(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2MetricSpec) validateResource(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2MetricSpec) validateType(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta2MetricSpec) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAutoscalingV2beta2MetricSpec
