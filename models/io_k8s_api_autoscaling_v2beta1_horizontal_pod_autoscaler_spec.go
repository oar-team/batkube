...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerSpec) validateMaxReplicas(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerSpec) validateMetrics(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerSpec) validateScaleTargetRef(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerSpec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerSpec) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerSpec
