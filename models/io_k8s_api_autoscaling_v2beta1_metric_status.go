...
func (m *IoK8sAPIAutoscalingV2beta1MetricStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta1MetricStatus) validateExternal(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricStatus) validateObject(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricStatus) validatePods(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricStatus) validateResource(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricStatus) validateType(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricStatus) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAutoscalingV2beta1MetricStatus
