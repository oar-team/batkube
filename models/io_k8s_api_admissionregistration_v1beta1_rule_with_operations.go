...
func (m *IoK8sAPIAdmissionregistrationV1beta1RuleWithOperations) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *IoK8sAPIAdmissionregistrationV1beta1RuleWithOperations) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sAPIAdmissionregistrationV1beta1RuleWithOperations) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAdmissionregistrationV1beta1RuleWithOperations
