...
func (m *IoK8sAPINetworkingV1beta1HTTPIngressPath) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1beta1HTTPIngressPath) validateBackend(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1beta1HTTPIngressPath) UnmarshalBinary(b []byte) error {
	var res IoK8sAPINetworkingV1beta1HTTPIngressPath
