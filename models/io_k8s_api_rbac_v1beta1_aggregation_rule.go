...
func (m *IoK8sAPIRbacV1beta1AggregationRule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1beta1AggregationRule) validateClusterRoleSelectors(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1AggregationRule) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1beta1AggregationRule
