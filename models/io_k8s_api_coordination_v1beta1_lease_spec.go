...
func (m *IoK8sAPICoordinationV1beta1LeaseSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoordinationV1beta1LeaseSpec) validateAcquireTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1beta1LeaseSpec) validateRenewTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1beta1LeaseSpec) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoordinationV1beta1LeaseSpec
