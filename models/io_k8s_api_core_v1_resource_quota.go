...
func (m *IoK8sAPICoreV1ResourceQuota) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceQuota) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceQuota) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ResourceQuota) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ResourceQuota
