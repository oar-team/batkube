...
func (m *IoK8sAPIAppsV1DaemonSet) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSet) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSet) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSet) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1DaemonSet
