...
func (m *IoK8sAPIRbacV1Subject) validateKind(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1Subject) validateName(formats strfmt.Registry) error {
