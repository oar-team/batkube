...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus) validateCurrentMetrics(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus) validateCurrentReplicas(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus) validateDesiredReplicas(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus) validateLastScaleTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAutoscalingV2beta1HorizontalPodAutoscalerStatus
