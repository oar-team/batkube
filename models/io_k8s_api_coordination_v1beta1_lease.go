...
func (m *IoK8sAPICoordinationV1beta1Lease) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoordinationV1beta1Lease) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1beta1Lease) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1beta1Lease) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoordinationV1beta1Lease
