...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ExternalDocumentation) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ExternalDocumentation) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ExternalDocumentation) UnmarshalBinary(b []byte) error {
	var res IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ExternalDocumentation
