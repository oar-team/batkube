...
func (m *IoK8sAPINetworkingV1beta1Ingress) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPINetworkingV1beta1Ingress) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1beta1Ingress) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1beta1Ingress) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPINetworkingV1beta1Ingress) UnmarshalBinary(b []byte) error {
	var res IoK8sAPINetworkingV1beta1Ingress
