...
func (m *IoK8sAPICoreV1FlexPersistentVolumeSource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1FlexPersistentVolumeSource) validateDriver(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1FlexPersistentVolumeSource) validateSecretRef(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1FlexPersistentVolumeSource) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1FlexPersistentVolumeSource
