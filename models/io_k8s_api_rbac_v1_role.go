...
func (m *IoK8sAPIRbacV1Role) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1Role) validateRules(formats strfmt.Registry) error {
