...
func (m *IoK8sAPIRbacV1beta1Subject) validateKind(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1Subject) validateName(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1beta1Subject) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1beta1Subject
