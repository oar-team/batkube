...
func (m *IoK8sAPIAppsV1DaemonSetCondition) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAppsV1DaemonSetCondition) validateLastTransitionTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSetCondition) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSetCondition) validateType(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DaemonSetCondition) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1DaemonSetCondition
