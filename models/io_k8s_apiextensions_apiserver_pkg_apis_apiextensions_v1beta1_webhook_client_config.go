...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig) validateService(formats strfmt.Registry) error {
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig) UnmarshalBinary(b []byte) error {
	var res IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1WebhookClientConfig
