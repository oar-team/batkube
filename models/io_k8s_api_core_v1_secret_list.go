...
func (m *IoK8sAPICoreV1SecretList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1SecretList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1SecretList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1SecretList
