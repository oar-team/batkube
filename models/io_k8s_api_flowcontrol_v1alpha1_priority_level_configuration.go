...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIFlowcontrolV1alpha1PriorityLevelConfiguration
