...
func (m *IoK8sAPIStorageV1beta1CSIDriverList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1beta1CSIDriverList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1beta1CSIDriverList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1beta1CSIDriverList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1beta1CSIDriverList
