...
func (m *IoK8sAPICoreV1PodTemplateList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PodTemplateList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PodTemplateList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1PodTemplateList
