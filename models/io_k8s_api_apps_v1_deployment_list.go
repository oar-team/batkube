...
func (m *IoK8sAPIAppsV1DeploymentList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1DeploymentList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1DeploymentList
