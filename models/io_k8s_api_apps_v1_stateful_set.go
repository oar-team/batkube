...
func (m *IoK8sAPIAppsV1StatefulSet) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1StatefulSet) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1StatefulSet) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1StatefulSet) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1StatefulSet
