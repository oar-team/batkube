...
func (m *IoK8sAPICoreV1LimitRangeList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1LimitRangeList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1LimitRangeList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1LimitRangeList
