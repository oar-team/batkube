...
func (m *IoK8sAPIStorageV1VolumeAttachmentList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1VolumeAttachmentList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1VolumeAttachmentList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1VolumeAttachmentList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1VolumeAttachmentList
