...
func (m *IoK8sAPIStorageV1CSINodeList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1CSINodeList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1CSINodeList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1CSINodeList
