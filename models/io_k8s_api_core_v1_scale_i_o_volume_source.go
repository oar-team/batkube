...
func (m *IoK8sAPICoreV1ScaleIOVolumeSource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ScaleIOVolumeSource) validateGateway(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ScaleIOVolumeSource) validateSecretRef(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ScaleIOVolumeSource) validateSystem(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ScaleIOVolumeSource) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ScaleIOVolumeSource
