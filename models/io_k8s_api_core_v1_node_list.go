...
func (m *IoK8sAPICoreV1NodeList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1NodeList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1NodeList
