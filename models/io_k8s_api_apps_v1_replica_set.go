...
func (m *IoK8sAPIAppsV1ReplicaSet) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1ReplicaSet) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1ReplicaSet) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAppsV1ReplicaSet) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAppsV1ReplicaSet
