...
func (m *IoK8sAPICoreV1ConfigMapProjection) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ConfigMapProjection) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ConfigMapProjection) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ConfigMapProjection
