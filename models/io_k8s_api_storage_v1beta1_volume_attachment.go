...
func (m *IoK8sAPIStorageV1beta1VolumeAttachment) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachment) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachment) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachment) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1beta1VolumeAttachment) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1beta1VolumeAttachment
