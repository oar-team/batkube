...
func (m *IoK8sAPISettingsV1alpha1PodPresetList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPISettingsV1alpha1PodPresetList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPISettingsV1alpha1PodPresetList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPISettingsV1alpha1PodPresetList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPISettingsV1alpha1PodPresetList
