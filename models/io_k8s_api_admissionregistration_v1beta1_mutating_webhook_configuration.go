...
func (m *IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfiguration) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfiguration) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfiguration) validateWebhooks(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfiguration) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfiguration) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAdmissionregistrationV1beta1MutatingWebhookConfiguration
