...
func (m *IoK8sAPICoreV1ReplicationControllerCondition) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ReplicationControllerCondition) validateLastTransitionTime(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ReplicationControllerCondition) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ReplicationControllerCondition) validateType(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ReplicationControllerCondition) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IoK8sAPICoreV1ReplicationControllerCondition) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ReplicationControllerCondition
