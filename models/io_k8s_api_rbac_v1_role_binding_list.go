...
func (m *IoK8sAPIRbacV1RoleBindingList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleBindingList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1RoleBindingList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1RoleBindingList
