...
func (m *IoK8sAPICoreV1EndpointsList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1EndpointsList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1EndpointsList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1EndpointsList
