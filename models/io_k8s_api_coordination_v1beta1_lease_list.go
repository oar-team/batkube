...
func (m *IoK8sAPICoordinationV1beta1LeaseList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoordinationV1beta1LeaseList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1beta1LeaseList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoordinationV1beta1LeaseList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoordinationV1beta1LeaseList
