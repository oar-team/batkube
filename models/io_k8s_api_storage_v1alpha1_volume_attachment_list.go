...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachmentList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachmentList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachmentList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachmentList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1alpha1VolumeAttachmentList
