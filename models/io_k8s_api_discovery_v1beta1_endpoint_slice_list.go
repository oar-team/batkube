...
func (m *IoK8sAPIDiscoveryV1beta1EndpointSliceList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIDiscoveryV1beta1EndpointSliceList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIDiscoveryV1beta1EndpointSliceList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIDiscoveryV1beta1EndpointSliceList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIDiscoveryV1beta1EndpointSliceList
