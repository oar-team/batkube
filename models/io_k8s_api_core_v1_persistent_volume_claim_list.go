...
func (m *IoK8sAPICoreV1PersistentVolumeClaimList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1PersistentVolumeClaimList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PersistentVolumeClaimList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1PersistentVolumeClaimList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1PersistentVolumeClaimList
