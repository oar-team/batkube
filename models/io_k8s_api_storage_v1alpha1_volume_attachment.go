...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachment) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachment) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachment) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachment) validateStatus(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1alpha1VolumeAttachment) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1alpha1VolumeAttachment
