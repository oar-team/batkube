...
func (m *IoK8sAPIRbacV1ClusterRoleBindingList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIRbacV1ClusterRoleBindingList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRoleBindingList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRoleBindingList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1ClusterRoleBindingList
