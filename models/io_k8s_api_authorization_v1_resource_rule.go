...
func (m *IoK8sAPIAuthorizationV1ResourceRule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAuthorizationV1ResourceRule) validateVerbs(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAuthorizationV1ResourceRule) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAuthorizationV1ResourceRule
