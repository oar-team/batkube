...
func (m *IoK8sAPICoreV1EventList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1EventList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1EventList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1EventList
