...
func (m *IoK8sAPIAutoscalingV2beta1MetricSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIAutoscalingV2beta1MetricSpec) validateExternal(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricSpec) validateObject(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricSpec) validatePods(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricSpec) validateResource(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricSpec) validateType(formats strfmt.Registry) error {
...
func (m *IoK8sAPIAutoscalingV2beta1MetricSpec) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIAutoscalingV2beta1MetricSpec
