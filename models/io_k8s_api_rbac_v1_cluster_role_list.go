...
func (m *IoK8sAPIRbacV1ClusterRoleList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRoleList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1ClusterRoleList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1ClusterRoleList
