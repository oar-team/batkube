...
func (m *IoK8sAPICoreV1ReplicationControllerList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPICoreV1ReplicationControllerList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ReplicationControllerList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1ReplicationControllerList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPICoreV1ReplicationControllerList
