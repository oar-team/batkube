...
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) validateAttachError(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) validateAttached(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) validateDetachError(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1VolumeAttachmentStatus) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1VolumeAttachmentStatus
