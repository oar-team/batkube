...
func (m *IoK8sAPIStorageV1CSIDriverList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1CSIDriverList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIStorageV1CSIDriverList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIStorageV1CSIDriverList
