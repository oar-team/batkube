...
func (m *IoK8sAPICoreV1Node) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Node) validateSpec(formats strfmt.Registry) error {
...
func (m *IoK8sAPICoreV1Node) validateStatus(formats strfmt.Registry) error {
