...
// IoK8sAPIRbacV1alpha1RoleList RoleList is a collection of Roles. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 RoleList, and will no longer be served in v1.20.
//
...
func (m *IoK8sAPIRbacV1alpha1RoleList) validateItems(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleList) validateMetadata(formats strfmt.Registry) error {
...
func (m *IoK8sAPIRbacV1alpha1RoleList) UnmarshalBinary(b []byte) error {
	var res IoK8sAPIRbacV1alpha1RoleList
