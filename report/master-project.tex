...
\chapter{Kubernetes and the scheduling problem}
...
The Cloud Native Computing Foundation\footnote{\url{https://www.cncf.io/}} was
founded in the intent of leveraging the container technology for a overall
better web.
This is the definition of Cloud Native Computing according to the CNCF :
...
The basic processing unit of Kubernetes is called a \textbf{pod}. A pod is
composed of one or several containers and volumes (A volume is some storage
...
api server like user interactions through kubectl or scheduling operations.
...
A general definition of HPC - which can also be applied to HPDA - would be :
...
with a container driven approach. Kubernetes is now the standard for AI and
Machine Learning as shown by the many efforts at making it an efficient
environment\cite{lee2017design}\cite{233001}\cite{10.1145/3154842.3154845}, and
many believe it represents the future of HPC aswell.
