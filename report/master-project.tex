...
which is a set of jobs  to be executed - the tasks arre called jobs in this
...
infrastructure to try and predict is performances on this particular situation,
evaluating a scheduler often boils down to testing it against real scenarios -
that is to say with a real workload, on a real infrastructure.
