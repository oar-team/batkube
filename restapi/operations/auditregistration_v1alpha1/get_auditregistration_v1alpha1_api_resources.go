...
type GetAuditregistrationV1alpha1APIResourcesHandlerFunc func(GetAuditregistrationV1alpha1APIResourcesParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAuditregistrationV1alpha1APIResourcesHandlerFunc) Handle(params GetAuditregistrationV1alpha1APIResourcesParams) middleware.Responder {
	return fn(params)
}
...
type GetAuditregistrationV1alpha1APIResourcesHandler interface {
	Handle(GetAuditregistrationV1alpha1APIResourcesParams) middleware.Responder
}
