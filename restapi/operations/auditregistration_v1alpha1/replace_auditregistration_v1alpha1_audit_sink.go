...
type ReplaceAuditregistrationV1alpha1AuditSinkHandlerFunc func(ReplaceAuditregistrationV1alpha1AuditSinkParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceAuditregistrationV1alpha1AuditSinkHandlerFunc) Handle(params ReplaceAuditregistrationV1alpha1AuditSinkParams) middleware.Responder {
	return fn(params)
}
...
type ReplaceAuditregistrationV1alpha1AuditSinkHandler interface {
	Handle(ReplaceAuditregistrationV1alpha1AuditSinkParams) middleware.Responder
}
