...
// DeleteAuditregistrationV1alpha1CollectionAuditSinkURL generates an URL for the delete auditregistration v1alpha1 collection audit sink operation
type DeleteAuditregistrationV1alpha1CollectionAuditSinkURL struct {
...
func (o *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL) WithBasePath(bp string) *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/auditregistration.k8s.io/v1alpha1/auditsinks"
...
func (o *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteAuditregistrationV1alpha1CollectionAuditSinkURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteAuditregistrationV1alpha1CollectionAuditSinkURL")
	}
...
func (o *DeleteAuditregistrationV1alpha1CollectionAuditSinkURL) StringFull(scheme, host string) string {
