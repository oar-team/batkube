...
type CreateAuditregistrationV1alpha1AuditSinkHandlerFunc func(CreateAuditregistrationV1alpha1AuditSinkParams) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateAuditregistrationV1alpha1AuditSinkHandlerFunc) Handle(params CreateAuditregistrationV1alpha1AuditSinkParams) middleware.Responder {
	return fn(params)
}
...
type CreateAuditregistrationV1alpha1AuditSinkHandler interface {
	Handle(CreateAuditregistrationV1alpha1AuditSinkParams) middleware.Responder
}
