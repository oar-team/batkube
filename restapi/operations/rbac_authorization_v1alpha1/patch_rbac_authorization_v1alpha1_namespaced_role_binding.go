...
type PatchRbacAuthorizationV1alpha1NamespacedRoleBindingHandlerFunc func(PatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchRbacAuthorizationV1alpha1NamespacedRoleBindingHandlerFunc) Handle(params PatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type PatchRbacAuthorizationV1alpha1NamespacedRoleBindingHandler interface {
	Handle(PatchRbacAuthorizationV1alpha1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
