...
type WatchRbacAuthorizationV1alpha1NamespacedRoleListHandlerFunc func(WatchRbacAuthorizationV1alpha1NamespacedRoleListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1alpha1NamespacedRoleListHandlerFunc) Handle(params WatchRbacAuthorizationV1alpha1NamespacedRoleListParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1alpha1NamespacedRoleListHandler interface {
	Handle(WatchRbacAuthorizationV1alpha1NamespacedRoleListParams, interface{}) middleware.Responder
}
