...
func NewDeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding(ctx *middleware.Context, handler DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingHandler) *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding {
	return &DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding{Context: ctx, Handler: handler}
}

/*DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding swagger:route DELETE /apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings rbacAuthorization_v1alpha1 deleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding

delete collection of RoleBinding

*/
type DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding struct {
	Context *middleware.Context
	Handler DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingHandler
}

func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
