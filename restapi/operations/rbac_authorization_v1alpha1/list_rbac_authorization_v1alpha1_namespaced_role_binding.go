...
type ListRbacAuthorizationV1alpha1NamespacedRoleBindingHandlerFunc func(ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1alpha1NamespacedRoleBindingHandlerFunc) Handle(params ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1alpha1NamespacedRoleBindingHandler interface {
	Handle(ListRbacAuthorizationV1alpha1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
