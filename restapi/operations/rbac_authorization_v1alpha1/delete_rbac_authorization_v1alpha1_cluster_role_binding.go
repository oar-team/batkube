...
type DeleteRbacAuthorizationV1alpha1ClusterRoleBindingHandlerFunc func(DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1alpha1ClusterRoleBindingHandlerFunc) Handle(params DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1alpha1ClusterRoleBindingHandler interface {
	Handle(DeleteRbacAuthorizationV1alpha1ClusterRoleBindingParams, interface{}) middleware.Responder
}
