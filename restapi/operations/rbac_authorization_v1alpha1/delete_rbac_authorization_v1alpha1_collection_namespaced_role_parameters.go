...
// NewDeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams creates a new DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams object
...
func NewDeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams() DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams {
	...
	return DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams{}
}

// DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams contains all the bound params for the delete rbac authorization v1alpha1 collection namespaced role operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteRbacAuthorizationV1alpha1CollectionNamespacedRole
...
//
// To ensure default values, the struct must have been initialized with NewDeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams() beforehand.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindDryRun binds and validates parameter DryRun from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validatePropagationPolicy(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleParams) validateWatch(formats strfmt.Registry) error {
