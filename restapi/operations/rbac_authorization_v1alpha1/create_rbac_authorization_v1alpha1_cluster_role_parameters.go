...
// CreateRbacAuthorizationV1alpha1ClusterRoleParams contains all the bound params for the create rbac authorization v1alpha1 cluster role operation
// typically these are obtained from a http.Request
//
// swagger:parameters createRbacAuthorizationV1alpha1ClusterRole
...
//
// To ensure default values, the struct must have been initialized with NewCreateRbacAuthorizationV1alpha1ClusterRoleParams() beforehand.
func (o *CreateRbacAuthorizationV1alpha1ClusterRoleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateRbacAuthorizationV1alpha1ClusterRoleParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateRbacAuthorizationV1alpha1ClusterRoleParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateRbacAuthorizationV1alpha1ClusterRoleParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1alpha1ClusterRoleParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateRbacAuthorizationV1alpha1ClusterRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1alpha1ClusterRoleParams) validatePretty(formats strfmt.Registry) error {
