...
// NewDeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams creates a new DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams object
...
func NewDeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams() DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams {
	...
	return DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams{}
}

// DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams contains all the bound params for the delete rbac authorization v1alpha1 collection namespaced role binding operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBinding
...
//
// To ensure default values, the struct must have been initialized with NewDeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams() beforehand.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindDryRun binds and validates parameter DryRun from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validatePropagationPolicy(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1alpha1CollectionNamespacedRoleBindingParams) validateWatch(formats strfmt.Registry) error {
