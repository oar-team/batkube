...
type WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListHandlerFunc func(WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListHandlerFunc) Handle(params WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListHandler interface {
	Handle(WatchRbacAuthorizationV1alpha1NamespacedRoleBindingListParams, interface{}) middleware.Responder
}
