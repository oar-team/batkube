...
// NewWatchRbacAuthorizationV1alpha1ClusterRoleListParams creates a new WatchRbacAuthorizationV1alpha1ClusterRoleListParams object
// no default values defined in spec.
func NewWatchRbacAuthorizationV1alpha1ClusterRoleListParams() WatchRbacAuthorizationV1alpha1ClusterRoleListParams {

	return WatchRbacAuthorizationV1alpha1ClusterRoleListParams{}
}

// WatchRbacAuthorizationV1alpha1ClusterRoleListParams contains all the bound params for the watch rbac authorization v1alpha1 cluster role list operation
// typically these are obtained from a http.Request
//
// swagger:parameters watchRbacAuthorizationV1alpha1ClusterRoleList
...
//
// To ensure default values, the struct must have been initialized with NewWatchRbacAuthorizationV1alpha1ClusterRoleListParams() beforehand.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1alpha1ClusterRoleListParams) validateWatch(formats strfmt.Registry) error {
