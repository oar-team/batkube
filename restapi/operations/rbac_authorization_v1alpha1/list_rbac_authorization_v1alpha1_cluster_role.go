...
type ListRbacAuthorizationV1alpha1ClusterRoleHandlerFunc func(ListRbacAuthorizationV1alpha1ClusterRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1alpha1ClusterRoleHandlerFunc) Handle(params ListRbacAuthorizationV1alpha1ClusterRoleParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1alpha1ClusterRoleHandler interface {
	Handle(ListRbacAuthorizationV1alpha1ClusterRoleParams, interface{}) middleware.Responder
}
