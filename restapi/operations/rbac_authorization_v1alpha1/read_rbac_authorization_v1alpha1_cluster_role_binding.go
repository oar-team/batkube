...
type ReadRbacAuthorizationV1alpha1ClusterRoleBindingHandlerFunc func(ReadRbacAuthorizationV1alpha1ClusterRoleBindingParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadRbacAuthorizationV1alpha1ClusterRoleBindingHandlerFunc) Handle(params ReadRbacAuthorizationV1alpha1ClusterRoleBindingParams) middleware.Responder {
	return fn(params)
}
...
type ReadRbacAuthorizationV1alpha1ClusterRoleBindingHandler interface {
	Handle(ReadRbacAuthorizationV1alpha1ClusterRoleBindingParams) middleware.Responder
}
