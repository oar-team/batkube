...
type DeleteRbacAuthorizationV1alpha1NamespacedRoleHandlerFunc func(DeleteRbacAuthorizationV1alpha1NamespacedRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1alpha1NamespacedRoleHandlerFunc) Handle(params DeleteRbacAuthorizationV1alpha1NamespacedRoleParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1alpha1NamespacedRoleHandler interface {
	Handle(DeleteRbacAuthorizationV1alpha1NamespacedRoleParams, interface{}) middleware.Responder
}
