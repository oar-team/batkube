...
type ReplaceRbacAuthorizationV1alpha1ClusterRoleBindingHandlerFunc func(ReplaceRbacAuthorizationV1alpha1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceRbacAuthorizationV1alpha1ClusterRoleBindingHandlerFunc) Handle(params ReplaceRbacAuthorizationV1alpha1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type ReplaceRbacAuthorizationV1alpha1ClusterRoleBindingHandler interface {
	Handle(ReplaceRbacAuthorizationV1alpha1ClusterRoleBindingParams, interface{}) middleware.Responder
}
