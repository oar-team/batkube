...
// NewPatchStorageV1beta1CSIDriverParams creates a new PatchStorageV1beta1CSIDriverParams object
// no default values defined in spec.
func NewPatchStorageV1beta1CSIDriverParams() PatchStorageV1beta1CSIDriverParams {

	return PatchStorageV1beta1CSIDriverParams{}
}

// PatchStorageV1beta1CSIDriverParams contains all the bound params for the patch storage v1beta1 c s i driver operation
...
func (o *PatchStorageV1beta1CSIDriverParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchStorageV1beta1CSIDriverParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchStorageV1beta1CSIDriverParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSIDriverParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchStorageV1beta1CSIDriverParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSIDriverParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchStorageV1beta1CSIDriverParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSIDriverParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchStorageV1beta1CSIDriverParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSIDriverParams) validatePretty(formats strfmt.Registry) error {
