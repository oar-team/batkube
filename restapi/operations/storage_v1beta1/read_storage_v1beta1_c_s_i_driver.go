...
type ReadStorageV1beta1CSIDriverHandlerFunc func(ReadStorageV1beta1CSIDriverParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadStorageV1beta1CSIDriverHandlerFunc) Handle(params ReadStorageV1beta1CSIDriverParams, principal interface{}) middleware.Responder {
...
type ReadStorageV1beta1CSIDriverHandler interface {
	Handle(ReadStorageV1beta1CSIDriverParams, interface{}) middleware.Responder
}
