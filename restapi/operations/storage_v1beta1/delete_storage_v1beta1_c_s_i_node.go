...
type DeleteStorageV1beta1CSINodeHandlerFunc func(DeleteStorageV1beta1CSINodeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteStorageV1beta1CSINodeHandlerFunc) Handle(params DeleteStorageV1beta1CSINodeParams, principal interface{}) middleware.Responder {
...
type DeleteStorageV1beta1CSINodeHandler interface {
	Handle(DeleteStorageV1beta1CSINodeParams, interface{}) middleware.Responder
}
