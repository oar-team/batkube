...
type ReadStorageV1beta1VolumeAttachmentHandlerFunc func(ReadStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadStorageV1beta1VolumeAttachmentHandlerFunc) Handle(params ReadStorageV1beta1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type ReadStorageV1beta1VolumeAttachmentHandler interface {
	Handle(ReadStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder
}
...
func NewReadStorageV1beta1VolumeAttachment(ctx *middleware.Context, handler ReadStorageV1beta1VolumeAttachmentHandler) *ReadStorageV1beta1VolumeAttachment {
	return &ReadStorageV1beta1VolumeAttachment{Context: ctx, Handler: handler}
}
...
func (o *ReadStorageV1beta1VolumeAttachment) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewReadStorageV1beta1VolumeAttachmentParams()
