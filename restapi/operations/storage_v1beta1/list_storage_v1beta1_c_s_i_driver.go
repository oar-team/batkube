...
type ListStorageV1beta1CSIDriverHandlerFunc func(ListStorageV1beta1CSIDriverParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListStorageV1beta1CSIDriverHandlerFunc) Handle(params ListStorageV1beta1CSIDriverParams, principal interface{}) middleware.Responder {
...
type ListStorageV1beta1CSIDriverHandler interface {
	Handle(ListStorageV1beta1CSIDriverParams, interface{}) middleware.Responder
}
