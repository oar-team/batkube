...
// NewCreateStorageV1beta1VolumeAttachmentParams creates a new CreateStorageV1beta1VolumeAttachmentParams object
// no default values defined in spec.
func NewCreateStorageV1beta1VolumeAttachmentParams() CreateStorageV1beta1VolumeAttachmentParams {

	return CreateStorageV1beta1VolumeAttachmentParams{}
}

// CreateStorageV1beta1VolumeAttachmentParams contains all the bound params for the create storage v1beta1 volume attachment operation
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateStorageV1beta1VolumeAttachmentParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateStorageV1beta1VolumeAttachmentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateStorageV1beta1VolumeAttachmentParams) validatePretty(formats strfmt.Registry) error {
