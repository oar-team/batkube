...
type WatchStorageV1beta1CSINodeListHandlerFunc func(WatchStorageV1beta1CSINodeListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1beta1CSINodeListHandlerFunc) Handle(params WatchStorageV1beta1CSINodeListParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1beta1CSINodeListHandler interface {
	Handle(WatchStorageV1beta1CSINodeListParams, interface{}) middleware.Responder
}
