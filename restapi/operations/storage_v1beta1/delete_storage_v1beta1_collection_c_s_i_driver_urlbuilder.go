...
// DeleteStorageV1beta1CollectionCSIDriverURL generates an URL for the delete storage v1beta1 collection c s i driver operation
type DeleteStorageV1beta1CollectionCSIDriverURL struct {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverURL) WithBasePath(bp string) *DeleteStorageV1beta1CollectionCSIDriverURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteStorageV1beta1CollectionCSIDriverURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteStorageV1beta1CollectionCSIDriverURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/storage.k8s.io/v1beta1/csidrivers"
...
func (o *DeleteStorageV1beta1CollectionCSIDriverURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteStorageV1beta1CollectionCSIDriverURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteStorageV1beta1CollectionCSIDriverURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteStorageV1beta1CollectionCSIDriverURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteStorageV1beta1CollectionCSIDriverURL")
	}
...
func (o *DeleteStorageV1beta1CollectionCSIDriverURL) StringFull(scheme, host string) string {
