...
type DeleteStorageV1beta1CollectionStorageClassHandlerFunc func(DeleteStorageV1beta1CollectionStorageClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteStorageV1beta1CollectionStorageClassHandlerFunc) Handle(params DeleteStorageV1beta1CollectionStorageClassParams, principal interface{}) middleware.Responder {
...
type DeleteStorageV1beta1CollectionStorageClassHandler interface {
	Handle(DeleteStorageV1beta1CollectionStorageClassParams, interface{}) middleware.Responder
}
