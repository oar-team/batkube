...
type CreateStorageV1beta1VolumeAttachmentHandlerFunc func(CreateStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateStorageV1beta1VolumeAttachmentHandlerFunc) Handle(params CreateStorageV1beta1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type CreateStorageV1beta1VolumeAttachmentHandler interface {
	Handle(CreateStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder
}
