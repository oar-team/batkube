...
type ListStorageV1beta1StorageClassHandlerFunc func(ListStorageV1beta1StorageClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListStorageV1beta1StorageClassHandlerFunc) Handle(params ListStorageV1beta1StorageClassParams, principal interface{}) middleware.Responder {
...
type ListStorageV1beta1StorageClassHandler interface {
	Handle(ListStorageV1beta1StorageClassParams, interface{}) middleware.Responder
}
