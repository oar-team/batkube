...
type GetStorageV1beta1APIResourcesHandlerFunc func(GetStorageV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetStorageV1beta1APIResourcesHandlerFunc) Handle(params GetStorageV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetStorageV1beta1APIResourcesHandler interface {
	Handle(GetStorageV1beta1APIResourcesParams, interface{}) middleware.Responder
}
