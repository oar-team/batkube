...
type WatchStorageV1beta1CSIDriverHandlerFunc func(WatchStorageV1beta1CSIDriverParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1beta1CSIDriverHandlerFunc) Handle(params WatchStorageV1beta1CSIDriverParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1beta1CSIDriverHandler interface {
	Handle(WatchStorageV1beta1CSIDriverParams, interface{}) middleware.Responder
}
