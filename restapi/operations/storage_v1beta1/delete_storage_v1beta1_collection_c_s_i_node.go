...
type DeleteStorageV1beta1CollectionCSINodeHandlerFunc func(DeleteStorageV1beta1CollectionCSINodeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteStorageV1beta1CollectionCSINodeHandlerFunc) Handle(params DeleteStorageV1beta1CollectionCSINodeParams, principal interface{}) middleware.Responder {
...
type DeleteStorageV1beta1CollectionCSINodeHandler interface {
	Handle(DeleteStorageV1beta1CollectionCSINodeParams, interface{}) middleware.Responder
}
