...
// NewPatchStorageV1beta1CSINodeParams creates a new PatchStorageV1beta1CSINodeParams object
// no default values defined in spec.
func NewPatchStorageV1beta1CSINodeParams() PatchStorageV1beta1CSINodeParams {

	return PatchStorageV1beta1CSINodeParams{}
}

// PatchStorageV1beta1CSINodeParams contains all the bound params for the patch storage v1beta1 c s i node operation
...
func (o *PatchStorageV1beta1CSINodeParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchStorageV1beta1CSINodeParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchStorageV1beta1CSINodeParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSINodeParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchStorageV1beta1CSINodeParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSINodeParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchStorageV1beta1CSINodeParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSINodeParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchStorageV1beta1CSINodeParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1beta1CSINodeParams) validatePretty(formats strfmt.Registry) error {
