...
// NewReplaceStorageV1beta1VolumeAttachmentParams creates a new ReplaceStorageV1beta1VolumeAttachmentParams object
// no default values defined in spec.
func NewReplaceStorageV1beta1VolumeAttachmentParams() ReplaceStorageV1beta1VolumeAttachmentParams {

	return ReplaceStorageV1beta1VolumeAttachmentParams{}
}

// ReplaceStorageV1beta1VolumeAttachmentParams contains all the bound params for the replace storage v1beta1 volume attachment operation
...
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPIStorageV1beta1VolumeAttachment
...
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceStorageV1beta1VolumeAttachmentParams) validatePretty(formats strfmt.Registry) error {
