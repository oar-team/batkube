...
type DeleteStorageV1beta1VolumeAttachmentHandlerFunc func(DeleteStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteStorageV1beta1VolumeAttachmentHandlerFunc) Handle(params DeleteStorageV1beta1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type DeleteStorageV1beta1VolumeAttachmentHandler interface {
	Handle(DeleteStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder
}
