...
type PatchStorageV1beta1VolumeAttachmentHandlerFunc func(PatchStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchStorageV1beta1VolumeAttachmentHandlerFunc) Handle(params PatchStorageV1beta1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type PatchStorageV1beta1VolumeAttachmentHandler interface {
	Handle(PatchStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder
}
