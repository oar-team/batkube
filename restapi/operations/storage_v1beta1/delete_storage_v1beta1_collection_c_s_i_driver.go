...
type DeleteStorageV1beta1CollectionCSIDriverHandlerFunc func(DeleteStorageV1beta1CollectionCSIDriverParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteStorageV1beta1CollectionCSIDriverHandlerFunc) Handle(params DeleteStorageV1beta1CollectionCSIDriverParams, principal interface{}) middleware.Responder {
...
type DeleteStorageV1beta1CollectionCSIDriverHandler interface {
	Handle(DeleteStorageV1beta1CollectionCSIDriverParams, interface{}) middleware.Responder
}
