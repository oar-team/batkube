...
type WatchStorageV1beta1CSINodeHandlerFunc func(WatchStorageV1beta1CSINodeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1beta1CSINodeHandlerFunc) Handle(params WatchStorageV1beta1CSINodeParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1beta1CSINodeHandler interface {
	Handle(WatchStorageV1beta1CSINodeParams, interface{}) middleware.Responder
}
