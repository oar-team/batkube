...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteStorageV1beta1CollectionCSINodeParams) validateWatch(formats strfmt.Registry) error {
