...
type WatchStorageV1beta1VolumeAttachmentHandlerFunc func(WatchStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1beta1VolumeAttachmentHandlerFunc) Handle(params WatchStorageV1beta1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1beta1VolumeAttachmentHandler interface {
	Handle(WatchStorageV1beta1VolumeAttachmentParams, interface{}) middleware.Responder
}
