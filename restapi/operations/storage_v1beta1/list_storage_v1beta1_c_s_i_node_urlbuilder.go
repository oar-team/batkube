...
// ListStorageV1beta1CSINodeURL generates an URL for the list storage v1beta1 c s i node operation
type ListStorageV1beta1CSINodeURL struct {
...
func (o *ListStorageV1beta1CSINodeURL) WithBasePath(bp string) *ListStorageV1beta1CSINodeURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *ListStorageV1beta1CSINodeURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *ListStorageV1beta1CSINodeURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *ListStorageV1beta1CSINodeURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *ListStorageV1beta1CSINodeURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *ListStorageV1beta1CSINodeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListStorageV1beta1CSINodeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListStorageV1beta1CSINodeURL")
	}
...
func (o *ListStorageV1beta1CSINodeURL) StringFull(scheme, host string) string {
