...
// NewReadStorageV1beta1StorageClassParams creates a new ReadStorageV1beta1StorageClassParams object
// no default values defined in spec.
func NewReadStorageV1beta1StorageClassParams() ReadStorageV1beta1StorageClassParams {

	return ReadStorageV1beta1StorageClassParams{}
}

// ReadStorageV1beta1StorageClassParams contains all the bound params for the read storage v1beta1 storage class operation
...
func (o *ReadStorageV1beta1StorageClassParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadStorageV1beta1StorageClassParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadStorageV1beta1StorageClassParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1beta1StorageClassParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadStorageV1beta1StorageClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1beta1StorageClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadStorageV1beta1StorageClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1beta1StorageClassParams) validatePretty(formats strfmt.Registry) error {
