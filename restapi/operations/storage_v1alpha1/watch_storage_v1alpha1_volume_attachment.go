...
type WatchStorageV1alpha1VolumeAttachmentHandlerFunc func(WatchStorageV1alpha1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1alpha1VolumeAttachmentHandlerFunc) Handle(params WatchStorageV1alpha1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1alpha1VolumeAttachmentHandler interface {
	Handle(WatchStorageV1alpha1VolumeAttachmentParams, interface{}) middleware.Responder
}
