...
type PatchStorageV1alpha1VolumeAttachmentHandlerFunc func(PatchStorageV1alpha1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchStorageV1alpha1VolumeAttachmentHandlerFunc) Handle(params PatchStorageV1alpha1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type PatchStorageV1alpha1VolumeAttachmentHandler interface {
	Handle(PatchStorageV1alpha1VolumeAttachmentParams, interface{}) middleware.Responder
}
