...
type GetStorageV1alpha1APIResourcesHandlerFunc func(GetStorageV1alpha1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetStorageV1alpha1APIResourcesHandlerFunc) Handle(params GetStorageV1alpha1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetStorageV1alpha1APIResourcesHandler interface {
	Handle(GetStorageV1alpha1APIResourcesParams, interface{}) middleware.Responder
}
...
func NewGetStorageV1alpha1APIResources(ctx *middleware.Context, handler GetStorageV1alpha1APIResourcesHandler) *GetStorageV1alpha1APIResources {
	return &GetStorageV1alpha1APIResources{Context: ctx, Handler: handler}
}
...
func (o *GetStorageV1alpha1APIResources) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetStorageV1alpha1APIResourcesParams()
