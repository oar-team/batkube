...
// DeleteStorageV1alpha1CollectionVolumeAttachmentURL generates an URL for the delete storage v1alpha1 collection volume attachment operation
type DeleteStorageV1alpha1CollectionVolumeAttachmentURL struct {
...
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentURL) WithBasePath(bp string) *DeleteStorageV1alpha1CollectionVolumeAttachmentURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/storage.k8s.io/v1alpha1/volumeattachments"
...
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteStorageV1alpha1CollectionVolumeAttachmentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteStorageV1alpha1CollectionVolumeAttachmentURL")
	}
...
func (o *DeleteStorageV1alpha1CollectionVolumeAttachmentURL) StringFull(scheme, host string) string {
