...
type ReplaceStorageV1alpha1VolumeAttachmentHandlerFunc func(ReplaceStorageV1alpha1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceStorageV1alpha1VolumeAttachmentHandlerFunc) Handle(params ReplaceStorageV1alpha1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type ReplaceStorageV1alpha1VolumeAttachmentHandler interface {
	Handle(ReplaceStorageV1alpha1VolumeAttachmentParams, interface{}) middleware.Responder
}
