...
// ReadStorageV1alpha1VolumeAttachmentParams contains all the bound params for the read storage v1alpha1 volume attachment operation
...
func (o *ReadStorageV1alpha1VolumeAttachmentParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadStorageV1alpha1VolumeAttachmentParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadStorageV1alpha1VolumeAttachmentParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1alpha1VolumeAttachmentParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadStorageV1alpha1VolumeAttachmentParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1alpha1VolumeAttachmentParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadStorageV1alpha1VolumeAttachmentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1alpha1VolumeAttachmentParams) validatePretty(formats strfmt.Registry) error {
