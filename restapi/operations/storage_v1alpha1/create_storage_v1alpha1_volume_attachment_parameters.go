...
// NewCreateStorageV1alpha1VolumeAttachmentParams creates a new CreateStorageV1alpha1VolumeAttachmentParams object
// no default values defined in spec.
func NewCreateStorageV1alpha1VolumeAttachmentParams() CreateStorageV1alpha1VolumeAttachmentParams {

	return CreateStorageV1alpha1VolumeAttachmentParams{}
}

// CreateStorageV1alpha1VolumeAttachmentParams contains all the bound params for the create storage v1alpha1 volume attachment operation
...
func (o *CreateStorageV1alpha1VolumeAttachmentParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateStorageV1alpha1VolumeAttachmentParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateStorageV1alpha1VolumeAttachmentParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateStorageV1alpha1VolumeAttachmentParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateStorageV1alpha1VolumeAttachmentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateStorageV1alpha1VolumeAttachmentParams) validatePretty(formats strfmt.Registry) error {
