...
type WatchStorageV1alpha1VolumeAttachmentListHandlerFunc func(WatchStorageV1alpha1VolumeAttachmentListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1alpha1VolumeAttachmentListHandlerFunc) Handle(params WatchStorageV1alpha1VolumeAttachmentListParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1alpha1VolumeAttachmentListHandler interface {
	Handle(WatchStorageV1alpha1VolumeAttachmentListParams, interface{}) middleware.Responder
}
