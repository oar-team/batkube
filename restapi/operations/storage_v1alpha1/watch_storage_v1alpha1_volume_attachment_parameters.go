...
// NewWatchStorageV1alpha1VolumeAttachmentParams creates a new WatchStorageV1alpha1VolumeAttachmentParams object
// no default values defined in spec.
func NewWatchStorageV1alpha1VolumeAttachmentParams() WatchStorageV1alpha1VolumeAttachmentParams {

	return WatchStorageV1alpha1VolumeAttachmentParams{}
}

// WatchStorageV1alpha1VolumeAttachmentParams contains all the bound params for the watch storage v1alpha1 volume attachment operation
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchStorageV1alpha1VolumeAttachmentParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchStorageV1alpha1VolumeAttachmentParams) validateWatch(formats strfmt.Registry) error {
