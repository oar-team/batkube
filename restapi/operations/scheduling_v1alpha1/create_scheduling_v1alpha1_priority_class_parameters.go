...
// NewCreateSchedulingV1alpha1PriorityClassParams creates a new CreateSchedulingV1alpha1PriorityClassParams object
// no default values defined in spec.
func NewCreateSchedulingV1alpha1PriorityClassParams() CreateSchedulingV1alpha1PriorityClassParams {

	return CreateSchedulingV1alpha1PriorityClassParams{}
}

// CreateSchedulingV1alpha1PriorityClassParams contains all the bound params for the create scheduling v1alpha1 priority class operation
...
func (o *CreateSchedulingV1alpha1PriorityClassParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateSchedulingV1alpha1PriorityClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateSchedulingV1alpha1PriorityClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateSchedulingV1alpha1PriorityClassParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSchedulingV1alpha1PriorityClassParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateSchedulingV1alpha1PriorityClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSchedulingV1alpha1PriorityClassParams) validatePretty(formats strfmt.Registry) error {
