...
type CreateSchedulingV1alpha1PriorityClassHandlerFunc func(CreateSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateSchedulingV1alpha1PriorityClassHandlerFunc) Handle(params CreateSchedulingV1alpha1PriorityClassParams, principal interface{}) middleware.Responder {
...
type CreateSchedulingV1alpha1PriorityClassHandler interface {
	Handle(CreateSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder
}
