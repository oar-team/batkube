...
type GetSchedulingV1alpha1APIResourcesHandlerFunc func(GetSchedulingV1alpha1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetSchedulingV1alpha1APIResourcesHandlerFunc) Handle(params GetSchedulingV1alpha1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetSchedulingV1alpha1APIResourcesHandler interface {
	Handle(GetSchedulingV1alpha1APIResourcesParams, interface{}) middleware.Responder
}
