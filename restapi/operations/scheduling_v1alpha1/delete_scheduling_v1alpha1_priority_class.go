...
type DeleteSchedulingV1alpha1PriorityClassHandlerFunc func(DeleteSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteSchedulingV1alpha1PriorityClassHandlerFunc) Handle(params DeleteSchedulingV1alpha1PriorityClassParams, principal interface{}) middleware.Responder {
...
type DeleteSchedulingV1alpha1PriorityClassHandler interface {
	Handle(DeleteSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder
}
...
func NewDeleteSchedulingV1alpha1PriorityClass(ctx *middleware.Context, handler DeleteSchedulingV1alpha1PriorityClassHandler) *DeleteSchedulingV1alpha1PriorityClass {
	return &DeleteSchedulingV1alpha1PriorityClass{Context: ctx, Handler: handler}
}
...
func (o *DeleteSchedulingV1alpha1PriorityClass) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewDeleteSchedulingV1alpha1PriorityClassParams()
