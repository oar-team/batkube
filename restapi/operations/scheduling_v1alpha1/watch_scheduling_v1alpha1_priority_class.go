...
type WatchSchedulingV1alpha1PriorityClassHandlerFunc func(WatchSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchSchedulingV1alpha1PriorityClassHandlerFunc) Handle(params WatchSchedulingV1alpha1PriorityClassParams, principal interface{}) middleware.Responder {
...
type WatchSchedulingV1alpha1PriorityClassHandler interface {
	Handle(WatchSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder
}
