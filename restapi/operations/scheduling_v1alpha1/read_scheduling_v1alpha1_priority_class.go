...
type ReadSchedulingV1alpha1PriorityClassHandlerFunc func(ReadSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadSchedulingV1alpha1PriorityClassHandlerFunc) Handle(params ReadSchedulingV1alpha1PriorityClassParams, principal interface{}) middleware.Responder {
...
type ReadSchedulingV1alpha1PriorityClassHandler interface {
	Handle(ReadSchedulingV1alpha1PriorityClassParams, interface{}) middleware.Responder
}
