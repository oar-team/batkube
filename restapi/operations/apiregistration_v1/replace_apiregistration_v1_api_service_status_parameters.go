...
// NewReplaceApiregistrationV1APIServiceStatusParams creates a new ReplaceApiregistrationV1APIServiceStatusParams object
// no default values defined in spec.
func NewReplaceApiregistrationV1APIServiceStatusParams() ReplaceApiregistrationV1APIServiceStatusParams {

	return ReplaceApiregistrationV1APIServiceStatusParams{}
}

// ReplaceApiregistrationV1APIServiceStatusParams contains all the bound params for the replace apiregistration v1 API service status operation
...
func (o *ReplaceApiregistrationV1APIServiceStatusParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sKubeAggregatorPkgApisApiregistrationV1APIService
...
func (o *ReplaceApiregistrationV1APIServiceStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceApiregistrationV1APIServiceStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceApiregistrationV1APIServiceStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiregistrationV1APIServiceStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceApiregistrationV1APIServiceStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiregistrationV1APIServiceStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceApiregistrationV1APIServiceStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiregistrationV1APIServiceStatusParams) validatePretty(formats strfmt.Registry) error {
