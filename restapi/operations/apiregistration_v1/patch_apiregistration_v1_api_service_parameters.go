...
// NewPatchApiregistrationV1APIServiceParams creates a new PatchApiregistrationV1APIServiceParams object
// no default values defined in spec.
func NewPatchApiregistrationV1APIServiceParams() PatchApiregistrationV1APIServiceParams {

	return PatchApiregistrationV1APIServiceParams{}
}

// PatchApiregistrationV1APIServiceParams contains all the bound params for the patch apiregistration v1 API service operation
...
func (o *PatchApiregistrationV1APIServiceParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchApiregistrationV1APIServiceParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchApiregistrationV1APIServiceParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchApiregistrationV1APIServiceParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchApiregistrationV1APIServiceParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchApiregistrationV1APIServiceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceParams) validatePretty(formats strfmt.Registry) error {
