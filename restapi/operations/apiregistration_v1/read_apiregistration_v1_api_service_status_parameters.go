...
// ReadApiregistrationV1APIServiceStatusParams contains all the bound params for the read apiregistration v1 API service status operation
...
func (o *ReadApiregistrationV1APIServiceStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadApiregistrationV1APIServiceStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadApiregistrationV1APIServiceStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadApiregistrationV1APIServiceStatusParams) validatePretty(formats strfmt.Registry) error {
