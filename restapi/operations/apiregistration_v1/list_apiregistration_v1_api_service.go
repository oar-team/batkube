...
type ListApiregistrationV1APIServiceHandlerFunc func(ListApiregistrationV1APIServiceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListApiregistrationV1APIServiceHandlerFunc) Handle(params ListApiregistrationV1APIServiceParams, principal interface{}) middleware.Responder {
...
type ListApiregistrationV1APIServiceHandler interface {
	Handle(ListApiregistrationV1APIServiceParams, interface{}) middleware.Responder
}
