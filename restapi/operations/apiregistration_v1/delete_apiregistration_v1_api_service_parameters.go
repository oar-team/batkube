...
// NewDeleteApiregistrationV1APIServiceParams creates a new DeleteApiregistrationV1APIServiceParams object
// no default values defined in spec.
func NewDeleteApiregistrationV1APIServiceParams() DeleteApiregistrationV1APIServiceParams {

	return DeleteApiregistrationV1APIServiceParams{}
}

// DeleteApiregistrationV1APIServiceParams contains all the bound params for the delete apiregistration v1 API service operation
...
func (o *DeleteApiregistrationV1APIServiceParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteApiregistrationV1APIServiceParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteApiregistrationV1APIServiceParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1APIServiceParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteApiregistrationV1APIServiceParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1APIServiceParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteApiregistrationV1APIServiceParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1APIServiceParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteApiregistrationV1APIServiceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1APIServiceParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteApiregistrationV1APIServiceParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1APIServiceParams) validatePropagationPolicy(formats strfmt.Registry) error {
