...
// NewPatchApiregistrationV1APIServiceStatusParams creates a new PatchApiregistrationV1APIServiceStatusParams object
// no default values defined in spec.
func NewPatchApiregistrationV1APIServiceStatusParams() PatchApiregistrationV1APIServiceStatusParams {

	return PatchApiregistrationV1APIServiceStatusParams{}
}

// PatchApiregistrationV1APIServiceStatusParams contains all the bound params for the patch apiregistration v1 API service status operation
...
func (o *PatchApiregistrationV1APIServiceStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchApiregistrationV1APIServiceStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchApiregistrationV1APIServiceStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchApiregistrationV1APIServiceStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchApiregistrationV1APIServiceStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchApiregistrationV1APIServiceStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiregistrationV1APIServiceStatusParams) validatePretty(formats strfmt.Registry) error {
