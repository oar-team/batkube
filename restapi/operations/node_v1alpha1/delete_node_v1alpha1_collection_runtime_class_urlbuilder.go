...
// DeleteNodeV1alpha1CollectionRuntimeClassURL generates an URL for the delete node v1alpha1 collection runtime class operation
type DeleteNodeV1alpha1CollectionRuntimeClassURL struct {
...
func (o *DeleteNodeV1alpha1CollectionRuntimeClassURL) WithBasePath(bp string) *DeleteNodeV1alpha1CollectionRuntimeClassURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteNodeV1alpha1CollectionRuntimeClassURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteNodeV1alpha1CollectionRuntimeClassURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *DeleteNodeV1alpha1CollectionRuntimeClassURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteNodeV1alpha1CollectionRuntimeClassURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteNodeV1alpha1CollectionRuntimeClassURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteNodeV1alpha1CollectionRuntimeClassURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteNodeV1alpha1CollectionRuntimeClassURL")
	}
...
func (o *DeleteNodeV1alpha1CollectionRuntimeClassURL) StringFull(scheme, host string) string {
