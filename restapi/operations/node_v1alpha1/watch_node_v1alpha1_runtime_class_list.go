...
type WatchNodeV1alpha1RuntimeClassListHandlerFunc func(WatchNodeV1alpha1RuntimeClassListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchNodeV1alpha1RuntimeClassListHandlerFunc) Handle(params WatchNodeV1alpha1RuntimeClassListParams, principal interface{}) middleware.Responder {
...
type WatchNodeV1alpha1RuntimeClassListHandler interface {
	Handle(WatchNodeV1alpha1RuntimeClassListParams, interface{}) middleware.Responder
}
