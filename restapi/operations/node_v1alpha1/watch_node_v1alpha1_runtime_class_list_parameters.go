...
// NewWatchNodeV1alpha1RuntimeClassListParams creates a new WatchNodeV1alpha1RuntimeClassListParams object
// no default values defined in spec.
func NewWatchNodeV1alpha1RuntimeClassListParams() WatchNodeV1alpha1RuntimeClassListParams {

	return WatchNodeV1alpha1RuntimeClassListParams{}
}

// WatchNodeV1alpha1RuntimeClassListParams contains all the bound params for the watch node v1alpha1 runtime class list operation
// typically these are obtained from a http.Request
//
// swagger:parameters watchNodeV1alpha1RuntimeClassList
...
//
// To ensure default values, the struct must have been initialized with NewWatchNodeV1alpha1RuntimeClassListParams() beforehand.
func (o *WatchNodeV1alpha1RuntimeClassListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchNodeV1alpha1RuntimeClassListParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1alpha1RuntimeClassListParams) validateWatch(formats strfmt.Registry) error {
