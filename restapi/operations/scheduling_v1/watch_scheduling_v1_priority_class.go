...
type WatchSchedulingV1PriorityClassHandlerFunc func(WatchSchedulingV1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchSchedulingV1PriorityClassHandlerFunc) Handle(params WatchSchedulingV1PriorityClassParams, principal interface{}) middleware.Responder {
...
type WatchSchedulingV1PriorityClassHandler interface {
	Handle(WatchSchedulingV1PriorityClassParams, interface{}) middleware.Responder
}
