...
// NewPatchSchedulingV1PriorityClassParams creates a new PatchSchedulingV1PriorityClassParams object
// no default values defined in spec.
func NewPatchSchedulingV1PriorityClassParams() PatchSchedulingV1PriorityClassParams {

	return PatchSchedulingV1PriorityClassParams{}
}

// PatchSchedulingV1PriorityClassParams contains all the bound params for the patch scheduling v1 priority class operation
...
func (o *PatchSchedulingV1PriorityClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchSchedulingV1PriorityClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchSchedulingV1PriorityClassParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1PriorityClassParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchSchedulingV1PriorityClassParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1PriorityClassParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchSchedulingV1PriorityClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1PriorityClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchSchedulingV1PriorityClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1PriorityClassParams) validatePretty(formats strfmt.Registry) error {
