...
type GetSchedulingV1APIResourcesHandlerFunc func(GetSchedulingV1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetSchedulingV1APIResourcesHandlerFunc) Handle(params GetSchedulingV1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetSchedulingV1APIResourcesHandler interface {
	Handle(GetSchedulingV1APIResourcesParams, interface{}) middleware.Responder
}
