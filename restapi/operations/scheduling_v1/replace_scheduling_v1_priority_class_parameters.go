...
// NewReplaceSchedulingV1PriorityClassParams creates a new ReplaceSchedulingV1PriorityClassParams object
// no default values defined in spec.
func NewReplaceSchedulingV1PriorityClassParams() ReplaceSchedulingV1PriorityClassParams {

	return ReplaceSchedulingV1PriorityClassParams{}
}

// ReplaceSchedulingV1PriorityClassParams contains all the bound params for the replace scheduling v1 priority class operation
...
func (o *ReplaceSchedulingV1PriorityClassParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPISchedulingV1PriorityClass
...
func (o *ReplaceSchedulingV1PriorityClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceSchedulingV1PriorityClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceSchedulingV1PriorityClassParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceSchedulingV1PriorityClassParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceSchedulingV1PriorityClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceSchedulingV1PriorityClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceSchedulingV1PriorityClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceSchedulingV1PriorityClassParams) validatePretty(formats strfmt.Registry) error {
