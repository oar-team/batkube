...
type ReplaceSchedulingV1PriorityClassHandlerFunc func(ReplaceSchedulingV1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceSchedulingV1PriorityClassHandlerFunc) Handle(params ReplaceSchedulingV1PriorityClassParams, principal interface{}) middleware.Responder {
...
type ReplaceSchedulingV1PriorityClassHandler interface {
	Handle(ReplaceSchedulingV1PriorityClassParams, interface{}) middleware.Responder
}
...
func NewReplaceSchedulingV1PriorityClass(ctx *middleware.Context, handler ReplaceSchedulingV1PriorityClassHandler) *ReplaceSchedulingV1PriorityClass {
	return &ReplaceSchedulingV1PriorityClass{Context: ctx, Handler: handler}
}
...
func (o *ReplaceSchedulingV1PriorityClass) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewReplaceSchedulingV1PriorityClassParams()
