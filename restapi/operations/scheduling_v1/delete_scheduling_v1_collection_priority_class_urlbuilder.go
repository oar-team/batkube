...
// DeleteSchedulingV1CollectionPriorityClassURL generates an URL for the delete scheduling v1 collection priority class operation
type DeleteSchedulingV1CollectionPriorityClassURL struct {
...
func (o *DeleteSchedulingV1CollectionPriorityClassURL) WithBasePath(bp string) *DeleteSchedulingV1CollectionPriorityClassURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteSchedulingV1CollectionPriorityClassURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteSchedulingV1CollectionPriorityClassURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/scheduling.k8s.io/v1/priorityclasses"
...
func (o *DeleteSchedulingV1CollectionPriorityClassURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteSchedulingV1CollectionPriorityClassURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteSchedulingV1CollectionPriorityClassURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteSchedulingV1CollectionPriorityClassURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteSchedulingV1CollectionPriorityClassURL")
	}
...
func (o *DeleteSchedulingV1CollectionPriorityClassURL) StringFull(scheme, host string) string {
