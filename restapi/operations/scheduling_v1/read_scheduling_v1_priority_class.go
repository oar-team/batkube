...
type ReadSchedulingV1PriorityClassHandlerFunc func(ReadSchedulingV1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadSchedulingV1PriorityClassHandlerFunc) Handle(params ReadSchedulingV1PriorityClassParams, principal interface{}) middleware.Responder {
...
type ReadSchedulingV1PriorityClassHandler interface {
	Handle(ReadSchedulingV1PriorityClassParams, interface{}) middleware.Responder
}
