...
// NewReadSchedulingV1PriorityClassParams creates a new ReadSchedulingV1PriorityClassParams object
// no default values defined in spec.
func NewReadSchedulingV1PriorityClassParams() ReadSchedulingV1PriorityClassParams {

	return ReadSchedulingV1PriorityClassParams{}
}

// ReadSchedulingV1PriorityClassParams contains all the bound params for the read scheduling v1 priority class operation
...
func (o *ReadSchedulingV1PriorityClassParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadSchedulingV1PriorityClassParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadSchedulingV1PriorityClassParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSchedulingV1PriorityClassParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadSchedulingV1PriorityClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSchedulingV1PriorityClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadSchedulingV1PriorityClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSchedulingV1PriorityClassParams) validatePretty(formats strfmt.Registry) error {
