...
type ListSchedulingV1PriorityClassHandlerFunc func(ListSchedulingV1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListSchedulingV1PriorityClassHandlerFunc) Handle(params ListSchedulingV1PriorityClassParams, principal interface{}) middleware.Responder {
...
type ListSchedulingV1PriorityClassHandler interface {
	Handle(ListSchedulingV1PriorityClassParams, interface{}) middleware.Responder
}
