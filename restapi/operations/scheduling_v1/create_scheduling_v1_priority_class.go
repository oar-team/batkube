...
type CreateSchedulingV1PriorityClassHandlerFunc func(CreateSchedulingV1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateSchedulingV1PriorityClassHandlerFunc) Handle(params CreateSchedulingV1PriorityClassParams, principal interface{}) middleware.Responder {
...
type CreateSchedulingV1PriorityClassHandler interface {
	Handle(CreateSchedulingV1PriorityClassParams, interface{}) middleware.Responder
}
