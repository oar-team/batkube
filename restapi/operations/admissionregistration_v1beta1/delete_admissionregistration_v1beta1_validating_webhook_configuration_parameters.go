...
// DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams contains all the bound params for the delete admissionregistration v1beta1 validating webhook configuration operation
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams) validatePropagationPolicy(formats strfmt.Registry) error {
