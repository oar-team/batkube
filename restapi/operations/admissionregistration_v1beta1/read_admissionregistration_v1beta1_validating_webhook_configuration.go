...
type ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationHandlerFunc func(ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationHandlerFunc) Handle(params ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationHandler interface {
	Handle(ReadAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder
}
