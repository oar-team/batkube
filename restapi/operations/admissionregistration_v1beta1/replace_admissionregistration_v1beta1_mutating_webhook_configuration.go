...
func (fn ReplaceAdmissionregistrationV1beta1MutatingWebhookConfigurationHandlerFunc) Handle(params ReplaceAdmissionregistrationV1beta1MutatingWebhookConfigurationParams) middleware.Responder {
	return fn(params)
}
