...
type DeleteAdmissionregistrationV1beta1MutatingWebhookConfigurationHandlerFunc func(DeleteAdmissionregistrationV1beta1MutatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAdmissionregistrationV1beta1MutatingWebhookConfigurationHandlerFunc) Handle(params DeleteAdmissionregistrationV1beta1MutatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type DeleteAdmissionregistrationV1beta1MutatingWebhookConfigurationHandler interface {
	Handle(DeleteAdmissionregistrationV1beta1MutatingWebhookConfigurationParams, interface{}) middleware.Responder
}
