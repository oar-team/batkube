...
type WatchAdmissionregistrationV1beta1MutatingWebhookConfigurationListHandlerFunc func(WatchAdmissionregistrationV1beta1MutatingWebhookConfigurationListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAdmissionregistrationV1beta1MutatingWebhookConfigurationListHandlerFunc) Handle(params WatchAdmissionregistrationV1beta1MutatingWebhookConfigurationListParams, principal interface{}) middleware.Responder {
...
type WatchAdmissionregistrationV1beta1MutatingWebhookConfigurationListHandler interface {
	Handle(WatchAdmissionregistrationV1beta1MutatingWebhookConfigurationListParams, interface{}) middleware.Responder
}
