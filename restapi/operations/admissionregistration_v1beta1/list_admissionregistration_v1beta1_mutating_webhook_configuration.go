...
func (fn ListAdmissionregistrationV1beta1MutatingWebhookConfigurationHandlerFunc) Handle(params ListAdmissionregistrationV1beta1MutatingWebhookConfigurationParams) middleware.Responder {
	return fn(params)
}
