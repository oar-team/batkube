...
type ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationHandlerFunc func(ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationHandlerFunc) Handle(params ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationHandler interface {
	Handle(ReplaceAdmissionregistrationV1beta1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder
}
