...
type WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListHandlerFunc func(WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListHandlerFunc) Handle(params WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListParams, principal interface{}) middleware.Responder {
...
type WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListHandler interface {
	Handle(WatchAdmissionregistrationV1beta1ValidatingWebhookConfigurationListParams, interface{}) middleware.Responder
}
