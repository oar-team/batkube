...
type DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationHandlerFunc func(DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationHandlerFunc) Handle(params DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationHandler interface {
	Handle(DeleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfigurationParams, interface{}) middleware.Responder
}
