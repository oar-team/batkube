...
type DeleteNodeV1beta1CollectionRuntimeClassHandlerFunc func(DeleteNodeV1beta1CollectionRuntimeClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteNodeV1beta1CollectionRuntimeClassHandlerFunc) Handle(params DeleteNodeV1beta1CollectionRuntimeClassParams, principal interface{}) middleware.Responder {
...
type DeleteNodeV1beta1CollectionRuntimeClassHandler interface {
	Handle(DeleteNodeV1beta1CollectionRuntimeClassParams, interface{}) middleware.Responder
}
