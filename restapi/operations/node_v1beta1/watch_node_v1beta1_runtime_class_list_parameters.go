...
// NewWatchNodeV1beta1RuntimeClassListParams creates a new WatchNodeV1beta1RuntimeClassListParams object
// no default values defined in spec.
func NewWatchNodeV1beta1RuntimeClassListParams() WatchNodeV1beta1RuntimeClassListParams {

	return WatchNodeV1beta1RuntimeClassListParams{}
}

// WatchNodeV1beta1RuntimeClassListParams contains all the bound params for the watch node v1beta1 runtime class list operation
// typically these are obtained from a http.Request
//
// swagger:parameters watchNodeV1beta1RuntimeClassList
...
//
// To ensure default values, the struct must have been initialized with NewWatchNodeV1beta1RuntimeClassListParams() beforehand.
func (o *WatchNodeV1beta1RuntimeClassListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchNodeV1beta1RuntimeClassListParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchNodeV1beta1RuntimeClassListParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchNodeV1beta1RuntimeClassListParams) validateWatch(formats strfmt.Registry) error {
