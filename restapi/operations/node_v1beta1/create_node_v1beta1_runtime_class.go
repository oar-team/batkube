...
type CreateNodeV1beta1RuntimeClassHandlerFunc func(CreateNodeV1beta1RuntimeClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateNodeV1beta1RuntimeClassHandlerFunc) Handle(params CreateNodeV1beta1RuntimeClassParams, principal interface{}) middleware.Responder {
...
type CreateNodeV1beta1RuntimeClassHandler interface {
	Handle(CreateNodeV1beta1RuntimeClassParams, interface{}) middleware.Responder
}
