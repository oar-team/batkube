...
// NewDeleteNodeV1beta1RuntimeClassParams creates a new DeleteNodeV1beta1RuntimeClassParams object
// no default values defined in spec.
func NewDeleteNodeV1beta1RuntimeClassParams() DeleteNodeV1beta1RuntimeClassParams {

	return DeleteNodeV1beta1RuntimeClassParams{}
}

// DeleteNodeV1beta1RuntimeClassParams contains all the bound params for the delete node v1beta1 runtime class operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteNodeV1beta1RuntimeClass
...
//
// To ensure default values, the struct must have been initialized with NewDeleteNodeV1beta1RuntimeClassParams() beforehand.
func (o *DeleteNodeV1beta1RuntimeClassParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteNodeV1beta1RuntimeClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteNodeV1beta1RuntimeClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteNodeV1beta1RuntimeClassParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNodeV1beta1RuntimeClassParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteNodeV1beta1RuntimeClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNodeV1beta1RuntimeClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteNodeV1beta1RuntimeClassParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNodeV1beta1RuntimeClassParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteNodeV1beta1RuntimeClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNodeV1beta1RuntimeClassParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteNodeV1beta1RuntimeClassParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNodeV1beta1RuntimeClassParams) validatePropagationPolicy(formats strfmt.Registry) error {
