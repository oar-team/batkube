...
type WatchBatchV1beta1CronJobListForAllNamespacesHandlerFunc func(WatchBatchV1beta1CronJobListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchBatchV1beta1CronJobListForAllNamespacesHandlerFunc) Handle(params WatchBatchV1beta1CronJobListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchBatchV1beta1CronJobListForAllNamespacesHandler interface {
	Handle(WatchBatchV1beta1CronJobListForAllNamespacesParams, interface{}) middleware.Responder
}
