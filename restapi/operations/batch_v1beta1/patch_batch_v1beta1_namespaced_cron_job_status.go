...
type PatchBatchV1beta1NamespacedCronJobStatusHandlerFunc func(PatchBatchV1beta1NamespacedCronJobStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchBatchV1beta1NamespacedCronJobStatusHandlerFunc) Handle(params PatchBatchV1beta1NamespacedCronJobStatusParams, principal interface{}) middleware.Responder {
...
type PatchBatchV1beta1NamespacedCronJobStatusHandler interface {
	Handle(PatchBatchV1beta1NamespacedCronJobStatusParams, interface{}) middleware.Responder
}
