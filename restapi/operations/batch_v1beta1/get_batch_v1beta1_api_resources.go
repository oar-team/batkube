...
type GetBatchV1beta1APIResourcesHandlerFunc func(GetBatchV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetBatchV1beta1APIResourcesHandlerFunc) Handle(params GetBatchV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetBatchV1beta1APIResourcesHandler interface {
	Handle(GetBatchV1beta1APIResourcesParams, interface{}) middleware.Responder
}
