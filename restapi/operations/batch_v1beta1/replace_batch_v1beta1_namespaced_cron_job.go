...
type ReplaceBatchV1beta1NamespacedCronJobHandlerFunc func(ReplaceBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceBatchV1beta1NamespacedCronJobHandlerFunc) Handle(params ReplaceBatchV1beta1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type ReplaceBatchV1beta1NamespacedCronJobHandler interface {
	Handle(ReplaceBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder
}
