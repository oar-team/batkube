...
type DeleteBatchV1beta1CollectionNamespacedCronJobHandlerFunc func(DeleteBatchV1beta1CollectionNamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteBatchV1beta1CollectionNamespacedCronJobHandlerFunc) Handle(params DeleteBatchV1beta1CollectionNamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type DeleteBatchV1beta1CollectionNamespacedCronJobHandler interface {
	Handle(DeleteBatchV1beta1CollectionNamespacedCronJobParams, interface{}) middleware.Responder
}
