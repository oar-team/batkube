...
type ListBatchV1beta1CronJobForAllNamespacesHandlerFunc func(ListBatchV1beta1CronJobForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListBatchV1beta1CronJobForAllNamespacesHandlerFunc) Handle(params ListBatchV1beta1CronJobForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListBatchV1beta1CronJobForAllNamespacesHandler interface {
	Handle(ListBatchV1beta1CronJobForAllNamespacesParams, interface{}) middleware.Responder
}
