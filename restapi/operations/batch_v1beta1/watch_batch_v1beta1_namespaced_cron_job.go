...
type WatchBatchV1beta1NamespacedCronJobHandlerFunc func(WatchBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchBatchV1beta1NamespacedCronJobHandlerFunc) Handle(params WatchBatchV1beta1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type WatchBatchV1beta1NamespacedCronJobHandler interface {
	Handle(WatchBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder
}
