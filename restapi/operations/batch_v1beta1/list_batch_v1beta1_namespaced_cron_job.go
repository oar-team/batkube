...
type ListBatchV1beta1NamespacedCronJobHandlerFunc func(ListBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListBatchV1beta1NamespacedCronJobHandlerFunc) Handle(params ListBatchV1beta1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type ListBatchV1beta1NamespacedCronJobHandler interface {
	Handle(ListBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder
}
