...
type WatchBatchV1beta1NamespacedCronJobListHandlerFunc func(WatchBatchV1beta1NamespacedCronJobListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchBatchV1beta1NamespacedCronJobListHandlerFunc) Handle(params WatchBatchV1beta1NamespacedCronJobListParams, principal interface{}) middleware.Responder {
...
type WatchBatchV1beta1NamespacedCronJobListHandler interface {
	Handle(WatchBatchV1beta1NamespacedCronJobListParams, interface{}) middleware.Responder
}
