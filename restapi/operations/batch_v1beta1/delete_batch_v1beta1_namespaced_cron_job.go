...
type DeleteBatchV1beta1NamespacedCronJobHandlerFunc func(DeleteBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteBatchV1beta1NamespacedCronJobHandlerFunc) Handle(params DeleteBatchV1beta1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type DeleteBatchV1beta1NamespacedCronJobHandler interface {
	Handle(DeleteBatchV1beta1NamespacedCronJobParams, interface{}) middleware.Responder
}
