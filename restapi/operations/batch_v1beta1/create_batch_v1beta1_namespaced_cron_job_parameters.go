...
// NewCreateBatchV1beta1NamespacedCronJobParams creates a new CreateBatchV1beta1NamespacedCronJobParams object
// no default values defined in spec.
func NewCreateBatchV1beta1NamespacedCronJobParams() CreateBatchV1beta1NamespacedCronJobParams {

	return CreateBatchV1beta1NamespacedCronJobParams{}
}

// CreateBatchV1beta1NamespacedCronJobParams contains all the bound params for the create batch v1beta1 namespaced cron job operation
...
func (o *CreateBatchV1beta1NamespacedCronJobParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateBatchV1beta1NamespacedCronJobParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateBatchV1beta1NamespacedCronJobParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateBatchV1beta1NamespacedCronJobParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateBatchV1beta1NamespacedCronJobParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateBatchV1beta1NamespacedCronJobParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateBatchV1beta1NamespacedCronJobParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateBatchV1beta1NamespacedCronJobParams) validatePretty(formats strfmt.Registry) error {
