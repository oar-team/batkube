...
// NewDeleteApiextensionsV1CustomResourceDefinitionParams creates a new DeleteApiextensionsV1CustomResourceDefinitionParams object
// no default values defined in spec.
func NewDeleteApiextensionsV1CustomResourceDefinitionParams() DeleteApiextensionsV1CustomResourceDefinitionParams {

	return DeleteApiextensionsV1CustomResourceDefinitionParams{}
}

// DeleteApiextensionsV1CustomResourceDefinitionParams contains all the bound params for the delete apiextensions v1 custom resource definition operation
...
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiextensionsV1CustomResourceDefinitionParams) validatePropagationPolicy(formats strfmt.Registry) error {
