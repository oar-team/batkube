...
// ReplaceApiextensionsV1CustomResourceDefinitionStatusParams contains all the bound params for the replace apiextensions v1 custom resource definition status operation
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionStatusParams) validatePretty(formats strfmt.Registry) error {
