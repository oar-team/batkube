...
// NewReadApiextensionsV1CustomResourceDefinitionParams creates a new ReadApiextensionsV1CustomResourceDefinitionParams object
// no default values defined in spec.
func NewReadApiextensionsV1CustomResourceDefinitionParams() ReadApiextensionsV1CustomResourceDefinitionParams {

	return ReadApiextensionsV1CustomResourceDefinitionParams{}
}

// ReadApiextensionsV1CustomResourceDefinitionParams contains all the bound params for the read apiextensions v1 custom resource definition operation
...
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadApiextensionsV1CustomResourceDefinitionParams) validatePretty(formats strfmt.Registry) error {
