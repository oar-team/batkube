...
// NewPatchApiextensionsV1CustomResourceDefinitionStatusParams creates a new PatchApiextensionsV1CustomResourceDefinitionStatusParams object
...
func NewPatchApiextensionsV1CustomResourceDefinitionStatusParams() PatchApiextensionsV1CustomResourceDefinitionStatusParams {
	...
	return PatchApiextensionsV1CustomResourceDefinitionStatusParams{}
}

// PatchApiextensionsV1CustomResourceDefinitionStatusParams contains all the bound params for the patch apiextensions v1 custom resource definition status operation
...
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionStatusParams) validatePretty(formats strfmt.Registry) error {
