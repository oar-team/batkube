...
type ReadApiextensionsV1CustomResourceDefinitionStatusHandlerFunc func(ReadApiextensionsV1CustomResourceDefinitionStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadApiextensionsV1CustomResourceDefinitionStatusHandlerFunc) Handle(params ReadApiextensionsV1CustomResourceDefinitionStatusParams, principal interface{}) middleware.Responder {
...
type ReadApiextensionsV1CustomResourceDefinitionStatusHandler interface {
	Handle(ReadApiextensionsV1CustomResourceDefinitionStatusParams, interface{}) middleware.Responder
}
