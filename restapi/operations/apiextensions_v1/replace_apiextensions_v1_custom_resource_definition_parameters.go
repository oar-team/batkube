...
// NewReplaceApiextensionsV1CustomResourceDefinitionParams creates a new ReplaceApiextensionsV1CustomResourceDefinitionParams object
// no default values defined in spec.
func NewReplaceApiextensionsV1CustomResourceDefinitionParams() ReplaceApiextensionsV1CustomResourceDefinitionParams {

	return ReplaceApiextensionsV1CustomResourceDefinitionParams{}
}

// ReplaceApiextensionsV1CustomResourceDefinitionParams contains all the bound params for the replace apiextensions v1 custom resource definition operation
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceApiextensionsV1CustomResourceDefinitionParams) validatePretty(formats strfmt.Registry) error {
