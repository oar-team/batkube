...
// NewPatchApiextensionsV1CustomResourceDefinitionParams creates a new PatchApiextensionsV1CustomResourceDefinitionParams object
// no default values defined in spec.
func NewPatchApiextensionsV1CustomResourceDefinitionParams() PatchApiextensionsV1CustomResourceDefinitionParams {

	return PatchApiextensionsV1CustomResourceDefinitionParams{}
}

// PatchApiextensionsV1CustomResourceDefinitionParams contains all the bound params for the patch apiextensions v1 custom resource definition operation
...
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchApiextensionsV1CustomResourceDefinitionParams) validatePretty(formats strfmt.Registry) error {
