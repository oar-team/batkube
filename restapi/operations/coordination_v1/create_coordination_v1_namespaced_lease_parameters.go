...
// NewCreateCoordinationV1NamespacedLeaseParams creates a new CreateCoordinationV1NamespacedLeaseParams object
// no default values defined in spec.
func NewCreateCoordinationV1NamespacedLeaseParams() CreateCoordinationV1NamespacedLeaseParams {

	return CreateCoordinationV1NamespacedLeaseParams{}
}

// CreateCoordinationV1NamespacedLeaseParams contains all the bound params for the create coordination v1 namespaced lease operation
...
func (o *CreateCoordinationV1NamespacedLeaseParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateCoordinationV1NamespacedLeaseParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateCoordinationV1NamespacedLeaseParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateCoordinationV1NamespacedLeaseParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoordinationV1NamespacedLeaseParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateCoordinationV1NamespacedLeaseParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoordinationV1NamespacedLeaseParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateCoordinationV1NamespacedLeaseParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoordinationV1NamespacedLeaseParams) validatePretty(formats strfmt.Registry) error {
