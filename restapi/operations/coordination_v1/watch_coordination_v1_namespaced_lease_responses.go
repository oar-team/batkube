...
func NewWatchCoordinationV1NamespacedLeaseOK() *WatchCoordinationV1NamespacedLeaseOK {
	...
	return &WatchCoordinationV1NamespacedLeaseOK{}
}

// WithPayload adds the payload to the watch coordination v1 namespaced lease o k response
func (o *WatchCoordinationV1NamespacedLeaseOK) WithPayload(payload *models.IoK8sApimachineryPkgApisMetaV1WatchEvent) *WatchCoordinationV1NamespacedLeaseOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the watch coordination v1 namespaced lease o k response
func (o *WatchCoordinationV1NamespacedLeaseOK) SetPayload(payload *models.IoK8sApimachineryPkgApisMetaV1WatchEvent) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *WatchCoordinationV1NamespacedLeaseOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
func NewWatchCoordinationV1NamespacedLeaseUnauthorized() *WatchCoordinationV1NamespacedLeaseUnauthorized {
	...
	return &WatchCoordinationV1NamespacedLeaseUnauthorized{}
}

// WriteResponse to the client
func (o *WatchCoordinationV1NamespacedLeaseUnauthorized) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
