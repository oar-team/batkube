...
// DeleteCoordinationV1CollectionNamespacedLeaseURL generates an URL for the delete coordination v1 collection namespaced lease operation
type DeleteCoordinationV1CollectionNamespacedLeaseURL struct {
	Namespace string
...
func (o *DeleteCoordinationV1CollectionNamespacedLeaseURL) WithBasePath(bp string) *DeleteCoordinationV1CollectionNamespacedLeaseURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoordinationV1CollectionNamespacedLeaseURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoordinationV1CollectionNamespacedLeaseURL) Build() (*url.URL, error) {
	var _result url.URL
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on DeleteCoordinationV1CollectionNamespacedLeaseURL")
	}
...
func (o *DeleteCoordinationV1CollectionNamespacedLeaseURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoordinationV1CollectionNamespacedLeaseURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoordinationV1CollectionNamespacedLeaseURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoordinationV1CollectionNamespacedLeaseURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoordinationV1CollectionNamespacedLeaseURL")
	}
...
func (o *DeleteCoordinationV1CollectionNamespacedLeaseURL) StringFull(scheme, host string) string {
