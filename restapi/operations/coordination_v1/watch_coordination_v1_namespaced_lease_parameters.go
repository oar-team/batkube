...
// NewWatchCoordinationV1NamespacedLeaseParams creates a new WatchCoordinationV1NamespacedLeaseParams object
// no default values defined in spec.
func NewWatchCoordinationV1NamespacedLeaseParams() WatchCoordinationV1NamespacedLeaseParams {

	return WatchCoordinationV1NamespacedLeaseParams{}
}

// WatchCoordinationV1NamespacedLeaseParams contains all the bound params for the watch coordination v1 namespaced lease operation
...
func (o *WatchCoordinationV1NamespacedLeaseParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchCoordinationV1NamespacedLeaseParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchCoordinationV1NamespacedLeaseParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchCoordinationV1NamespacedLeaseParams) validateWatch(formats strfmt.Registry) error {
