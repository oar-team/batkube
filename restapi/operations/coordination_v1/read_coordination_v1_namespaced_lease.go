...
type ReadCoordinationV1NamespacedLeaseHandlerFunc func(ReadCoordinationV1NamespacedLeaseParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoordinationV1NamespacedLeaseHandlerFunc) Handle(params ReadCoordinationV1NamespacedLeaseParams, principal interface{}) middleware.Responder {
...
type ReadCoordinationV1NamespacedLeaseHandler interface {
	Handle(ReadCoordinationV1NamespacedLeaseParams, interface{}) middleware.Responder
}
