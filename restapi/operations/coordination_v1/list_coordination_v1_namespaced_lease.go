...
type ListCoordinationV1NamespacedLeaseHandlerFunc func(ListCoordinationV1NamespacedLeaseParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoordinationV1NamespacedLeaseHandlerFunc) Handle(params ListCoordinationV1NamespacedLeaseParams, principal interface{}) middleware.Responder {
...
type ListCoordinationV1NamespacedLeaseHandler interface {
	Handle(ListCoordinationV1NamespacedLeaseParams, interface{}) middleware.Responder
}
