...
type CreateCoordinationV1NamespacedLeaseHandlerFunc func(CreateCoordinationV1NamespacedLeaseParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateCoordinationV1NamespacedLeaseHandlerFunc) Handle(params CreateCoordinationV1NamespacedLeaseParams, principal interface{}) middleware.Responder {
...
type CreateCoordinationV1NamespacedLeaseHandler interface {
	Handle(CreateCoordinationV1NamespacedLeaseParams, interface{}) middleware.Responder
}
