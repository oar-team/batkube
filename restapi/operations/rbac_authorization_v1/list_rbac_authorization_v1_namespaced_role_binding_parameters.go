...
// NewListRbacAuthorizationV1NamespacedRoleBindingParams creates a new ListRbacAuthorizationV1NamespacedRoleBindingParams object
// no default values defined in spec.
func NewListRbacAuthorizationV1NamespacedRoleBindingParams() ListRbacAuthorizationV1NamespacedRoleBindingParams {

	return ListRbacAuthorizationV1NamespacedRoleBindingParams{}
}

// ListRbacAuthorizationV1NamespacedRoleBindingParams contains all the bound params for the list rbac authorization v1 namespaced role binding operation
// typically these are obtained from a http.Request
//
// swagger:parameters listRbacAuthorizationV1NamespacedRoleBinding
...
//
// To ensure default values, the struct must have been initialized with NewListRbacAuthorizationV1NamespacedRoleBindingParams() beforehand.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1NamespacedRoleBindingParams) validateWatch(formats strfmt.Registry) error {
