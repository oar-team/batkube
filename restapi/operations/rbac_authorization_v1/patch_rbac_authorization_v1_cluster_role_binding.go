...
type PatchRbacAuthorizationV1ClusterRoleBindingHandlerFunc func(PatchRbacAuthorizationV1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchRbacAuthorizationV1ClusterRoleBindingHandlerFunc) Handle(params PatchRbacAuthorizationV1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type PatchRbacAuthorizationV1ClusterRoleBindingHandler interface {
	Handle(PatchRbacAuthorizationV1ClusterRoleBindingParams, interface{}) middleware.Responder
}
