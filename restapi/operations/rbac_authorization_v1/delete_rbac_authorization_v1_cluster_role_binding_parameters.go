...
// NewDeleteRbacAuthorizationV1ClusterRoleBindingParams creates a new DeleteRbacAuthorizationV1ClusterRoleBindingParams object
// no default values defined in spec.
func NewDeleteRbacAuthorizationV1ClusterRoleBindingParams() DeleteRbacAuthorizationV1ClusterRoleBindingParams {

	return DeleteRbacAuthorizationV1ClusterRoleBindingParams{}
}

// DeleteRbacAuthorizationV1ClusterRoleBindingParams contains all the bound params for the delete rbac authorization v1 cluster role binding operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteRbacAuthorizationV1ClusterRoleBinding
...
//
// To ensure default values, the struct must have been initialized with NewDeleteRbacAuthorizationV1ClusterRoleBindingParams() beforehand.
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleBindingParams) validatePropagationPolicy(formats strfmt.Registry) error {
