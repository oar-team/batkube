...
// DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL generates an URL for the delete rbac authorization v1 collection cluster role binding operation
type DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL struct {
...
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL) WithBasePath(bp string) *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings"
...
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL")
	}
...
func (o *DeleteRbacAuthorizationV1CollectionClusterRoleBindingURL) StringFull(scheme, host string) string {
