...
type DeleteRbacAuthorizationV1NamespacedRoleHandlerFunc func(DeleteRbacAuthorizationV1NamespacedRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1NamespacedRoleHandlerFunc) Handle(params DeleteRbacAuthorizationV1NamespacedRoleParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1NamespacedRoleHandler interface {
	Handle(DeleteRbacAuthorizationV1NamespacedRoleParams, interface{}) middleware.Responder
}
