...
type ReadRbacAuthorizationV1NamespacedRoleBindingHandlerFunc func(ReadRbacAuthorizationV1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadRbacAuthorizationV1NamespacedRoleBindingHandlerFunc) Handle(params ReadRbacAuthorizationV1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type ReadRbacAuthorizationV1NamespacedRoleBindingHandler interface {
	Handle(ReadRbacAuthorizationV1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
