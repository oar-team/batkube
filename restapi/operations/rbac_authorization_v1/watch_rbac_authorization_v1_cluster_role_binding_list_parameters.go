...
// NewWatchRbacAuthorizationV1ClusterRoleBindingListParams creates a new WatchRbacAuthorizationV1ClusterRoleBindingListParams object
// no default values defined in spec.
func NewWatchRbacAuthorizationV1ClusterRoleBindingListParams() WatchRbacAuthorizationV1ClusterRoleBindingListParams {

	return WatchRbacAuthorizationV1ClusterRoleBindingListParams{}
}

// WatchRbacAuthorizationV1ClusterRoleBindingListParams contains all the bound params for the watch rbac authorization v1 cluster role binding list operation
// typically these are obtained from a http.Request
//
// swagger:parameters watchRbacAuthorizationV1ClusterRoleBindingList
...
//
// To ensure default values, the struct must have been initialized with NewWatchRbacAuthorizationV1ClusterRoleBindingListParams() beforehand.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1ClusterRoleBindingListParams) validateWatch(formats strfmt.Registry) error {
