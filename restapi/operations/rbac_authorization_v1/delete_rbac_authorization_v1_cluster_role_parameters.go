...
// NewDeleteRbacAuthorizationV1ClusterRoleParams creates a new DeleteRbacAuthorizationV1ClusterRoleParams object
// no default values defined in spec.
func NewDeleteRbacAuthorizationV1ClusterRoleParams() DeleteRbacAuthorizationV1ClusterRoleParams {

	return DeleteRbacAuthorizationV1ClusterRoleParams{}
}

// DeleteRbacAuthorizationV1ClusterRoleParams contains all the bound params for the delete rbac authorization v1 cluster role operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteRbacAuthorizationV1ClusterRole
...
//
// To ensure default values, the struct must have been initialized with NewDeleteRbacAuthorizationV1ClusterRoleParams() beforehand.
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1ClusterRoleParams) validatePropagationPolicy(formats strfmt.Registry) error {
