...
// NewListRbacAuthorizationV1RoleBindingForAllNamespacesParams creates a new ListRbacAuthorizationV1RoleBindingForAllNamespacesParams object
...
func NewListRbacAuthorizationV1RoleBindingForAllNamespacesParams() ListRbacAuthorizationV1RoleBindingForAllNamespacesParams {
	...
	return ListRbacAuthorizationV1RoleBindingForAllNamespacesParams{}
}

// ListRbacAuthorizationV1RoleBindingForAllNamespacesParams contains all the bound params for the list rbac authorization v1 role binding for all namespaces operation
// typically these are obtained from a http.Request
//
// swagger:parameters listRbacAuthorizationV1RoleBindingForAllNamespaces
...
//
// To ensure default values, the struct must have been initialized with NewListRbacAuthorizationV1RoleBindingForAllNamespacesParams() beforehand.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1RoleBindingForAllNamespacesParams) validateWatch(formats strfmt.Registry) error {
