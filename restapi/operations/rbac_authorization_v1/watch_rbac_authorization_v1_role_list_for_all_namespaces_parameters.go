...
// NewWatchRbacAuthorizationV1RoleListForAllNamespacesParams creates a new WatchRbacAuthorizationV1RoleListForAllNamespacesParams object
...
func NewWatchRbacAuthorizationV1RoleListForAllNamespacesParams() WatchRbacAuthorizationV1RoleListForAllNamespacesParams {
	...
	return WatchRbacAuthorizationV1RoleListForAllNamespacesParams{}
}

// WatchRbacAuthorizationV1RoleListForAllNamespacesParams contains all the bound params for the watch rbac authorization v1 role list for all namespaces operation
// typically these are obtained from a http.Request
//
// swagger:parameters watchRbacAuthorizationV1RoleListForAllNamespaces
...
//
// To ensure default values, the struct must have been initialized with NewWatchRbacAuthorizationV1RoleListForAllNamespacesParams() beforehand.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchRbacAuthorizationV1RoleListForAllNamespacesParams) validateWatch(formats strfmt.Registry) error {
