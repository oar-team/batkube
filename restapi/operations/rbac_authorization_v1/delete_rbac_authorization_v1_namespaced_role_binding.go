...
type DeleteRbacAuthorizationV1NamespacedRoleBindingHandlerFunc func(DeleteRbacAuthorizationV1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1NamespacedRoleBindingHandlerFunc) Handle(params DeleteRbacAuthorizationV1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1NamespacedRoleBindingHandler interface {
	Handle(DeleteRbacAuthorizationV1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
