...
type DeleteRbacAuthorizationV1CollectionClusterRoleHandlerFunc func(DeleteRbacAuthorizationV1CollectionClusterRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1CollectionClusterRoleHandlerFunc) Handle(params DeleteRbacAuthorizationV1CollectionClusterRoleParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1CollectionClusterRoleHandler interface {
	Handle(DeleteRbacAuthorizationV1CollectionClusterRoleParams, interface{}) middleware.Responder
}
