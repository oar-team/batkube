...
type DeleteRbacAuthorizationV1CollectionClusterRoleBindingHandlerFunc func(DeleteRbacAuthorizationV1CollectionClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1CollectionClusterRoleBindingHandlerFunc) Handle(params DeleteRbacAuthorizationV1CollectionClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1CollectionClusterRoleBindingHandler interface {
	Handle(DeleteRbacAuthorizationV1CollectionClusterRoleBindingParams, interface{}) middleware.Responder
}
