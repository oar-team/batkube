...
type WatchRbacAuthorizationV1RoleListForAllNamespacesHandlerFunc func(WatchRbacAuthorizationV1RoleListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1RoleListForAllNamespacesHandlerFunc) Handle(params WatchRbacAuthorizationV1RoleListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1RoleListForAllNamespacesHandler interface {
	Handle(WatchRbacAuthorizationV1RoleListForAllNamespacesParams, interface{}) middleware.Responder
}
