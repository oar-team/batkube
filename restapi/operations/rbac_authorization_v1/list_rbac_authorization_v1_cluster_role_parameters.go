...
// NewListRbacAuthorizationV1ClusterRoleParams creates a new ListRbacAuthorizationV1ClusterRoleParams object
// no default values defined in spec.
func NewListRbacAuthorizationV1ClusterRoleParams() ListRbacAuthorizationV1ClusterRoleParams {

	return ListRbacAuthorizationV1ClusterRoleParams{}
}

// ListRbacAuthorizationV1ClusterRoleParams contains all the bound params for the list rbac authorization v1 cluster role operation
// typically these are obtained from a http.Request
//
// swagger:parameters listRbacAuthorizationV1ClusterRole
...
//
// To ensure default values, the struct must have been initialized with NewListRbacAuthorizationV1ClusterRoleParams() beforehand.
func (o *ListRbacAuthorizationV1ClusterRoleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListRbacAuthorizationV1ClusterRoleParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListRbacAuthorizationV1ClusterRoleParams) validateWatch(formats strfmt.Registry) error {
