...
type ListRbacAuthorizationV1ClusterRoleBindingHandlerFunc func(ListRbacAuthorizationV1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1ClusterRoleBindingHandlerFunc) Handle(params ListRbacAuthorizationV1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1ClusterRoleBindingHandler interface {
	Handle(ListRbacAuthorizationV1ClusterRoleBindingParams, interface{}) middleware.Responder
}
