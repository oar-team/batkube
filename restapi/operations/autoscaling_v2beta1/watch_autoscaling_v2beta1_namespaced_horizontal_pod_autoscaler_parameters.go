...
// NewWatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams creates a new WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams object
...
func NewWatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams() WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams {
	...
	return WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams{}
}

// WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams contains all the bound params for the watch autoscaling v2beta1 namespaced horizontal pod autoscaler operation
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateWatch(formats strfmt.Registry) error {
