...
type ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc func(ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
