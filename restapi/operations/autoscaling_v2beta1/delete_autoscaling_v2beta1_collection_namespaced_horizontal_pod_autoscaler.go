...
type DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerHandlerFunc func(DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerHandler interface {
	Handle(DeleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
