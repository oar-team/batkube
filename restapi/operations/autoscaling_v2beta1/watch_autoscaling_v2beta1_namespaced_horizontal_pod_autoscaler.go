...
type WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc func(WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(WatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
