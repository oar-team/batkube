...
// CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams contains all the bound params for the create autoscaling v2beta1 namespaced horizontal pod autoscaler operation
...
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validatePretty(formats strfmt.Registry) error {
