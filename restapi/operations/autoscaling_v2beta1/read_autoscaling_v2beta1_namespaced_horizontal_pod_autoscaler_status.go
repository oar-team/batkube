...
type ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusHandlerFunc func(ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusHandlerFunc) Handle(params ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams, principal interface{}) middleware.Responder {
...
type ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusHandler interface {
	Handle(ReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams, interface{}) middleware.Responder
}
