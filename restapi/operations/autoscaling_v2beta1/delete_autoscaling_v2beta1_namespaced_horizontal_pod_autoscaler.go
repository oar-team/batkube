...
type DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc func(DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
