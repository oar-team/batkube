...
type ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc func(ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
