...
// DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams contains all the bound params for the delete autoscaling v2beta1 namespaced horizontal pod autoscaler operation
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams) validatePropagationPolicy(formats strfmt.Registry) error {
