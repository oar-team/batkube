...
type PatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusHandlerFunc func(PatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusHandlerFunc) Handle(params PatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams, principal interface{}) middleware.Responder {
...
type PatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusHandler interface {
	Handle(PatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams, interface{}) middleware.Responder
}
