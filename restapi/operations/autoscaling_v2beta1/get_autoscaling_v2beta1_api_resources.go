...
type GetAutoscalingV2beta1APIResourcesHandlerFunc func(GetAutoscalingV2beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAutoscalingV2beta1APIResourcesHandlerFunc) Handle(params GetAutoscalingV2beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetAutoscalingV2beta1APIResourcesHandler interface {
	Handle(GetAutoscalingV2beta1APIResourcesParams, interface{}) middleware.Responder
}
