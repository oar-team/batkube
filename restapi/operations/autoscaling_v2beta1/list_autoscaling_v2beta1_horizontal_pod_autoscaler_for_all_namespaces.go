...
type ListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesHandlerFunc func(ListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesHandlerFunc) Handle(params ListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesHandler interface {
	Handle(ListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesParams, interface{}) middleware.Responder
}
