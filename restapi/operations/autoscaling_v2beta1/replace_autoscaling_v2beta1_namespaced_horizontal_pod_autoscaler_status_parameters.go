...
// ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams contains all the bound params for the replace autoscaling v2beta1 namespaced horizontal pod autoscaler status operation
...
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusParams) validatePretty(formats strfmt.Registry) error {
