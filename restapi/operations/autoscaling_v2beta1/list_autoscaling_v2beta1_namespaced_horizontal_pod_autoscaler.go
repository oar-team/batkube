...
type ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc func(ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(ListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
