...
type ConnectCoreV1GetNamespacedPodPortforwardHandlerFunc func(ConnectCoreV1GetNamespacedPodPortforwardParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1GetNamespacedPodPortforwardHandlerFunc) Handle(params ConnectCoreV1GetNamespacedPodPortforwardParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1GetNamespacedPodPortforwardHandler interface {
	Handle(ConnectCoreV1GetNamespacedPodPortforwardParams, interface{}) middleware.Responder
}
