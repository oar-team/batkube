...
// ConnectCoreV1GetNamespacedPodProxyParams contains all the bound params for the connect core v1 get namespaced pod proxy operation
...
func (o *ConnectCoreV1GetNamespacedPodProxyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ConnectCoreV1GetNamespacedPodProxyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ConnectCoreV1GetNamespacedPodProxyParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1GetNamespacedPodProxyParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPath binds and validates parameter Path from query.
func (o *ConnectCoreV1GetNamespacedPodProxyParams) bindPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1GetNamespacedPodProxyParams) validatePath(formats strfmt.Registry) error {
