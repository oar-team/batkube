...
// NewPatchCoreV1NamespacedPodParams creates a new PatchCoreV1NamespacedPodParams object
// no default values defined in spec.
func NewPatchCoreV1NamespacedPodParams() PatchCoreV1NamespacedPodParams {

	return PatchCoreV1NamespacedPodParams{}
}

// PatchCoreV1NamespacedPodParams contains all the bound params for the patch core v1 namespaced pod operation
...
func (o *PatchCoreV1NamespacedPodParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchCoreV1NamespacedPodParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchCoreV1NamespacedPodParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedPodParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchCoreV1NamespacedPodParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedPodParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchCoreV1NamespacedPodParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedPodParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchCoreV1NamespacedPodParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedPodParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchCoreV1NamespacedPodParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedPodParams) validatePretty(formats strfmt.Registry) error {
