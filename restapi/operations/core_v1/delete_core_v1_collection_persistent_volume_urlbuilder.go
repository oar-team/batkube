...
// DeleteCoreV1CollectionPersistentVolumeURL generates an URL for the delete core v1 collection persistent volume operation
type DeleteCoreV1CollectionPersistentVolumeURL struct {
...
func (o *DeleteCoreV1CollectionPersistentVolumeURL) WithBasePath(bp string) *DeleteCoreV1CollectionPersistentVolumeURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionPersistentVolumeURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionPersistentVolumeURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/api/v1/persistentvolumes"
...
func (o *DeleteCoreV1CollectionPersistentVolumeURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionPersistentVolumeURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionPersistentVolumeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionPersistentVolumeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionPersistentVolumeURL")
	}
...
func (o *DeleteCoreV1CollectionPersistentVolumeURL) StringFull(scheme, host string) string {
