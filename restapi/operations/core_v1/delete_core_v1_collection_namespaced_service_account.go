...
type DeleteCoreV1CollectionNamespacedServiceAccountHandlerFunc func(DeleteCoreV1CollectionNamespacedServiceAccountParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteCoreV1CollectionNamespacedServiceAccountHandlerFunc) Handle(params DeleteCoreV1CollectionNamespacedServiceAccountParams, principal interface{}) middleware.Responder {
...
type DeleteCoreV1CollectionNamespacedServiceAccountHandler interface {
	Handle(DeleteCoreV1CollectionNamespacedServiceAccountParams, interface{}) middleware.Responder
}
