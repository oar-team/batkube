...
// ConnectCoreV1GetNodeProxyWithPathParams contains all the bound params for the connect core v1 get node proxy with path operation
...
func (o *ConnectCoreV1GetNodeProxyWithPathParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ConnectCoreV1GetNodeProxyWithPathParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPathPath binds and validates parameter PathPath from path.
func (o *ConnectCoreV1GetNodeProxyWithPathParams) bindPathPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1GetNodeProxyWithPathParams) validatePathPath(formats strfmt.Registry) error {

	return nil
}

// bindQueryPath binds and validates parameter QueryPath from query.
func (o *ConnectCoreV1GetNodeProxyWithPathParams) bindQueryPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1GetNodeProxyWithPathParams) validateQueryPath(formats strfmt.Registry) error {
