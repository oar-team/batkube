...
type ListCoreV1ServiceAccountForAllNamespacesHandlerFunc func(ListCoreV1ServiceAccountForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1ServiceAccountForAllNamespacesHandlerFunc) Handle(params ListCoreV1ServiceAccountForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1ServiceAccountForAllNamespacesHandler interface {
	Handle(ListCoreV1ServiceAccountForAllNamespacesParams, interface{}) middleware.Responder
}
