...
// DeleteCoreV1CollectionNodeURL generates an URL for the delete core v1 collection node operation
type DeleteCoreV1CollectionNodeURL struct {
...
func (o *DeleteCoreV1CollectionNodeURL) WithBasePath(bp string) *DeleteCoreV1CollectionNodeURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionNodeURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionNodeURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/api/v1/nodes"
...
func (o *DeleteCoreV1CollectionNodeURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionNodeURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionNodeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionNodeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionNodeURL")
	}
...
func (o *DeleteCoreV1CollectionNodeURL) StringFull(scheme, host string) string {
