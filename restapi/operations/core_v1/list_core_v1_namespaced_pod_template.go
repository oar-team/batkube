...
type ListCoreV1NamespacedPodTemplateHandlerFunc func(ListCoreV1NamespacedPodTemplateParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1NamespacedPodTemplateHandlerFunc) Handle(params ListCoreV1NamespacedPodTemplateParams, principal interface{}) middleware.Responder {
...
type ListCoreV1NamespacedPodTemplateHandler interface {
	Handle(ListCoreV1NamespacedPodTemplateParams, interface{}) middleware.Responder
}
