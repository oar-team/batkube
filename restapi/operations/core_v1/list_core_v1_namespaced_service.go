...
type ListCoreV1NamespacedServiceHandlerFunc func(ListCoreV1NamespacedServiceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1NamespacedServiceHandlerFunc) Handle(params ListCoreV1NamespacedServiceParams, principal interface{}) middleware.Responder {
...
type ListCoreV1NamespacedServiceHandler interface {
	Handle(ListCoreV1NamespacedServiceParams, interface{}) middleware.Responder
}
...
func NewListCoreV1NamespacedService(ctx *middleware.Context, handler ListCoreV1NamespacedServiceHandler) *ListCoreV1NamespacedService {
	return &ListCoreV1NamespacedService{Context: ctx, Handler: handler}
}
...
func (o *ListCoreV1NamespacedService) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewListCoreV1NamespacedServiceParams()
