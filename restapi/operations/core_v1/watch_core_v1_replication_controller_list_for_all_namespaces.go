...
type WatchCoreV1ReplicationControllerListForAllNamespacesHandlerFunc func(WatchCoreV1ReplicationControllerListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1ReplicationControllerListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1ReplicationControllerListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1ReplicationControllerListForAllNamespacesHandler interface {
	Handle(WatchCoreV1ReplicationControllerListForAllNamespacesParams, interface{}) middleware.Responder
}
