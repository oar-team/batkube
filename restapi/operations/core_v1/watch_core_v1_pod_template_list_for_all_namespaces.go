...
type WatchCoreV1PodTemplateListForAllNamespacesHandlerFunc func(WatchCoreV1PodTemplateListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1PodTemplateListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1PodTemplateListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1PodTemplateListForAllNamespacesHandler interface {
	Handle(WatchCoreV1PodTemplateListForAllNamespacesParams, interface{}) middleware.Responder
}
