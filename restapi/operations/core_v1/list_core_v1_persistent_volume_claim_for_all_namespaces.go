...
type ListCoreV1PersistentVolumeClaimForAllNamespacesHandlerFunc func(ListCoreV1PersistentVolumeClaimForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1PersistentVolumeClaimForAllNamespacesHandlerFunc) Handle(params ListCoreV1PersistentVolumeClaimForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1PersistentVolumeClaimForAllNamespacesHandler interface {
	Handle(ListCoreV1PersistentVolumeClaimForAllNamespacesParams, interface{}) middleware.Responder
}
