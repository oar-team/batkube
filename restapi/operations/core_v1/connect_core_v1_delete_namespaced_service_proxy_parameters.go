...
// ConnectCoreV1DeleteNamespacedServiceProxyParams contains all the bound params for the connect core v1 delete namespaced service proxy operation
...
func (o *ConnectCoreV1DeleteNamespacedServiceProxyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ConnectCoreV1DeleteNamespacedServiceProxyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ConnectCoreV1DeleteNamespacedServiceProxyParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1DeleteNamespacedServiceProxyParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPath binds and validates parameter Path from query.
func (o *ConnectCoreV1DeleteNamespacedServiceProxyParams) bindPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1DeleteNamespacedServiceProxyParams) validatePath(formats strfmt.Registry) error {
