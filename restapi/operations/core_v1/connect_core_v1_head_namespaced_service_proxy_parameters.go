...
// ConnectCoreV1HeadNamespacedServiceProxyParams contains all the bound params for the connect core v1 head namespaced service proxy operation
...
func (o *ConnectCoreV1HeadNamespacedServiceProxyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ConnectCoreV1HeadNamespacedServiceProxyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ConnectCoreV1HeadNamespacedServiceProxyParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1HeadNamespacedServiceProxyParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPath binds and validates parameter Path from query.
func (o *ConnectCoreV1HeadNamespacedServiceProxyParams) bindPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1HeadNamespacedServiceProxyParams) validatePath(formats strfmt.Registry) error {
