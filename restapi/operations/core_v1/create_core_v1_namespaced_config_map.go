...
type CreateCoreV1NamespacedConfigMapHandlerFunc func(CreateCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateCoreV1NamespacedConfigMapHandlerFunc) Handle(params CreateCoreV1NamespacedConfigMapParams, principal interface{}) middleware.Responder {
...
type CreateCoreV1NamespacedConfigMapHandler interface {
	Handle(CreateCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder
}
