...
type ListCoreV1ServiceForAllNamespacesHandlerFunc func(ListCoreV1ServiceForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1ServiceForAllNamespacesHandlerFunc) Handle(params ListCoreV1ServiceForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1ServiceForAllNamespacesHandler interface {
	Handle(ListCoreV1ServiceForAllNamespacesParams, interface{}) middleware.Responder
}
