...
// NewPatchCoreV1NamespacedResourceQuotaParams creates a new PatchCoreV1NamespacedResourceQuotaParams object
// no default values defined in spec.
func NewPatchCoreV1NamespacedResourceQuotaParams() PatchCoreV1NamespacedResourceQuotaParams {

	return PatchCoreV1NamespacedResourceQuotaParams{}
}

// PatchCoreV1NamespacedResourceQuotaParams contains all the bound params for the patch core v1 namespaced resource quota operation
...
func (o *PatchCoreV1NamespacedResourceQuotaParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchCoreV1NamespacedResourceQuotaParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchCoreV1NamespacedResourceQuotaParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedResourceQuotaParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchCoreV1NamespacedResourceQuotaParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedResourceQuotaParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchCoreV1NamespacedResourceQuotaParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedResourceQuotaParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchCoreV1NamespacedResourceQuotaParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedResourceQuotaParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchCoreV1NamespacedResourceQuotaParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchCoreV1NamespacedResourceQuotaParams) validatePretty(formats strfmt.Registry) error {
