...
type ListCoreV1ReplicationControllerForAllNamespacesHandlerFunc func(ListCoreV1ReplicationControllerForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1ReplicationControllerForAllNamespacesHandlerFunc) Handle(params ListCoreV1ReplicationControllerForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1ReplicationControllerForAllNamespacesHandler interface {
	Handle(ListCoreV1ReplicationControllerForAllNamespacesParams, interface{}) middleware.Responder
}
