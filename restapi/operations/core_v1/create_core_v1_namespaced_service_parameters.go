...
// NewCreateCoreV1NamespacedServiceParams creates a new CreateCoreV1NamespacedServiceParams object
// no default values defined in spec.
func NewCreateCoreV1NamespacedServiceParams() CreateCoreV1NamespacedServiceParams {

	return CreateCoreV1NamespacedServiceParams{}
}

// CreateCoreV1NamespacedServiceParams contains all the bound params for the create core v1 namespaced service operation
...
func (o *CreateCoreV1NamespacedServiceParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateCoreV1NamespacedServiceParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateCoreV1NamespacedServiceParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedServiceParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateCoreV1NamespacedServiceParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedServiceParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateCoreV1NamespacedServiceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedServiceParams) validatePretty(formats strfmt.Registry) error {
