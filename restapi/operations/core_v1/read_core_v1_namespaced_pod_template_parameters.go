...
// NewReadCoreV1NamespacedPodTemplateParams creates a new ReadCoreV1NamespacedPodTemplateParams object
// no default values defined in spec.
func NewReadCoreV1NamespacedPodTemplateParams() ReadCoreV1NamespacedPodTemplateParams {

	return ReadCoreV1NamespacedPodTemplateParams{}
}

// ReadCoreV1NamespacedPodTemplateParams contains all the bound params for the read core v1 namespaced pod template operation
...
func (o *ReadCoreV1NamespacedPodTemplateParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadCoreV1NamespacedPodTemplateParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadCoreV1NamespacedPodTemplateParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadCoreV1NamespacedPodTemplateParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadCoreV1NamespacedPodTemplateParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadCoreV1NamespacedPodTemplateParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadCoreV1NamespacedPodTemplateParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadCoreV1NamespacedPodTemplateParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadCoreV1NamespacedPodTemplateParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadCoreV1NamespacedPodTemplateParams) validatePretty(formats strfmt.Registry) error {
