...
type ConnectCoreV1DeleteNodeProxyHandlerFunc func(ConnectCoreV1DeleteNodeProxyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1DeleteNodeProxyHandlerFunc) Handle(params ConnectCoreV1DeleteNodeProxyParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1DeleteNodeProxyHandler interface {
	Handle(ConnectCoreV1DeleteNodeProxyParams, interface{}) middleware.Responder
}
