...
// DeleteCoreV1CollectionNamespacedLimitRangeURL generates an URL for the delete core v1 collection namespaced limit range operation
type DeleteCoreV1CollectionNamespacedLimitRangeURL struct {
	Namespace string
...
func (o *DeleteCoreV1CollectionNamespacedLimitRangeURL) WithBasePath(bp string) *DeleteCoreV1CollectionNamespacedLimitRangeURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionNamespacedLimitRangeURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionNamespacedLimitRangeURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/api/v1/namespaces/{namespace}/limitranges"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteCoreV1CollectionNamespacedLimitRangeURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedLimitRangeURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionNamespacedLimitRangeURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionNamespacedLimitRangeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionNamespacedLimitRangeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionNamespacedLimitRangeURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedLimitRangeURL) StringFull(scheme, host string) string {
