...
type ConnectCoreV1PostNamespacedPodPortforwardHandlerFunc func(ConnectCoreV1PostNamespacedPodPortforwardParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1PostNamespacedPodPortforwardHandlerFunc) Handle(params ConnectCoreV1PostNamespacedPodPortforwardParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1PostNamespacedPodPortforwardHandler interface {
	Handle(ConnectCoreV1PostNamespacedPodPortforwardParams, interface{}) middleware.Responder
}
