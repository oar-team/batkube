...
type PatchCoreV1NamespacedConfigMapHandlerFunc func(PatchCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchCoreV1NamespacedConfigMapHandlerFunc) Handle(params PatchCoreV1NamespacedConfigMapParams, principal interface{}) middleware.Responder {
...
type PatchCoreV1NamespacedConfigMapHandler interface {
	Handle(PatchCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder
}
