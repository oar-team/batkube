...
// NewCreateCoreV1NamespacedResourceQuotaParams creates a new CreateCoreV1NamespacedResourceQuotaParams object
// no default values defined in spec.
func NewCreateCoreV1NamespacedResourceQuotaParams() CreateCoreV1NamespacedResourceQuotaParams {

	return CreateCoreV1NamespacedResourceQuotaParams{}
}

// CreateCoreV1NamespacedResourceQuotaParams contains all the bound params for the create core v1 namespaced resource quota operation
...
func (o *CreateCoreV1NamespacedResourceQuotaParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateCoreV1NamespacedResourceQuotaParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateCoreV1NamespacedResourceQuotaParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedResourceQuotaParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateCoreV1NamespacedResourceQuotaParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedResourceQuotaParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateCoreV1NamespacedResourceQuotaParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedResourceQuotaParams) validatePretty(formats strfmt.Registry) error {
