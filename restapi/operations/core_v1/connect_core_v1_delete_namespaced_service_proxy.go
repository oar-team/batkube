...
type ConnectCoreV1DeleteNamespacedServiceProxyHandlerFunc func(ConnectCoreV1DeleteNamespacedServiceProxyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1DeleteNamespacedServiceProxyHandlerFunc) Handle(params ConnectCoreV1DeleteNamespacedServiceProxyParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1DeleteNamespacedServiceProxyHandler interface {
	Handle(ConnectCoreV1DeleteNamespacedServiceProxyParams, interface{}) middleware.Responder
}
