...
type WatchCoreV1LimitRangeListForAllNamespacesHandlerFunc func(WatchCoreV1LimitRangeListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1LimitRangeListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1LimitRangeListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1LimitRangeListForAllNamespacesHandler interface {
	Handle(WatchCoreV1LimitRangeListForAllNamespacesParams, interface{}) middleware.Responder
}
