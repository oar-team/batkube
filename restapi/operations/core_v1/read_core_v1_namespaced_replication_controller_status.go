...
type ReadCoreV1NamespacedReplicationControllerStatusHandlerFunc func(ReadCoreV1NamespacedReplicationControllerStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoreV1NamespacedReplicationControllerStatusHandlerFunc) Handle(params ReadCoreV1NamespacedReplicationControllerStatusParams, principal interface{}) middleware.Responder {
...
type ReadCoreV1NamespacedReplicationControllerStatusHandler interface {
	Handle(ReadCoreV1NamespacedReplicationControllerStatusParams, interface{}) middleware.Responder
}
