...
type CreateCoreV1NamespacedLimitRangeHandlerFunc func(CreateCoreV1NamespacedLimitRangeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateCoreV1NamespacedLimitRangeHandlerFunc) Handle(params CreateCoreV1NamespacedLimitRangeParams, principal interface{}) middleware.Responder {
...
type CreateCoreV1NamespacedLimitRangeHandler interface {
	Handle(CreateCoreV1NamespacedLimitRangeParams, interface{}) middleware.Responder
}
