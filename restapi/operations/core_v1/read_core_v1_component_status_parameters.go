...
// NewReadCoreV1ComponentStatusParams creates a new ReadCoreV1ComponentStatusParams object
// no default values defined in spec.
func NewReadCoreV1ComponentStatusParams() ReadCoreV1ComponentStatusParams {

	return ReadCoreV1ComponentStatusParams{}
}

// ReadCoreV1ComponentStatusParams contains all the bound params for the read core v1 component status operation
...
func (o *ReadCoreV1ComponentStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadCoreV1ComponentStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadCoreV1ComponentStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadCoreV1ComponentStatusParams) validatePretty(formats strfmt.Registry) error {
