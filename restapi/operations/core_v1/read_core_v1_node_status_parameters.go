...
// NewReadCoreV1NodeStatusParams creates a new ReadCoreV1NodeStatusParams object
// no default values defined in spec.
func NewReadCoreV1NodeStatusParams() ReadCoreV1NodeStatusParams {

	return ReadCoreV1NodeStatusParams{}
}

// ReadCoreV1NodeStatusParams contains all the bound params for the read core v1 node status operation
...
func (o *ReadCoreV1NodeStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadCoreV1NodeStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadCoreV1NodeStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadCoreV1NodeStatusParams) validatePretty(formats strfmt.Registry) error {
