...
type WatchCoreV1NamespacedPodHandlerFunc func(WatchCoreV1NamespacedPodParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1NamespacedPodHandlerFunc) Handle(params WatchCoreV1NamespacedPodParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1NamespacedPodHandler interface {
	Handle(WatchCoreV1NamespacedPodParams, interface{}) middleware.Responder
}
...
func NewWatchCoreV1NamespacedPod(ctx *middleware.Context, handler WatchCoreV1NamespacedPodHandler) *WatchCoreV1NamespacedPod {
	return &WatchCoreV1NamespacedPod{Context: ctx, Handler: handler}
}
...
func (o *WatchCoreV1NamespacedPod) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewWatchCoreV1NamespacedPodParams()
