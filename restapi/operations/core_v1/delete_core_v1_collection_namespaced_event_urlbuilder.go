...
// DeleteCoreV1CollectionNamespacedEventURL generates an URL for the delete core v1 collection namespaced event operation
type DeleteCoreV1CollectionNamespacedEventURL struct {
	Namespace string
...
func (o *DeleteCoreV1CollectionNamespacedEventURL) WithBasePath(bp string) *DeleteCoreV1CollectionNamespacedEventURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionNamespacedEventURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionNamespacedEventURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/api/v1/namespaces/{namespace}/events"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteCoreV1CollectionNamespacedEventURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedEventURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionNamespacedEventURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionNamespacedEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionNamespacedEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionNamespacedEventURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedEventURL) StringFull(scheme, host string) string {
