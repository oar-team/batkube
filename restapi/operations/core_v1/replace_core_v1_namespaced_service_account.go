...
type ReplaceCoreV1NamespacedServiceAccountHandlerFunc func(ReplaceCoreV1NamespacedServiceAccountParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceCoreV1NamespacedServiceAccountHandlerFunc) Handle(params ReplaceCoreV1NamespacedServiceAccountParams, principal interface{}) middleware.Responder {
...
type ReplaceCoreV1NamespacedServiceAccountHandler interface {
	Handle(ReplaceCoreV1NamespacedServiceAccountParams, interface{}) middleware.Responder
}
