...
type CreateCoreV1NamespacedPersistentVolumeClaimHandlerFunc func(CreateCoreV1NamespacedPersistentVolumeClaimParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateCoreV1NamespacedPersistentVolumeClaimHandlerFunc) Handle(params CreateCoreV1NamespacedPersistentVolumeClaimParams, principal interface{}) middleware.Responder {
...
type CreateCoreV1NamespacedPersistentVolumeClaimHandler interface {
	Handle(CreateCoreV1NamespacedPersistentVolumeClaimParams, interface{}) middleware.Responder
}
