...
type WatchCoreV1EventListForAllNamespacesHandlerFunc func(WatchCoreV1EventListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1EventListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1EventListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1EventListForAllNamespacesHandler interface {
	Handle(WatchCoreV1EventListForAllNamespacesParams, interface{}) middleware.Responder
}
...
func NewWatchCoreV1EventListForAllNamespaces(ctx *middleware.Context, handler WatchCoreV1EventListForAllNamespacesHandler) *WatchCoreV1EventListForAllNamespaces {
	return &WatchCoreV1EventListForAllNamespaces{Context: ctx, Handler: handler}
}
...
func (o *WatchCoreV1EventListForAllNamespaces) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewWatchCoreV1EventListForAllNamespacesParams()
