...
// DeleteCoreV1CollectionNamespacedSecretURL generates an URL for the delete core v1 collection namespaced secret operation
type DeleteCoreV1CollectionNamespacedSecretURL struct {
	Namespace string
...
func (o *DeleteCoreV1CollectionNamespacedSecretURL) WithBasePath(bp string) *DeleteCoreV1CollectionNamespacedSecretURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionNamespacedSecretURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionNamespacedSecretURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/api/v1/namespaces/{namespace}/secrets"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteCoreV1CollectionNamespacedSecretURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedSecretURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionNamespacedSecretURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionNamespacedSecretURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionNamespacedSecretURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionNamespacedSecretURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedSecretURL) StringFull(scheme, host string) string {
