...
// DeleteCoreV1CollectionNamespacedConfigMapURL generates an URL for the delete core v1 collection namespaced config map operation
type DeleteCoreV1CollectionNamespacedConfigMapURL struct {
	Namespace string
...
func (o *DeleteCoreV1CollectionNamespacedConfigMapURL) WithBasePath(bp string) *DeleteCoreV1CollectionNamespacedConfigMapURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionNamespacedConfigMapURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionNamespacedConfigMapURL) Build() (*url.URL, error) {
	var _result url.URL
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on DeleteCoreV1CollectionNamespacedConfigMapURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedConfigMapURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionNamespacedConfigMapURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionNamespacedConfigMapURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionNamespacedConfigMapURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionNamespacedConfigMapURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedConfigMapURL) StringFull(scheme, host string) string {
