...
type ConnectCoreV1PutNodeProxyHandlerFunc func(ConnectCoreV1PutNodeProxyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1PutNodeProxyHandlerFunc) Handle(params ConnectCoreV1PutNodeProxyParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1PutNodeProxyHandler interface {
	Handle(ConnectCoreV1PutNodeProxyParams, interface{}) middleware.Responder
}
