...
// ListCoreV1NodeURL generates an URL for the list core v1 node operation
type ListCoreV1NodeURL struct {
...
func (o *ListCoreV1NodeURL) WithBasePath(bp string) *ListCoreV1NodeURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *ListCoreV1NodeURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *ListCoreV1NodeURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *ListCoreV1NodeURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *ListCoreV1NodeURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *ListCoreV1NodeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListCoreV1NodeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListCoreV1NodeURL")
	}
...
func (o *ListCoreV1NodeURL) StringFull(scheme, host string) string {
