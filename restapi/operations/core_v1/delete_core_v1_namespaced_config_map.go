...
type DeleteCoreV1NamespacedConfigMapHandlerFunc func(DeleteCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteCoreV1NamespacedConfigMapHandlerFunc) Handle(params DeleteCoreV1NamespacedConfigMapParams, principal interface{}) middleware.Responder {
...
type DeleteCoreV1NamespacedConfigMapHandler interface {
	Handle(DeleteCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder
}
