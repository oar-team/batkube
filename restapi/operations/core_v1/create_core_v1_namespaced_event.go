...
type CreateCoreV1NamespacedEventHandlerFunc func(CreateCoreV1NamespacedEventParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateCoreV1NamespacedEventHandlerFunc) Handle(params CreateCoreV1NamespacedEventParams, principal interface{}) middleware.Responder {
...
type CreateCoreV1NamespacedEventHandler interface {
	Handle(CreateCoreV1NamespacedEventParams, interface{}) middleware.Responder
}
