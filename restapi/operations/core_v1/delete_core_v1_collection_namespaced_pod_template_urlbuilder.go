...
// DeleteCoreV1CollectionNamespacedPodTemplateURL generates an URL for the delete core v1 collection namespaced pod template operation
type DeleteCoreV1CollectionNamespacedPodTemplateURL struct {
	Namespace string
...
func (o *DeleteCoreV1CollectionNamespacedPodTemplateURL) WithBasePath(bp string) *DeleteCoreV1CollectionNamespacedPodTemplateURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionNamespacedPodTemplateURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionNamespacedPodTemplateURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/api/v1/namespaces/{namespace}/podtemplates"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteCoreV1CollectionNamespacedPodTemplateURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedPodTemplateURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionNamespacedPodTemplateURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionNamespacedPodTemplateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionNamespacedPodTemplateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionNamespacedPodTemplateURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedPodTemplateURL) StringFull(scheme, host string) string {
