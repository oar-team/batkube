...
type ReplaceCoreV1NamespacedResourceQuotaHandlerFunc func(ReplaceCoreV1NamespacedResourceQuotaParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceCoreV1NamespacedResourceQuotaHandlerFunc) Handle(params ReplaceCoreV1NamespacedResourceQuotaParams, principal interface{}) middleware.Responder {
...
type ReplaceCoreV1NamespacedResourceQuotaHandler interface {
	Handle(ReplaceCoreV1NamespacedResourceQuotaParams, interface{}) middleware.Responder
}
