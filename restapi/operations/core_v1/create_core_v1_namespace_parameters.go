...
// NewCreateCoreV1NamespaceParams creates a new CreateCoreV1NamespaceParams object
// no default values defined in spec.
func NewCreateCoreV1NamespaceParams() CreateCoreV1NamespaceParams {

	return CreateCoreV1NamespaceParams{}
}

// CreateCoreV1NamespaceParams contains all the bound params for the create core v1 namespace operation
...
func (o *CreateCoreV1NamespaceParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateCoreV1NamespaceParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateCoreV1NamespaceParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespaceParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateCoreV1NamespaceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespaceParams) validatePretty(formats strfmt.Registry) error {
