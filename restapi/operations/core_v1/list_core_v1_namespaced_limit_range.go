...
type ListCoreV1NamespacedLimitRangeHandlerFunc func(ListCoreV1NamespacedLimitRangeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1NamespacedLimitRangeHandlerFunc) Handle(params ListCoreV1NamespacedLimitRangeParams, principal interface{}) middleware.Responder {
...
type ListCoreV1NamespacedLimitRangeHandler interface {
	Handle(ListCoreV1NamespacedLimitRangeParams, interface{}) middleware.Responder
}
...
func NewListCoreV1NamespacedLimitRange(ctx *middleware.Context, handler ListCoreV1NamespacedLimitRangeHandler) *ListCoreV1NamespacedLimitRange {
	return &ListCoreV1NamespacedLimitRange{Context: ctx, Handler: handler}
}
...
func (o *ListCoreV1NamespacedLimitRange) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewListCoreV1NamespacedLimitRangeParams()
