...
type ReplaceCoreV1NamespacedEventHandlerFunc func(ReplaceCoreV1NamespacedEventParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceCoreV1NamespacedEventHandlerFunc) Handle(params ReplaceCoreV1NamespacedEventParams, principal interface{}) middleware.Responder {
...
type ReplaceCoreV1NamespacedEventHandler interface {
	Handle(ReplaceCoreV1NamespacedEventParams, interface{}) middleware.Responder
}
