...
// NewCreateCoreV1NamespacedConfigMapParams creates a new CreateCoreV1NamespacedConfigMapParams object
// no default values defined in spec.
func NewCreateCoreV1NamespacedConfigMapParams() CreateCoreV1NamespacedConfigMapParams {

	return CreateCoreV1NamespacedConfigMapParams{}
}

// CreateCoreV1NamespacedConfigMapParams contains all the bound params for the create core v1 namespaced config map operation
...
func (o *CreateCoreV1NamespacedConfigMapParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateCoreV1NamespacedConfigMapParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateCoreV1NamespacedConfigMapParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedConfigMapParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateCoreV1NamespacedConfigMapParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedConfigMapParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateCoreV1NamespacedConfigMapParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedConfigMapParams) validatePretty(formats strfmt.Registry) error {
