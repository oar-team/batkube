...
// ConnectCoreV1PostNodeProxyParams contains all the bound params for the connect core v1 post node proxy operation
...
func (o *ConnectCoreV1PostNodeProxyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ConnectCoreV1PostNodeProxyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPath binds and validates parameter Path from query.
func (o *ConnectCoreV1PostNodeProxyParams) bindPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1PostNodeProxyParams) validatePath(formats strfmt.Registry) error {
