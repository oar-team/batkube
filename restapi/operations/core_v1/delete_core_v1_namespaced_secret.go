...
type DeleteCoreV1NamespacedSecretHandlerFunc func(DeleteCoreV1NamespacedSecretParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteCoreV1NamespacedSecretHandlerFunc) Handle(params DeleteCoreV1NamespacedSecretParams, principal interface{}) middleware.Responder {
...
type DeleteCoreV1NamespacedSecretHandler interface {
	Handle(DeleteCoreV1NamespacedSecretParams, interface{}) middleware.Responder
}
