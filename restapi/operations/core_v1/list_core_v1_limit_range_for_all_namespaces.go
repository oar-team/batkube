...
type ListCoreV1LimitRangeForAllNamespacesHandlerFunc func(ListCoreV1LimitRangeForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1LimitRangeForAllNamespacesHandlerFunc) Handle(params ListCoreV1LimitRangeForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1LimitRangeForAllNamespacesHandler interface {
	Handle(ListCoreV1LimitRangeForAllNamespacesParams, interface{}) middleware.Responder
}
