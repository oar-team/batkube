...
type WatchCoreV1NamespacedServiceHandlerFunc func(WatchCoreV1NamespacedServiceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1NamespacedServiceHandlerFunc) Handle(params WatchCoreV1NamespacedServiceParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1NamespacedServiceHandler interface {
	Handle(WatchCoreV1NamespacedServiceParams, interface{}) middleware.Responder
}
