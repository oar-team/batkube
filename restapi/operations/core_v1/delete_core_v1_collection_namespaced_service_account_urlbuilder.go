...
// DeleteCoreV1CollectionNamespacedServiceAccountURL generates an URL for the delete core v1 collection namespaced service account operation
type DeleteCoreV1CollectionNamespacedServiceAccountURL struct {
	Namespace string
...
func (o *DeleteCoreV1CollectionNamespacedServiceAccountURL) WithBasePath(bp string) *DeleteCoreV1CollectionNamespacedServiceAccountURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCoreV1CollectionNamespacedServiceAccountURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteCoreV1CollectionNamespacedServiceAccountURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/api/v1/namespaces/{namespace}/serviceaccounts"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteCoreV1CollectionNamespacedServiceAccountURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedServiceAccountURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCoreV1CollectionNamespacedServiceAccountURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCoreV1CollectionNamespacedServiceAccountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCoreV1CollectionNamespacedServiceAccountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCoreV1CollectionNamespacedServiceAccountURL")
	}
...
func (o *DeleteCoreV1CollectionNamespacedServiceAccountURL) StringFull(scheme, host string) string {
