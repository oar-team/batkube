...
type ListCoreV1NamespaceHandlerFunc func(ListCoreV1NamespaceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1NamespaceHandlerFunc) Handle(params ListCoreV1NamespaceParams, principal interface{}) middleware.Responder {
...
type ListCoreV1NamespaceHandler interface {
	Handle(ListCoreV1NamespaceParams, interface{}) middleware.Responder
}
