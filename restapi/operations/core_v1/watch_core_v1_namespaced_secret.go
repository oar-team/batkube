...
type WatchCoreV1NamespacedSecretHandlerFunc func(WatchCoreV1NamespacedSecretParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1NamespacedSecretHandlerFunc) Handle(params WatchCoreV1NamespacedSecretParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1NamespacedSecretHandler interface {
	Handle(WatchCoreV1NamespacedSecretParams, interface{}) middleware.Responder
}
