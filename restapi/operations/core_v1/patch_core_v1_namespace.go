...
type PatchCoreV1NamespaceHandlerFunc func(PatchCoreV1NamespaceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchCoreV1NamespaceHandlerFunc) Handle(params PatchCoreV1NamespaceParams, principal interface{}) middleware.Responder {
...
type PatchCoreV1NamespaceHandler interface {
	Handle(PatchCoreV1NamespaceParams, interface{}) middleware.Responder
}
