...
type ReadCoreV1NamespacedPersistentVolumeClaimStatusHandlerFunc func(ReadCoreV1NamespacedPersistentVolumeClaimStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoreV1NamespacedPersistentVolumeClaimStatusHandlerFunc) Handle(params ReadCoreV1NamespacedPersistentVolumeClaimStatusParams, principal interface{}) middleware.Responder {
...
type ReadCoreV1NamespacedPersistentVolumeClaimStatusHandler interface {
	Handle(ReadCoreV1NamespacedPersistentVolumeClaimStatusParams, interface{}) middleware.Responder
}
