...
type ConnectCoreV1PostNamespacedPodProxyWithPathHandlerFunc func(ConnectCoreV1PostNamespacedPodProxyWithPathParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1PostNamespacedPodProxyWithPathHandlerFunc) Handle(params ConnectCoreV1PostNamespacedPodProxyWithPathParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1PostNamespacedPodProxyWithPathHandler interface {
	Handle(ConnectCoreV1PostNamespacedPodProxyWithPathParams, interface{}) middleware.Responder
}
