...
type ListCoreV1PodTemplateForAllNamespacesHandlerFunc func(ListCoreV1PodTemplateForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1PodTemplateForAllNamespacesHandlerFunc) Handle(params ListCoreV1PodTemplateForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1PodTemplateForAllNamespacesHandler interface {
	Handle(ListCoreV1PodTemplateForAllNamespacesParams, interface{}) middleware.Responder
}
