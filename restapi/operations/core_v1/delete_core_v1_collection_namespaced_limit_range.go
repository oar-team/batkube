...
type DeleteCoreV1CollectionNamespacedLimitRangeHandlerFunc func(DeleteCoreV1CollectionNamespacedLimitRangeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteCoreV1CollectionNamespacedLimitRangeHandlerFunc) Handle(params DeleteCoreV1CollectionNamespacedLimitRangeParams, principal interface{}) middleware.Responder {
...
type DeleteCoreV1CollectionNamespacedLimitRangeHandler interface {
	Handle(DeleteCoreV1CollectionNamespacedLimitRangeParams, interface{}) middleware.Responder
}
