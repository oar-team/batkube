...
type ConnectCoreV1PostNamespacedPodExecHandlerFunc func(ConnectCoreV1PostNamespacedPodExecParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1PostNamespacedPodExecHandlerFunc) Handle(params ConnectCoreV1PostNamespacedPodExecParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1PostNamespacedPodExecHandler interface {
	Handle(ConnectCoreV1PostNamespacedPodExecParams, interface{}) middleware.Responder
}
