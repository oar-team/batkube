...
type ReadCoreV1NamespacedServiceAccountHandlerFunc func(ReadCoreV1NamespacedServiceAccountParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoreV1NamespacedServiceAccountHandlerFunc) Handle(params ReadCoreV1NamespacedServiceAccountParams, principal interface{}) middleware.Responder {
...
type ReadCoreV1NamespacedServiceAccountHandler interface {
	Handle(ReadCoreV1NamespacedServiceAccountParams, interface{}) middleware.Responder
}
