...
type ReadCoreV1NamespacedResourceQuotaStatusHandlerFunc func(ReadCoreV1NamespacedResourceQuotaStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoreV1NamespacedResourceQuotaStatusHandlerFunc) Handle(params ReadCoreV1NamespacedResourceQuotaStatusParams, principal interface{}) middleware.Responder {
...
type ReadCoreV1NamespacedResourceQuotaStatusHandler interface {
	Handle(ReadCoreV1NamespacedResourceQuotaStatusParams, interface{}) middleware.Responder
}
