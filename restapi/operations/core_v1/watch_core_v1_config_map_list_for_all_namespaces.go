...
type WatchCoreV1ConfigMapListForAllNamespacesHandlerFunc func(WatchCoreV1ConfigMapListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1ConfigMapListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1ConfigMapListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1ConfigMapListForAllNamespacesHandler interface {
	Handle(WatchCoreV1ConfigMapListForAllNamespacesParams, interface{}) middleware.Responder
}
