...
type ReadCoreV1NamespacedLimitRangeHandlerFunc func(ReadCoreV1NamespacedLimitRangeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoreV1NamespacedLimitRangeHandlerFunc) Handle(params ReadCoreV1NamespacedLimitRangeParams, principal interface{}) middleware.Responder {
...
type ReadCoreV1NamespacedLimitRangeHandler interface {
	Handle(ReadCoreV1NamespacedLimitRangeParams, interface{}) middleware.Responder
}
