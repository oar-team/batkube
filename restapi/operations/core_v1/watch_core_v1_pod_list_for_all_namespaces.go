...
type WatchCoreV1PodListForAllNamespacesHandlerFunc func(WatchCoreV1PodListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1PodListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1PodListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1PodListForAllNamespacesHandler interface {
	Handle(WatchCoreV1PodListForAllNamespacesParams, interface{}) middleware.Responder
}
