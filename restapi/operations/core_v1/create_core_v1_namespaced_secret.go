...
type CreateCoreV1NamespacedSecretHandlerFunc func(CreateCoreV1NamespacedSecretParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateCoreV1NamespacedSecretHandlerFunc) Handle(params CreateCoreV1NamespacedSecretParams, principal interface{}) middleware.Responder {
...
type CreateCoreV1NamespacedSecretHandler interface {
	Handle(CreateCoreV1NamespacedSecretParams, interface{}) middleware.Responder
}
