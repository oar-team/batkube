...
type WatchCoreV1NamespacedServiceAccountListHandlerFunc func(WatchCoreV1NamespacedServiceAccountListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1NamespacedServiceAccountListHandlerFunc) Handle(params WatchCoreV1NamespacedServiceAccountListParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1NamespacedServiceAccountListHandler interface {
	Handle(WatchCoreV1NamespacedServiceAccountListParams, interface{}) middleware.Responder
}
