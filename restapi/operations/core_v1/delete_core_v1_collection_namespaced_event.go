...
type DeleteCoreV1CollectionNamespacedEventHandlerFunc func(DeleteCoreV1CollectionNamespacedEventParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteCoreV1CollectionNamespacedEventHandlerFunc) Handle(params DeleteCoreV1CollectionNamespacedEventParams, principal interface{}) middleware.Responder {
...
type DeleteCoreV1CollectionNamespacedEventHandler interface {
	Handle(DeleteCoreV1CollectionNamespacedEventParams, interface{}) middleware.Responder
}
