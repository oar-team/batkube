...
type ReplaceCoreV1NamespacedResourceQuotaStatusHandlerFunc func(ReplaceCoreV1NamespacedResourceQuotaStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceCoreV1NamespacedResourceQuotaStatusHandlerFunc) Handle(params ReplaceCoreV1NamespacedResourceQuotaStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceCoreV1NamespacedResourceQuotaStatusHandler interface {
	Handle(ReplaceCoreV1NamespacedResourceQuotaStatusParams, interface{}) middleware.Responder
}
