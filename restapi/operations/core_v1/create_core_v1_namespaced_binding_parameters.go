...
// NewCreateCoreV1NamespacedBindingParams creates a new CreateCoreV1NamespacedBindingParams object
// no default values defined in spec.
func NewCreateCoreV1NamespacedBindingParams() CreateCoreV1NamespacedBindingParams {

	return CreateCoreV1NamespacedBindingParams{}
}

// CreateCoreV1NamespacedBindingParams contains all the bound params for the create core v1 namespaced binding operation
...
func (o *CreateCoreV1NamespacedBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateCoreV1NamespacedBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateCoreV1NamespacedBindingParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedBindingParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateCoreV1NamespacedBindingParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedBindingParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateCoreV1NamespacedBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateCoreV1NamespacedBindingParams) validatePretty(formats strfmt.Registry) error {
