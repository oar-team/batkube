...
type ListCoreV1ConfigMapForAllNamespacesHandlerFunc func(ListCoreV1ConfigMapForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1ConfigMapForAllNamespacesHandlerFunc) Handle(params ListCoreV1ConfigMapForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1ConfigMapForAllNamespacesHandler interface {
	Handle(ListCoreV1ConfigMapForAllNamespacesParams, interface{}) middleware.Responder
}
