...
type ReadCoreV1NamespacedPodLogHandlerFunc func(ReadCoreV1NamespacedPodLogParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoreV1NamespacedPodLogHandlerFunc) Handle(params ReadCoreV1NamespacedPodLogParams, principal interface{}) middleware.Responder {
...
type ReadCoreV1NamespacedPodLogHandler interface {
	Handle(ReadCoreV1NamespacedPodLogParams, interface{}) middleware.Responder
}
