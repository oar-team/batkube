...
type ConnectCoreV1PatchNodeProxyWithPathHandlerFunc func(ConnectCoreV1PatchNodeProxyWithPathParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1PatchNodeProxyWithPathHandlerFunc) Handle(params ConnectCoreV1PatchNodeProxyWithPathParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1PatchNodeProxyWithPathHandler interface {
	Handle(ConnectCoreV1PatchNodeProxyWithPathParams, interface{}) middleware.Responder
}
