...
type ConnectCoreV1PostNamespacedPodAttachHandlerFunc func(ConnectCoreV1PostNamespacedPodAttachParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ConnectCoreV1PostNamespacedPodAttachHandlerFunc) Handle(params ConnectCoreV1PostNamespacedPodAttachParams, principal interface{}) middleware.Responder {
...
type ConnectCoreV1PostNamespacedPodAttachHandler interface {
	Handle(ConnectCoreV1PostNamespacedPodAttachParams, interface{}) middleware.Responder
}
