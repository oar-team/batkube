...
type GetCoreV1APIResourcesHandlerFunc func(GetCoreV1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetCoreV1APIResourcesHandlerFunc) Handle(params GetCoreV1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetCoreV1APIResourcesHandler interface {
	Handle(GetCoreV1APIResourcesParams, interface{}) middleware.Responder
}
