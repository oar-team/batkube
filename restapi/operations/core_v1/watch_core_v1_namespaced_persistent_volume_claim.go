...
type WatchCoreV1NamespacedPersistentVolumeClaimHandlerFunc func(WatchCoreV1NamespacedPersistentVolumeClaimParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1NamespacedPersistentVolumeClaimHandlerFunc) Handle(params WatchCoreV1NamespacedPersistentVolumeClaimParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1NamespacedPersistentVolumeClaimHandler interface {
	Handle(WatchCoreV1NamespacedPersistentVolumeClaimParams, interface{}) middleware.Responder
}
