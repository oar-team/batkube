...
// NewReplaceCoreV1NamespaceFinalizeParams creates a new ReplaceCoreV1NamespaceFinalizeParams object
// no default values defined in spec.
func NewReplaceCoreV1NamespaceFinalizeParams() ReplaceCoreV1NamespaceFinalizeParams {

	return ReplaceCoreV1NamespaceFinalizeParams{}
}

// ReplaceCoreV1NamespaceFinalizeParams contains all the bound params for the replace core v1 namespace finalize operation
...
func (o *ReplaceCoreV1NamespaceFinalizeParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceCoreV1NamespaceFinalizeParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceCoreV1NamespaceFinalizeParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceCoreV1NamespaceFinalizeParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceCoreV1NamespaceFinalizeParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceCoreV1NamespaceFinalizeParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceCoreV1NamespaceFinalizeParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceCoreV1NamespaceFinalizeParams) validatePretty(formats strfmt.Registry) error {
