...
// ConnectCoreV1HeadNodeProxyParams contains all the bound params for the connect core v1 head node proxy operation
...
func (o *ConnectCoreV1HeadNodeProxyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ConnectCoreV1HeadNodeProxyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPath binds and validates parameter Path from query.
func (o *ConnectCoreV1HeadNodeProxyParams) bindPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1HeadNodeProxyParams) validatePath(formats strfmt.Registry) error {
