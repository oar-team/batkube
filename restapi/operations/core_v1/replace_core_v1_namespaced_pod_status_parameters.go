...
// NewReplaceCoreV1NamespacedPodStatusParams creates a new ReplaceCoreV1NamespacedPodStatusParams object
// no default values defined in spec.
func NewReplaceCoreV1NamespacedPodStatusParams() ReplaceCoreV1NamespacedPodStatusParams {

	return ReplaceCoreV1NamespacedPodStatusParams{}
}

// ReplaceCoreV1NamespacedPodStatusParams contains all the bound params for the replace core v1 namespaced pod status operation
...
func (o *ReplaceCoreV1NamespacedPodStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceCoreV1NamespacedPodStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceCoreV1NamespacedPodStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceCoreV1NamespacedPodStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceCoreV1NamespacedPodStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceCoreV1NamespacedPodStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReplaceCoreV1NamespacedPodStatusParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceCoreV1NamespacedPodStatusParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceCoreV1NamespacedPodStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceCoreV1NamespacedPodStatusParams) validatePretty(formats strfmt.Registry) error {
