...
// ConnectCoreV1DeleteNamespacedPodProxyWithPathParams contains all the bound params for the connect core v1 delete namespaced pod proxy with path operation
...
func (o *ConnectCoreV1DeleteNamespacedPodProxyWithPathParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ConnectCoreV1DeleteNamespacedPodProxyWithPathParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ConnectCoreV1DeleteNamespacedPodProxyWithPathParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ConnectCoreV1DeleteNamespacedPodProxyWithPathParams) validateNamespace(formats strfmt.Registry) error {
