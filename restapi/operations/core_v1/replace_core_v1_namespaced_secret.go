...
type ReplaceCoreV1NamespacedSecretHandlerFunc func(ReplaceCoreV1NamespacedSecretParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceCoreV1NamespacedSecretHandlerFunc) Handle(params ReplaceCoreV1NamespacedSecretParams, principal interface{}) middleware.Responder {
...
type ReplaceCoreV1NamespacedSecretHandler interface {
	Handle(ReplaceCoreV1NamespacedSecretParams, interface{}) middleware.Responder
}
