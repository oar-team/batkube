...
type WatchCoreV1ResourceQuotaListForAllNamespacesHandlerFunc func(WatchCoreV1ResourceQuotaListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1ResourceQuotaListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1ResourceQuotaListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1ResourceQuotaListForAllNamespacesHandler interface {
	Handle(WatchCoreV1ResourceQuotaListForAllNamespacesParams, interface{}) middleware.Responder
}
