...
type ReadCoreV1NamespacedConfigMapHandlerFunc func(ReadCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCoreV1NamespacedConfigMapHandlerFunc) Handle(params ReadCoreV1NamespacedConfigMapParams, principal interface{}) middleware.Responder {
...
type ReadCoreV1NamespacedConfigMapHandler interface {
	Handle(ReadCoreV1NamespacedConfigMapParams, interface{}) middleware.Responder
}
