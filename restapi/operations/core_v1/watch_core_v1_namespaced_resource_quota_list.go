...
type WatchCoreV1NamespacedResourceQuotaListHandlerFunc func(WatchCoreV1NamespacedResourceQuotaListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1NamespacedResourceQuotaListHandlerFunc) Handle(params WatchCoreV1NamespacedResourceQuotaListParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1NamespacedResourceQuotaListHandler interface {
	Handle(WatchCoreV1NamespacedResourceQuotaListParams, interface{}) middleware.Responder
}
