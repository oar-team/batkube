...
type ListCoreV1EventForAllNamespacesHandlerFunc func(ListCoreV1EventForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoreV1EventForAllNamespacesHandlerFunc) Handle(params ListCoreV1EventForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListCoreV1EventForAllNamespacesHandler interface {
	Handle(ListCoreV1EventForAllNamespacesParams, interface{}) middleware.Responder
}
