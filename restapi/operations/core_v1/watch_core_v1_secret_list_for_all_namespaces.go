...
type WatchCoreV1SecretListForAllNamespacesHandlerFunc func(WatchCoreV1SecretListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoreV1SecretListForAllNamespacesHandlerFunc) Handle(params WatchCoreV1SecretListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchCoreV1SecretListForAllNamespacesHandler interface {
	Handle(WatchCoreV1SecretListForAllNamespacesParams, interface{}) middleware.Responder
}
