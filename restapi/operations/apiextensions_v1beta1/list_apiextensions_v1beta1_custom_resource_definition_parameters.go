...
// NewListApiextensionsV1beta1CustomResourceDefinitionParams creates a new ListApiextensionsV1beta1CustomResourceDefinitionParams object
...
func NewListApiextensionsV1beta1CustomResourceDefinitionParams() ListApiextensionsV1beta1CustomResourceDefinitionParams {
	...
	return ListApiextensionsV1beta1CustomResourceDefinitionParams{}
}

// ListApiextensionsV1beta1CustomResourceDefinitionParams contains all the bound params for the list apiextensions v1beta1 custom resource definition operation
// typically these are obtained from a http.Request
//
// swagger:parameters listApiextensionsV1beta1CustomResourceDefinition
...
//
// To ensure default values, the struct must have been initialized with NewListApiextensionsV1beta1CustomResourceDefinitionParams() beforehand.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiextensionsV1beta1CustomResourceDefinitionParams) validateWatch(formats strfmt.Registry) error {
