...
// CreateApiextensionsV1beta1CustomResourceDefinitionParams contains all the bound params for the create apiextensions v1beta1 custom resource definition operation
// typically these are obtained from a http.Request
//
// swagger:parameters createApiextensionsV1beta1CustomResourceDefinition
...
//
// To ensure default values, the struct must have been initialized with NewCreateApiextensionsV1beta1CustomResourceDefinitionParams() beforehand.
func (o *CreateApiextensionsV1beta1CustomResourceDefinitionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateApiextensionsV1beta1CustomResourceDefinitionParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateApiextensionsV1beta1CustomResourceDefinitionParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateApiextensionsV1beta1CustomResourceDefinitionParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateApiextensionsV1beta1CustomResourceDefinitionParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateApiextensionsV1beta1CustomResourceDefinitionParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateApiextensionsV1beta1CustomResourceDefinitionParams) validatePretty(formats strfmt.Registry) error {
