...
type DeleteApiextensionsV1beta1CustomResourceDefinitionHandlerFunc func(DeleteApiextensionsV1beta1CustomResourceDefinitionParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteApiextensionsV1beta1CustomResourceDefinitionHandlerFunc) Handle(params DeleteApiextensionsV1beta1CustomResourceDefinitionParams, principal interface{}) middleware.Responder {
...
type DeleteApiextensionsV1beta1CustomResourceDefinitionHandler interface {
	Handle(DeleteApiextensionsV1beta1CustomResourceDefinitionParams, interface{}) middleware.Responder
}
