...
type GetAuthenticationV1beta1APIResourcesHandlerFunc func(GetAuthenticationV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAuthenticationV1beta1APIResourcesHandlerFunc) Handle(params GetAuthenticationV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetAuthenticationV1beta1APIResourcesHandler interface {
	Handle(GetAuthenticationV1beta1APIResourcesParams, interface{}) middleware.Responder
}
