...
// NewCreateAuthenticationV1beta1TokenReviewParams creates a new CreateAuthenticationV1beta1TokenReviewParams object
// no default values defined in spec.
func NewCreateAuthenticationV1beta1TokenReviewParams() CreateAuthenticationV1beta1TokenReviewParams {

	return CreateAuthenticationV1beta1TokenReviewParams{}
}

// CreateAuthenticationV1beta1TokenReviewParams contains all the bound params for the create authentication v1beta1 token review operation
...
func (o *CreateAuthenticationV1beta1TokenReviewParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPIAuthenticationV1beta1TokenReview
...
func (o *CreateAuthenticationV1beta1TokenReviewParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateAuthenticationV1beta1TokenReviewParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateAuthenticationV1beta1TokenReviewParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAuthenticationV1beta1TokenReviewParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateAuthenticationV1beta1TokenReviewParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAuthenticationV1beta1TokenReviewParams) validatePretty(formats strfmt.Registry) error {
