...
// NewReadStorageV1CSINodeParams creates a new ReadStorageV1CSINodeParams object
// no default values defined in spec.
func NewReadStorageV1CSINodeParams() ReadStorageV1CSINodeParams {

	return ReadStorageV1CSINodeParams{}
}

// ReadStorageV1CSINodeParams contains all the bound params for the read storage v1 c s i node operation
...
func (o *ReadStorageV1CSINodeParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadStorageV1CSINodeParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadStorageV1CSINodeParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1CSINodeParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadStorageV1CSINodeParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1CSINodeParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadStorageV1CSINodeParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadStorageV1CSINodeParams) validatePretty(formats strfmt.Registry) error {
