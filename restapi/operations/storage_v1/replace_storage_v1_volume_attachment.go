...
type ReplaceStorageV1VolumeAttachmentHandlerFunc func(ReplaceStorageV1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceStorageV1VolumeAttachmentHandlerFunc) Handle(params ReplaceStorageV1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type ReplaceStorageV1VolumeAttachmentHandler interface {
	Handle(ReplaceStorageV1VolumeAttachmentParams, interface{}) middleware.Responder
}
