...
// NewReplaceStorageV1VolumeAttachmentParams creates a new ReplaceStorageV1VolumeAttachmentParams object
// no default values defined in spec.
func NewReplaceStorageV1VolumeAttachmentParams() ReplaceStorageV1VolumeAttachmentParams {

	return ReplaceStorageV1VolumeAttachmentParams{}
}

// ReplaceStorageV1VolumeAttachmentParams contains all the bound params for the replace storage v1 volume attachment operation
...
func (o *ReplaceStorageV1VolumeAttachmentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPIStorageV1VolumeAttachment
...
func (o *ReplaceStorageV1VolumeAttachmentParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceStorageV1VolumeAttachmentParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceStorageV1VolumeAttachmentParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceStorageV1VolumeAttachmentParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceStorageV1VolumeAttachmentParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceStorageV1VolumeAttachmentParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceStorageV1VolumeAttachmentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceStorageV1VolumeAttachmentParams) validatePretty(formats strfmt.Registry) error {
