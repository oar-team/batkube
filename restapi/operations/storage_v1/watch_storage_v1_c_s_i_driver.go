...
type WatchStorageV1CSIDriverHandlerFunc func(WatchStorageV1CSIDriverParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1CSIDriverHandlerFunc) Handle(params WatchStorageV1CSIDriverParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1CSIDriverHandler interface {
	Handle(WatchStorageV1CSIDriverParams, interface{}) middleware.Responder
}
