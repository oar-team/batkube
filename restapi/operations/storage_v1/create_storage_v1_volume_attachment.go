...
type CreateStorageV1VolumeAttachmentHandlerFunc func(CreateStorageV1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateStorageV1VolumeAttachmentHandlerFunc) Handle(params CreateStorageV1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type CreateStorageV1VolumeAttachmentHandler interface {
	Handle(CreateStorageV1VolumeAttachmentParams, interface{}) middleware.Responder
}
