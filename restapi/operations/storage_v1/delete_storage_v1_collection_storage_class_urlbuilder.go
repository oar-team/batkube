...
// DeleteStorageV1CollectionStorageClassURL generates an URL for the delete storage v1 collection storage class operation
type DeleteStorageV1CollectionStorageClassURL struct {
...
func (o *DeleteStorageV1CollectionStorageClassURL) WithBasePath(bp string) *DeleteStorageV1CollectionStorageClassURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteStorageV1CollectionStorageClassURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteStorageV1CollectionStorageClassURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *DeleteStorageV1CollectionStorageClassURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteStorageV1CollectionStorageClassURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteStorageV1CollectionStorageClassURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteStorageV1CollectionStorageClassURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteStorageV1CollectionStorageClassURL")
	}
...
func (o *DeleteStorageV1CollectionStorageClassURL) StringFull(scheme, host string) string {
