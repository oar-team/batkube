...
// NewPatchStorageV1VolumeAttachmentParams creates a new PatchStorageV1VolumeAttachmentParams object
// no default values defined in spec.
func NewPatchStorageV1VolumeAttachmentParams() PatchStorageV1VolumeAttachmentParams {

	return PatchStorageV1VolumeAttachmentParams{}
}

// PatchStorageV1VolumeAttachmentParams contains all the bound params for the patch storage v1 volume attachment operation
...
func (o *PatchStorageV1VolumeAttachmentParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchStorageV1VolumeAttachmentParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchStorageV1VolumeAttachmentParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchStorageV1VolumeAttachmentParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchStorageV1VolumeAttachmentParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchStorageV1VolumeAttachmentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentParams) validatePretty(formats strfmt.Registry) error {
