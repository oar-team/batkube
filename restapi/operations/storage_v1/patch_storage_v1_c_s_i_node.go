...
type PatchStorageV1CSINodeHandlerFunc func(PatchStorageV1CSINodeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchStorageV1CSINodeHandlerFunc) Handle(params PatchStorageV1CSINodeParams, principal interface{}) middleware.Responder {
...
type PatchStorageV1CSINodeHandler interface {
	Handle(PatchStorageV1CSINodeParams, interface{}) middleware.Responder
}
...
func NewPatchStorageV1CSINode(ctx *middleware.Context, handler PatchStorageV1CSINodeHandler) *PatchStorageV1CSINode {
	return &PatchStorageV1CSINode{Context: ctx, Handler: handler}
}
...
func (o *PatchStorageV1CSINode) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewPatchStorageV1CSINodeParams()
