...
type DeleteStorageV1CollectionStorageClassHandlerFunc func(DeleteStorageV1CollectionStorageClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteStorageV1CollectionStorageClassHandlerFunc) Handle(params DeleteStorageV1CollectionStorageClassParams, principal interface{}) middleware.Responder {
...
type DeleteStorageV1CollectionStorageClassHandler interface {
	Handle(DeleteStorageV1CollectionStorageClassParams, interface{}) middleware.Responder
}
