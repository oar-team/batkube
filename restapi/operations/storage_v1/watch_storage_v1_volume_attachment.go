...
type WatchStorageV1VolumeAttachmentHandlerFunc func(WatchStorageV1VolumeAttachmentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1VolumeAttachmentHandlerFunc) Handle(params WatchStorageV1VolumeAttachmentParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1VolumeAttachmentHandler interface {
	Handle(WatchStorageV1VolumeAttachmentParams, interface{}) middleware.Responder
}
