...
type ReadStorageV1VolumeAttachmentStatusHandlerFunc func(ReadStorageV1VolumeAttachmentStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadStorageV1VolumeAttachmentStatusHandlerFunc) Handle(params ReadStorageV1VolumeAttachmentStatusParams, principal interface{}) middleware.Responder {
...
type ReadStorageV1VolumeAttachmentStatusHandler interface {
	Handle(ReadStorageV1VolumeAttachmentStatusParams, interface{}) middleware.Responder
}
