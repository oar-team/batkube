...
// DeleteStorageV1CollectionCSINodeURL generates an URL for the delete storage v1 collection c s i node operation
type DeleteStorageV1CollectionCSINodeURL struct {
...
func (o *DeleteStorageV1CollectionCSINodeURL) WithBasePath(bp string) *DeleteStorageV1CollectionCSINodeURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteStorageV1CollectionCSINodeURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteStorageV1CollectionCSINodeURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/storage.k8s.io/v1/csinodes"
...
func (o *DeleteStorageV1CollectionCSINodeURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteStorageV1CollectionCSINodeURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteStorageV1CollectionCSINodeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteStorageV1CollectionCSINodeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteStorageV1CollectionCSINodeURL")
	}
...
func (o *DeleteStorageV1CollectionCSINodeURL) StringFull(scheme, host string) string {
