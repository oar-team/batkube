...
type WatchStorageV1StorageClassHandlerFunc func(WatchStorageV1StorageClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchStorageV1StorageClassHandlerFunc) Handle(params WatchStorageV1StorageClassParams, principal interface{}) middleware.Responder {
...
type WatchStorageV1StorageClassHandler interface {
	Handle(WatchStorageV1StorageClassParams, interface{}) middleware.Responder
}
