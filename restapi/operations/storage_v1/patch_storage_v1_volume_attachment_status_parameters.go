...
// NewPatchStorageV1VolumeAttachmentStatusParams creates a new PatchStorageV1VolumeAttachmentStatusParams object
// no default values defined in spec.
func NewPatchStorageV1VolumeAttachmentStatusParams() PatchStorageV1VolumeAttachmentStatusParams {

	return PatchStorageV1VolumeAttachmentStatusParams{}
}

// PatchStorageV1VolumeAttachmentStatusParams contains all the bound params for the patch storage v1 volume attachment status operation
...
func (o *PatchStorageV1VolumeAttachmentStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchStorageV1VolumeAttachmentStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchStorageV1VolumeAttachmentStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchStorageV1VolumeAttachmentStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchStorageV1VolumeAttachmentStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchStorageV1VolumeAttachmentStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchStorageV1VolumeAttachmentStatusParams) validatePretty(formats strfmt.Registry) error {
