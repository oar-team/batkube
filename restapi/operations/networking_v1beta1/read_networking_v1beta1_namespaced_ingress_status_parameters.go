...
// ReadNetworkingV1beta1NamespacedIngressStatusParams contains all the bound params for the read networking v1beta1 namespaced ingress status operation
...
func (o *ReadNetworkingV1beta1NamespacedIngressStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadNetworkingV1beta1NamespacedIngressStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadNetworkingV1beta1NamespacedIngressStatusParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadNetworkingV1beta1NamespacedIngressStatusParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadNetworkingV1beta1NamespacedIngressStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadNetworkingV1beta1NamespacedIngressStatusParams) validatePretty(formats strfmt.Registry) error {
