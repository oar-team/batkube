...
type WatchNetworkingV1beta1IngressListForAllNamespacesHandlerFunc func(WatchNetworkingV1beta1IngressListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchNetworkingV1beta1IngressListForAllNamespacesHandlerFunc) Handle(params WatchNetworkingV1beta1IngressListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchNetworkingV1beta1IngressListForAllNamespacesHandler interface {
	Handle(WatchNetworkingV1beta1IngressListForAllNamespacesParams, interface{}) middleware.Responder
}
