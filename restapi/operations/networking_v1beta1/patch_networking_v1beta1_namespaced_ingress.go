...
type PatchNetworkingV1beta1NamespacedIngressHandlerFunc func(PatchNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchNetworkingV1beta1NamespacedIngressHandlerFunc) Handle(params PatchNetworkingV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type PatchNetworkingV1beta1NamespacedIngressHandler interface {
	Handle(PatchNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
...
func NewPatchNetworkingV1beta1NamespacedIngress(ctx *middleware.Context, handler PatchNetworkingV1beta1NamespacedIngressHandler) *PatchNetworkingV1beta1NamespacedIngress {
	return &PatchNetworkingV1beta1NamespacedIngress{Context: ctx, Handler: handler}
}
...
func (o *PatchNetworkingV1beta1NamespacedIngress) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewPatchNetworkingV1beta1NamespacedIngressParams()
