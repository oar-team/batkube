...
type ReadNetworkingV1beta1NamespacedIngressStatusHandlerFunc func(ReadNetworkingV1beta1NamespacedIngressStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadNetworkingV1beta1NamespacedIngressStatusHandlerFunc) Handle(params ReadNetworkingV1beta1NamespacedIngressStatusParams, principal interface{}) middleware.Responder {
...
type ReadNetworkingV1beta1NamespacedIngressStatusHandler interface {
	Handle(ReadNetworkingV1beta1NamespacedIngressStatusParams, interface{}) middleware.Responder
}
