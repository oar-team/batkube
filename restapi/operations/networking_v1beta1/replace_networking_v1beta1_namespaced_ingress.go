...
type ReplaceNetworkingV1beta1NamespacedIngressHandlerFunc func(ReplaceNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceNetworkingV1beta1NamespacedIngressHandlerFunc) Handle(params ReplaceNetworkingV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type ReplaceNetworkingV1beta1NamespacedIngressHandler interface {
	Handle(ReplaceNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
