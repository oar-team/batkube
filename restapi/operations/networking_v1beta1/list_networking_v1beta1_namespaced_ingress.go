...
type ListNetworkingV1beta1NamespacedIngressHandlerFunc func(ListNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListNetworkingV1beta1NamespacedIngressHandlerFunc) Handle(params ListNetworkingV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type ListNetworkingV1beta1NamespacedIngressHandler interface {
	Handle(ListNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
