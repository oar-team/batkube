...
type GetNetworkingV1beta1APIResourcesHandlerFunc func(GetNetworkingV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetNetworkingV1beta1APIResourcesHandlerFunc) Handle(params GetNetworkingV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetNetworkingV1beta1APIResourcesHandler interface {
	Handle(GetNetworkingV1beta1APIResourcesParams, interface{}) middleware.Responder
}
