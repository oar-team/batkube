...
// NewDeleteNetworkingV1beta1IngressClassParams creates a new DeleteNetworkingV1beta1IngressClassParams object
// no default values defined in spec.
func NewDeleteNetworkingV1beta1IngressClassParams() DeleteNetworkingV1beta1IngressClassParams {

	return DeleteNetworkingV1beta1IngressClassParams{}
}

// DeleteNetworkingV1beta1IngressClassParams contains all the bound params for the delete networking v1beta1 ingress class operation
...
func (o *DeleteNetworkingV1beta1IngressClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteNetworkingV1beta1IngressClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteNetworkingV1beta1IngressClassParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNetworkingV1beta1IngressClassParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteNetworkingV1beta1IngressClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNetworkingV1beta1IngressClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteNetworkingV1beta1IngressClassParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNetworkingV1beta1IngressClassParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteNetworkingV1beta1IngressClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNetworkingV1beta1IngressClassParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteNetworkingV1beta1IngressClassParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteNetworkingV1beta1IngressClassParams) validatePropagationPolicy(formats strfmt.Registry) error {
