...
type DeleteNetworkingV1beta1IngressClassHandlerFunc func(DeleteNetworkingV1beta1IngressClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteNetworkingV1beta1IngressClassHandlerFunc) Handle(params DeleteNetworkingV1beta1IngressClassParams, principal interface{}) middleware.Responder {
...
type DeleteNetworkingV1beta1IngressClassHandler interface {
	Handle(DeleteNetworkingV1beta1IngressClassParams, interface{}) middleware.Responder
}
