...
type CreateNetworkingV1beta1IngressClassHandlerFunc func(CreateNetworkingV1beta1IngressClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateNetworkingV1beta1IngressClassHandlerFunc) Handle(params CreateNetworkingV1beta1IngressClassParams, principal interface{}) middleware.Responder {
...
type CreateNetworkingV1beta1IngressClassHandler interface {
	Handle(CreateNetworkingV1beta1IngressClassParams, interface{}) middleware.Responder
}
