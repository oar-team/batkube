...
type ReplaceNetworkingV1beta1NamespacedIngressStatusHandlerFunc func(ReplaceNetworkingV1beta1NamespacedIngressStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceNetworkingV1beta1NamespacedIngressStatusHandlerFunc) Handle(params ReplaceNetworkingV1beta1NamespacedIngressStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceNetworkingV1beta1NamespacedIngressStatusHandler interface {
	Handle(ReplaceNetworkingV1beta1NamespacedIngressStatusParams, interface{}) middleware.Responder
}
