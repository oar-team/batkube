...
type ReadNetworkingV1beta1NamespacedIngressHandlerFunc func(ReadNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadNetworkingV1beta1NamespacedIngressHandlerFunc) Handle(params ReadNetworkingV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type ReadNetworkingV1beta1NamespacedIngressHandler interface {
	Handle(ReadNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
