...
type DeleteNetworkingV1beta1CollectionNamespacedIngressHandlerFunc func(DeleteNetworkingV1beta1CollectionNamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteNetworkingV1beta1CollectionNamespacedIngressHandlerFunc) Handle(params DeleteNetworkingV1beta1CollectionNamespacedIngressParams, principal interface{}) middleware.Responder {
...
type DeleteNetworkingV1beta1CollectionNamespacedIngressHandler interface {
	Handle(DeleteNetworkingV1beta1CollectionNamespacedIngressParams, interface{}) middleware.Responder
}
