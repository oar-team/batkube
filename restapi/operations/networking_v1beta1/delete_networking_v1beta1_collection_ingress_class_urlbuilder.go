...
// DeleteNetworkingV1beta1CollectionIngressClassURL generates an URL for the delete networking v1beta1 collection ingress class operation
type DeleteNetworkingV1beta1CollectionIngressClassURL struct {
...
func (o *DeleteNetworkingV1beta1CollectionIngressClassURL) WithBasePath(bp string) *DeleteNetworkingV1beta1CollectionIngressClassURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteNetworkingV1beta1CollectionIngressClassURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteNetworkingV1beta1CollectionIngressClassURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *DeleteNetworkingV1beta1CollectionIngressClassURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteNetworkingV1beta1CollectionIngressClassURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteNetworkingV1beta1CollectionIngressClassURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteNetworkingV1beta1CollectionIngressClassURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteNetworkingV1beta1CollectionIngressClassURL")
	}
...
func (o *DeleteNetworkingV1beta1CollectionIngressClassURL) StringFull(scheme, host string) string {
