...
type CreateNetworkingV1beta1NamespacedIngressHandlerFunc func(CreateNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateNetworkingV1beta1NamespacedIngressHandlerFunc) Handle(params CreateNetworkingV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type CreateNetworkingV1beta1NamespacedIngressHandler interface {
	Handle(CreateNetworkingV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
