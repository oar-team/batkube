...
func (o *DeleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscalerParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscalerParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {
...
func (o *DeleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscalerParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscalerParams) validateWatch(formats strfmt.Registry) error {
