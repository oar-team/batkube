...
type CreateAutoscalingV1NamespacedHorizontalPodAutoscalerHandlerFunc func(CreateAutoscalingV1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateAutoscalingV1NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params CreateAutoscalingV1NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type CreateAutoscalingV1NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(CreateAutoscalingV1NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
