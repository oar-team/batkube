...
func (fn DeleteSchedulingV1beta1CollectionPriorityClassHandlerFunc) Handle(params DeleteSchedulingV1beta1CollectionPriorityClassParams) middleware.Responder {
	return fn(params)
}
