...
// NewCreateSchedulingV1beta1PriorityClassParams creates a new CreateSchedulingV1beta1PriorityClassParams object
// no default values defined in spec.
func NewCreateSchedulingV1beta1PriorityClassParams() CreateSchedulingV1beta1PriorityClassParams {

	return CreateSchedulingV1beta1PriorityClassParams{}
}

// CreateSchedulingV1beta1PriorityClassParams contains all the bound params for the create scheduling v1beta1 priority class operation
...
func (o *CreateSchedulingV1beta1PriorityClassParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateSchedulingV1beta1PriorityClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateSchedulingV1beta1PriorityClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateSchedulingV1beta1PriorityClassParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSchedulingV1beta1PriorityClassParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateSchedulingV1beta1PriorityClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSchedulingV1beta1PriorityClassParams) validatePretty(formats strfmt.Registry) error {
