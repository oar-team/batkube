...
func NewReadSchedulingV1beta1PriorityClassOK() *ReadSchedulingV1beta1PriorityClassOK {
	...
	return &ReadSchedulingV1beta1PriorityClassOK{}
}

// WithPayload adds the payload to the read scheduling v1beta1 priority class o k response
func (o *ReadSchedulingV1beta1PriorityClassOK) WithPayload(payload *models.IoK8sAPISchedulingV1beta1PriorityClass) *ReadSchedulingV1beta1PriorityClassOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the read scheduling v1beta1 priority class o k response
func (o *ReadSchedulingV1beta1PriorityClassOK) SetPayload(payload *models.IoK8sAPISchedulingV1beta1PriorityClass) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ReadSchedulingV1beta1PriorityClassOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
func NewReadSchedulingV1beta1PriorityClassUnauthorized() *ReadSchedulingV1beta1PriorityClassUnauthorized {
	...
	return &ReadSchedulingV1beta1PriorityClassUnauthorized{}
}

// WriteResponse to the client
func (o *ReadSchedulingV1beta1PriorityClassUnauthorized) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
