...
type CreateSchedulingV1beta1PriorityClassHandlerFunc func(CreateSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateSchedulingV1beta1PriorityClassHandlerFunc) Handle(params CreateSchedulingV1beta1PriorityClassParams, principal interface{}) middleware.Responder {
...
type CreateSchedulingV1beta1PriorityClassHandler interface {
	Handle(CreateSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder
}
