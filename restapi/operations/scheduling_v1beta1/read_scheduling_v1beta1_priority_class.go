...
type ReadSchedulingV1beta1PriorityClassHandlerFunc func(ReadSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadSchedulingV1beta1PriorityClassHandlerFunc) Handle(params ReadSchedulingV1beta1PriorityClassParams, principal interface{}) middleware.Responder {
...
type ReadSchedulingV1beta1PriorityClassHandler interface {
	Handle(ReadSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder
}
