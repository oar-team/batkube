...
type WatchSchedulingV1beta1PriorityClassHandlerFunc func(WatchSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchSchedulingV1beta1PriorityClassHandlerFunc) Handle(params WatchSchedulingV1beta1PriorityClassParams, principal interface{}) middleware.Responder {
...
type WatchSchedulingV1beta1PriorityClassHandler interface {
	Handle(WatchSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder
}
