...
// ReadSchedulingV1beta1PriorityClassParams contains all the bound params for the read scheduling v1beta1 priority class operation
...
func (o *ReadSchedulingV1beta1PriorityClassParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReadSchedulingV1beta1PriorityClassParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadSchedulingV1beta1PriorityClassParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadSchedulingV1beta1PriorityClassParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSchedulingV1beta1PriorityClassParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadSchedulingV1beta1PriorityClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSchedulingV1beta1PriorityClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadSchedulingV1beta1PriorityClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSchedulingV1beta1PriorityClassParams) validatePretty(formats strfmt.Registry) error {
