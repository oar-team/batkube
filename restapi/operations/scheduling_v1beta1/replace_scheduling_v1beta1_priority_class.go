...
type ReplaceSchedulingV1beta1PriorityClassHandlerFunc func(ReplaceSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceSchedulingV1beta1PriorityClassHandlerFunc) Handle(params ReplaceSchedulingV1beta1PriorityClassParams, principal interface{}) middleware.Responder {
...
type ReplaceSchedulingV1beta1PriorityClassHandler interface {
	Handle(ReplaceSchedulingV1beta1PriorityClassParams, interface{}) middleware.Responder
}
