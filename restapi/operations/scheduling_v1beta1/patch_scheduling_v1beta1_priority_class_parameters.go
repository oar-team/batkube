...
// NewPatchSchedulingV1beta1PriorityClassParams creates a new PatchSchedulingV1beta1PriorityClassParams object
// no default values defined in spec.
func NewPatchSchedulingV1beta1PriorityClassParams() PatchSchedulingV1beta1PriorityClassParams {

	return PatchSchedulingV1beta1PriorityClassParams{}
}

// PatchSchedulingV1beta1PriorityClassParams contains all the bound params for the patch scheduling v1beta1 priority class operation
...
func (o *PatchSchedulingV1beta1PriorityClassParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PatchSchedulingV1beta1PriorityClassParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchSchedulingV1beta1PriorityClassParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchSchedulingV1beta1PriorityClassParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1beta1PriorityClassParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchSchedulingV1beta1PriorityClassParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1beta1PriorityClassParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchSchedulingV1beta1PriorityClassParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1beta1PriorityClassParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchSchedulingV1beta1PriorityClassParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSchedulingV1beta1PriorityClassParams) validatePretty(formats strfmt.Registry) error {
