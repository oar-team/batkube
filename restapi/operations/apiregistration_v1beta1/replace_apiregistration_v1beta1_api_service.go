...
type ReplaceApiregistrationV1beta1APIServiceHandlerFunc func(ReplaceApiregistrationV1beta1APIServiceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceApiregistrationV1beta1APIServiceHandlerFunc) Handle(params ReplaceApiregistrationV1beta1APIServiceParams, principal interface{}) middleware.Responder {
...
type ReplaceApiregistrationV1beta1APIServiceHandler interface {
	Handle(ReplaceApiregistrationV1beta1APIServiceParams, interface{}) middleware.Responder
}
