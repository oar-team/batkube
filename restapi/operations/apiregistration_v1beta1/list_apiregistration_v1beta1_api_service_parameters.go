...
// NewListApiregistrationV1beta1APIServiceParams creates a new ListApiregistrationV1beta1APIServiceParams object
// no default values defined in spec.
func NewListApiregistrationV1beta1APIServiceParams() ListApiregistrationV1beta1APIServiceParams {

	return ListApiregistrationV1beta1APIServiceParams{}
}

// ListApiregistrationV1beta1APIServiceParams contains all the bound params for the list apiregistration v1beta1 API service operation
// typically these are obtained from a http.Request
//
// swagger:parameters listApiregistrationV1beta1APIService
...
//
// To ensure default values, the struct must have been initialized with NewListApiregistrationV1beta1APIServiceParams() beforehand.
func (o *ListApiregistrationV1beta1APIServiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ListApiregistrationV1beta1APIServiceParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListApiregistrationV1beta1APIServiceParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListApiregistrationV1beta1APIServiceParams) validateWatch(formats strfmt.Registry) error {
