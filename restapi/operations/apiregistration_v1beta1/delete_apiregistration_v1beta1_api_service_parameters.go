...
// NewDeleteApiregistrationV1beta1APIServiceParams creates a new DeleteApiregistrationV1beta1APIServiceParams object
// no default values defined in spec.
func NewDeleteApiregistrationV1beta1APIServiceParams() DeleteApiregistrationV1beta1APIServiceParams {

	return DeleteApiregistrationV1beta1APIServiceParams{}
}

// DeleteApiregistrationV1beta1APIServiceParams contains all the bound params for the delete apiregistration v1beta1 API service operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteApiregistrationV1beta1APIService
...
//
// To ensure default values, the struct must have been initialized with NewDeleteApiregistrationV1beta1APIServiceParams() beforehand.
func (o *DeleteApiregistrationV1beta1APIServiceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteApiregistrationV1beta1APIServiceParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteApiregistrationV1beta1APIServiceParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteApiregistrationV1beta1APIServiceParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1beta1APIServiceParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteApiregistrationV1beta1APIServiceParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1beta1APIServiceParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteApiregistrationV1beta1APIServiceParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1beta1APIServiceParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteApiregistrationV1beta1APIServiceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1beta1APIServiceParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteApiregistrationV1beta1APIServiceParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteApiregistrationV1beta1APIServiceParams) validatePropagationPolicy(formats strfmt.Registry) error {
