...
type ReadApiregistrationV1beta1APIServiceHandlerFunc func(ReadApiregistrationV1beta1APIServiceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadApiregistrationV1beta1APIServiceHandlerFunc) Handle(params ReadApiregistrationV1beta1APIServiceParams, principal interface{}) middleware.Responder {
...
type ReadApiregistrationV1beta1APIServiceHandler interface {
	Handle(ReadApiregistrationV1beta1APIServiceParams, interface{}) middleware.Responder
}
