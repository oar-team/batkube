...
// DeleteApiregistrationV1beta1CollectionAPIServiceURL generates an URL for the delete apiregistration v1beta1 collection API service operation
type DeleteApiregistrationV1beta1CollectionAPIServiceURL struct {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceURL) WithBasePath(bp string) *DeleteApiregistrationV1beta1CollectionAPIServiceURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/apiregistration.k8s.io/v1beta1/apiservices"
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteApiregistrationV1beta1CollectionAPIServiceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteApiregistrationV1beta1CollectionAPIServiceURL")
	}
...
func (o *DeleteApiregistrationV1beta1CollectionAPIServiceURL) StringFull(scheme, host string) string {
