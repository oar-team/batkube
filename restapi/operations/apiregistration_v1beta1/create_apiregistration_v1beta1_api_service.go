...
type CreateApiregistrationV1beta1APIServiceHandlerFunc func(CreateApiregistrationV1beta1APIServiceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateApiregistrationV1beta1APIServiceHandlerFunc) Handle(params CreateApiregistrationV1beta1APIServiceParams, principal interface{}) middleware.Responder {
...
type CreateApiregistrationV1beta1APIServiceHandler interface {
	Handle(CreateApiregistrationV1beta1APIServiceParams, interface{}) middleware.Responder
}
