...
type WatchNetworkingV1NamespacedNetworkPolicyHandlerFunc func(WatchNetworkingV1NamespacedNetworkPolicyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchNetworkingV1NamespacedNetworkPolicyHandlerFunc) Handle(params WatchNetworkingV1NamespacedNetworkPolicyParams, principal interface{}) middleware.Responder {
...
type WatchNetworkingV1NamespacedNetworkPolicyHandler interface {
	Handle(WatchNetworkingV1NamespacedNetworkPolicyParams, interface{}) middleware.Responder
}
