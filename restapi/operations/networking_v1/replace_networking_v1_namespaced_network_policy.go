...
type ReplaceNetworkingV1NamespacedNetworkPolicyHandlerFunc func(ReplaceNetworkingV1NamespacedNetworkPolicyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceNetworkingV1NamespacedNetworkPolicyHandlerFunc) Handle(params ReplaceNetworkingV1NamespacedNetworkPolicyParams, principal interface{}) middleware.Responder {
...
type ReplaceNetworkingV1NamespacedNetworkPolicyHandler interface {
	Handle(ReplaceNetworkingV1NamespacedNetworkPolicyParams, interface{}) middleware.Responder
}
