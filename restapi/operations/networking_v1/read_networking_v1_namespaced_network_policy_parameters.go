...
// ReadNetworkingV1NamespacedNetworkPolicyParams contains all the bound params for the read networking v1 namespaced network policy operation
...
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadNetworkingV1NamespacedNetworkPolicyParams) validatePretty(formats strfmt.Registry) error {
