...
// NewCreateNetworkingV1NamespacedNetworkPolicyParams creates a new CreateNetworkingV1NamespacedNetworkPolicyParams object
// no default values defined in spec.
func NewCreateNetworkingV1NamespacedNetworkPolicyParams() CreateNetworkingV1NamespacedNetworkPolicyParams {

	return CreateNetworkingV1NamespacedNetworkPolicyParams{}
}

// CreateNetworkingV1NamespacedNetworkPolicyParams contains all the bound params for the create networking v1 namespaced network policy operation
...
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateNetworkingV1NamespacedNetworkPolicyParams) validatePretty(formats strfmt.Registry) error {
