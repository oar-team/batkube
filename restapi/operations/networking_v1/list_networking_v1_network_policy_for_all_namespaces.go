...
type ListNetworkingV1NetworkPolicyForAllNamespacesHandlerFunc func(ListNetworkingV1NetworkPolicyForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListNetworkingV1NetworkPolicyForAllNamespacesHandlerFunc) Handle(params ListNetworkingV1NetworkPolicyForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListNetworkingV1NetworkPolicyForAllNamespacesHandler interface {
	Handle(ListNetworkingV1NetworkPolicyForAllNamespacesParams, interface{}) middleware.Responder
}
