...
type GetNetworkingV1APIResourcesHandlerFunc func(GetNetworkingV1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetNetworkingV1APIResourcesHandlerFunc) Handle(params GetNetworkingV1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetNetworkingV1APIResourcesHandler interface {
	Handle(GetNetworkingV1APIResourcesParams, interface{}) middleware.Responder
}
