...
type CreateAuthorizationV1beta1SelfSubjectAccessReviewHandlerFunc func(CreateAuthorizationV1beta1SelfSubjectAccessReviewParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateAuthorizationV1beta1SelfSubjectAccessReviewHandlerFunc) Handle(params CreateAuthorizationV1beta1SelfSubjectAccessReviewParams, principal interface{}) middleware.Responder {
...
type CreateAuthorizationV1beta1SelfSubjectAccessReviewHandler interface {
	Handle(CreateAuthorizationV1beta1SelfSubjectAccessReviewParams, interface{}) middleware.Responder
}
