...
type GetAuthorizationV1beta1APIResourcesHandlerFunc func(GetAuthorizationV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAuthorizationV1beta1APIResourcesHandlerFunc) Handle(params GetAuthorizationV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetAuthorizationV1beta1APIResourcesHandler interface {
	Handle(GetAuthorizationV1beta1APIResourcesParams, interface{}) middleware.Responder
}
