...
// GetAuthorizationV1beta1APIResourcesParams contains all the bound params for the get authorization v1beta1 API resources operation
...
func (o *GetAuthorizationV1beta1APIResourcesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
