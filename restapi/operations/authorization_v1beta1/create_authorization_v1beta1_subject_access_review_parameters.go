...
// CreateAuthorizationV1beta1SubjectAccessReviewParams contains all the bound params for the create authorization v1beta1 subject access review operation
...
func (o *CreateAuthorizationV1beta1SubjectAccessReviewParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPIAuthorizationV1beta1SubjectAccessReview
...
func (o *CreateAuthorizationV1beta1SubjectAccessReviewParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateAuthorizationV1beta1SubjectAccessReviewParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateAuthorizationV1beta1SubjectAccessReviewParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAuthorizationV1beta1SubjectAccessReviewParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateAuthorizationV1beta1SubjectAccessReviewParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAuthorizationV1beta1SubjectAccessReviewParams) validatePretty(formats strfmt.Registry) error {
