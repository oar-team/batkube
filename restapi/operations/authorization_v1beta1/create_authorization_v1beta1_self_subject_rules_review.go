...
type CreateAuthorizationV1beta1SelfSubjectRulesReviewHandlerFunc func(CreateAuthorizationV1beta1SelfSubjectRulesReviewParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateAuthorizationV1beta1SelfSubjectRulesReviewHandlerFunc) Handle(params CreateAuthorizationV1beta1SelfSubjectRulesReviewParams, principal interface{}) middleware.Responder {
...
type CreateAuthorizationV1beta1SelfSubjectRulesReviewHandler interface {
	Handle(CreateAuthorizationV1beta1SelfSubjectRulesReviewParams, interface{}) middleware.Responder
}
