...
type DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceHandlerFunc func(DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceHandlerFunc) Handle(params DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceParams, principal interface{}) middleware.Responder {
...
type DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceHandler interface {
	Handle(DeleteDiscoveryV1beta1CollectionNamespacedEndpointSliceParams, interface{}) middleware.Responder
}
