...
// NewReadDiscoveryV1beta1NamespacedEndpointSliceParams creates a new ReadDiscoveryV1beta1NamespacedEndpointSliceParams object
// no default values defined in spec.
func NewReadDiscoveryV1beta1NamespacedEndpointSliceParams() ReadDiscoveryV1beta1NamespacedEndpointSliceParams {

	return ReadDiscoveryV1beta1NamespacedEndpointSliceParams{}
}

// ReadDiscoveryV1beta1NamespacedEndpointSliceParams contains all the bound params for the read discovery v1beta1 namespaced endpoint slice operation
...
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadDiscoveryV1beta1NamespacedEndpointSliceParams) validatePretty(formats strfmt.Registry) error {
