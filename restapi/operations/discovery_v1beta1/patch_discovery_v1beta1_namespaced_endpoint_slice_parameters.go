...
// PatchDiscoveryV1beta1NamespacedEndpointSliceParams contains all the bound params for the patch discovery v1beta1 namespaced endpoint slice operation
...
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchDiscoveryV1beta1NamespacedEndpointSliceParams) validatePretty(formats strfmt.Registry) error {
