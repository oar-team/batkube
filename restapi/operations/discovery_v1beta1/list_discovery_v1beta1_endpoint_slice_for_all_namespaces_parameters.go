...
// NewListDiscoveryV1beta1EndpointSliceForAllNamespacesParams creates a new ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams object
...
func NewListDiscoveryV1beta1EndpointSliceForAllNamespacesParams() ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams {
	...
	return ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams{}
}

// ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams contains all the bound params for the list discovery v1beta1 endpoint slice for all namespaces operation
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1EndpointSliceForAllNamespacesParams) validateWatch(formats strfmt.Registry) error {
