...
// NewCreateDiscoveryV1beta1NamespacedEndpointSliceParams creates a new CreateDiscoveryV1beta1NamespacedEndpointSliceParams object
// no default values defined in spec.
func NewCreateDiscoveryV1beta1NamespacedEndpointSliceParams() CreateDiscoveryV1beta1NamespacedEndpointSliceParams {

	return CreateDiscoveryV1beta1NamespacedEndpointSliceParams{}
}

// CreateDiscoveryV1beta1NamespacedEndpointSliceParams contains all the bound params for the create discovery v1beta1 namespaced endpoint slice operation
...
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateDiscoveryV1beta1NamespacedEndpointSliceParams) validatePretty(formats strfmt.Registry) error {
