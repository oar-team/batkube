...
type ReadDiscoveryV1beta1NamespacedEndpointSliceHandlerFunc func(ReadDiscoveryV1beta1NamespacedEndpointSliceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadDiscoveryV1beta1NamespacedEndpointSliceHandlerFunc) Handle(params ReadDiscoveryV1beta1NamespacedEndpointSliceParams, principal interface{}) middleware.Responder {
...
type ReadDiscoveryV1beta1NamespacedEndpointSliceHandler interface {
	Handle(ReadDiscoveryV1beta1NamespacedEndpointSliceParams, interface{}) middleware.Responder
}
