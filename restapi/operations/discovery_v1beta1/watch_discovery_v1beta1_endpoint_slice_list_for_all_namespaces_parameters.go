...
// NewWatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams creates a new WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams object
...
func NewWatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams() WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams {
	...
	return WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams{}
}

// WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams contains all the bound params for the watch discovery v1beta1 endpoint slice list for all namespaces operation
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchDiscoveryV1beta1EndpointSliceListForAllNamespacesParams) validateWatch(formats strfmt.Registry) error {
