...
type GetDiscoveryV1beta1APIResourcesHandlerFunc func(GetDiscoveryV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetDiscoveryV1beta1APIResourcesHandlerFunc) Handle(params GetDiscoveryV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetDiscoveryV1beta1APIResourcesHandler interface {
	Handle(GetDiscoveryV1beta1APIResourcesParams, interface{}) middleware.Responder
}
