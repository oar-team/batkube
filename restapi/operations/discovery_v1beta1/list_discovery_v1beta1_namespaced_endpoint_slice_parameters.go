...
// NewListDiscoveryV1beta1NamespacedEndpointSliceParams creates a new ListDiscoveryV1beta1NamespacedEndpointSliceParams object
// no default values defined in spec.
func NewListDiscoveryV1beta1NamespacedEndpointSliceParams() ListDiscoveryV1beta1NamespacedEndpointSliceParams {

	return ListDiscoveryV1beta1NamespacedEndpointSliceParams{}
}

// ListDiscoveryV1beta1NamespacedEndpointSliceParams contains all the bound params for the list discovery v1beta1 namespaced endpoint slice operation
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListDiscoveryV1beta1NamespacedEndpointSliceParams) validateWatch(formats strfmt.Registry) error {
