...
type WatchBatchV1NamespacedJobListHandlerFunc func(WatchBatchV1NamespacedJobListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchBatchV1NamespacedJobListHandlerFunc) Handle(params WatchBatchV1NamespacedJobListParams, principal interface{}) middleware.Responder {
...
type WatchBatchV1NamespacedJobListHandler interface {
	Handle(WatchBatchV1NamespacedJobListParams, interface{}) middleware.Responder
}
