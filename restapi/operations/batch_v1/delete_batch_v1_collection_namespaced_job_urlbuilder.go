...
// DeleteBatchV1CollectionNamespacedJobURL generates an URL for the delete batch v1 collection namespaced job operation
type DeleteBatchV1CollectionNamespacedJobURL struct {
	Namespace string
...
func (o *DeleteBatchV1CollectionNamespacedJobURL) WithBasePath(bp string) *DeleteBatchV1CollectionNamespacedJobURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteBatchV1CollectionNamespacedJobURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteBatchV1CollectionNamespacedJobURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/batch/v1/namespaces/{namespace}/jobs"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteBatchV1CollectionNamespacedJobURL")
	}
...
func (o *DeleteBatchV1CollectionNamespacedJobURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteBatchV1CollectionNamespacedJobURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteBatchV1CollectionNamespacedJobURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteBatchV1CollectionNamespacedJobURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteBatchV1CollectionNamespacedJobURL")
	}
...
func (o *DeleteBatchV1CollectionNamespacedJobURL) StringFull(scheme, host string) string {
