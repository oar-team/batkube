...
type PatchBatchV1NamespacedJobHandlerFunc func(PatchBatchV1NamespacedJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchBatchV1NamespacedJobHandlerFunc) Handle(params PatchBatchV1NamespacedJobParams, principal interface{}) middleware.Responder {
...
type PatchBatchV1NamespacedJobHandler interface {
	Handle(PatchBatchV1NamespacedJobParams, interface{}) middleware.Responder
}
