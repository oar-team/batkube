...
// NewWatchBatchV1JobListForAllNamespacesParams creates a new WatchBatchV1JobListForAllNamespacesParams object
// no default values defined in spec.
func NewWatchBatchV1JobListForAllNamespacesParams() WatchBatchV1JobListForAllNamespacesParams {

	return WatchBatchV1JobListForAllNamespacesParams{}
}

// WatchBatchV1JobListForAllNamespacesParams contains all the bound params for the watch batch v1 job list for all namespaces operation
// typically these are obtained from a http.Request
//
// swagger:parameters watchBatchV1JobListForAllNamespaces
...
//
// To ensure default values, the struct must have been initialized with NewWatchBatchV1JobListForAllNamespacesParams() beforehand.
func (o *WatchBatchV1JobListForAllNamespacesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WatchBatchV1JobListForAllNamespacesParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchBatchV1JobListForAllNamespacesParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchBatchV1JobListForAllNamespacesParams) validateWatch(formats strfmt.Registry) error {
