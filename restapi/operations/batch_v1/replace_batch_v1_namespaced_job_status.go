...
type ReplaceBatchV1NamespacedJobStatusHandlerFunc func(ReplaceBatchV1NamespacedJobStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceBatchV1NamespacedJobStatusHandlerFunc) Handle(params ReplaceBatchV1NamespacedJobStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceBatchV1NamespacedJobStatusHandler interface {
	Handle(ReplaceBatchV1NamespacedJobStatusParams, interface{}) middleware.Responder
}
