...
type WatchBatchV1NamespacedJobHandlerFunc func(WatchBatchV1NamespacedJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchBatchV1NamespacedJobHandlerFunc) Handle(params WatchBatchV1NamespacedJobParams, principal interface{}) middleware.Responder {
...
type WatchBatchV1NamespacedJobHandler interface {
	Handle(WatchBatchV1NamespacedJobParams, interface{}) middleware.Responder
}
