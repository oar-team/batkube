...
// NewDeleteBatchV1NamespacedJobParams creates a new DeleteBatchV1NamespacedJobParams object
// no default values defined in spec.
func NewDeleteBatchV1NamespacedJobParams() DeleteBatchV1NamespacedJobParams {

	return DeleteBatchV1NamespacedJobParams{}
}

// DeleteBatchV1NamespacedJobParams contains all the bound params for the delete batch v1 namespaced job operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteBatchV1NamespacedJob
...
//
// To ensure default values, the struct must have been initialized with NewDeleteBatchV1NamespacedJobParams() beforehand.
func (o *DeleteBatchV1NamespacedJobParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteBatchV1NamespacedJobParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteBatchV1NamespacedJobParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteBatchV1NamespacedJobParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV1NamespacedJobParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteBatchV1NamespacedJobParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV1NamespacedJobParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *DeleteBatchV1NamespacedJobParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV1NamespacedJobParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteBatchV1NamespacedJobParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV1NamespacedJobParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteBatchV1NamespacedJobParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV1NamespacedJobParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteBatchV1NamespacedJobParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBatchV1NamespacedJobParams) validatePropagationPolicy(formats strfmt.Registry) error {
