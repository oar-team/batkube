...
type DeleteBatchV1CollectionNamespacedJobHandlerFunc func(DeleteBatchV1CollectionNamespacedJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteBatchV1CollectionNamespacedJobHandlerFunc) Handle(params DeleteBatchV1CollectionNamespacedJobParams, principal interface{}) middleware.Responder {
...
type DeleteBatchV1CollectionNamespacedJobHandler interface {
	Handle(DeleteBatchV1CollectionNamespacedJobParams, interface{}) middleware.Responder
}
