...
type ListBatchV1JobForAllNamespacesHandlerFunc func(ListBatchV1JobForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListBatchV1JobForAllNamespacesHandlerFunc) Handle(params ListBatchV1JobForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListBatchV1JobForAllNamespacesHandler interface {
	Handle(ListBatchV1JobForAllNamespacesParams, interface{}) middleware.Responder
}
