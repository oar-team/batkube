...
// NewPatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams creates a new PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams object
...
func NewPatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams() PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams {
	...
	return PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams{}
}

// PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams contains all the bound params for the patch flowcontrol apiserver v1alpha1 priority level configuration status operation
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams) validatePretty(formats strfmt.Registry) error {
