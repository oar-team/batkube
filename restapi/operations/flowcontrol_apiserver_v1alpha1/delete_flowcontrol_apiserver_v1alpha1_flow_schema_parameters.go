...
// DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams contains all the bound params for the delete flowcontrol apiserver v1alpha1 flow schema operation
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams) validatePropagationPolicy(formats strfmt.Registry) error {
