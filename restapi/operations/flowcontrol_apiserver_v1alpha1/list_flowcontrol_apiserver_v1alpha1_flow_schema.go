...
type ListFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc func(ListFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc) Handle(params ListFlowcontrolApiserverV1alpha1FlowSchemaParams, principal interface{}) middleware.Responder {
...
type ListFlowcontrolApiserverV1alpha1FlowSchemaHandler interface {
	Handle(ListFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder
}
