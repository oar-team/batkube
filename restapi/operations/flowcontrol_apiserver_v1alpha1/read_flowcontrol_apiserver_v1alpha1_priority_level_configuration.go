...
type ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc func(ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc) Handle(params ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler interface {
	Handle(ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder
}
