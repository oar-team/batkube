...
type PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc func(PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc) Handle(params PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler interface {
	Handle(PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder
}
