...
type ReadFlowcontrolApiserverV1alpha1FlowSchemaStatusHandlerFunc func(ReadFlowcontrolApiserverV1alpha1FlowSchemaStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadFlowcontrolApiserverV1alpha1FlowSchemaStatusHandlerFunc) Handle(params ReadFlowcontrolApiserverV1alpha1FlowSchemaStatusParams, principal interface{}) middleware.Responder {
...
type ReadFlowcontrolApiserverV1alpha1FlowSchemaStatusHandler interface {
	Handle(ReadFlowcontrolApiserverV1alpha1FlowSchemaStatusParams, interface{}) middleware.Responder
}
