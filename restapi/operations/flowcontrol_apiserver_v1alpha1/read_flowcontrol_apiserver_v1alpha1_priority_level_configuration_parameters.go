...
// NewReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams creates a new ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
func NewReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams() ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	...
	return ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams{}
}

// ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams contains all the bound params for the read flowcontrol apiserver v1alpha1 priority level configuration operation
...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validatePretty(formats strfmt.Registry) error {
