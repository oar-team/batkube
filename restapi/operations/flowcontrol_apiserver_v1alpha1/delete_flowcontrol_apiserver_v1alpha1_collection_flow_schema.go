...
type DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaHandlerFunc func(DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaHandlerFunc) Handle(params DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaParams, principal interface{}) middleware.Responder {
...
type DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaHandler interface {
	Handle(DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaParams, interface{}) middleware.Responder
}
