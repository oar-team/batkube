...
// PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams contains all the bound params for the patch flowcontrol apiserver v1alpha1 flow schema status operation
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaStatusParams) validatePretty(formats strfmt.Registry) error {
