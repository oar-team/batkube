...
type ListFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc func(ListFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc) Handle(params ListFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type ListFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler interface {
	Handle(ListFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder
}
