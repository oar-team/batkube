...
// DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL generates an URL for the delete flowcontrol apiserver v1alpha1 collection flow schema operation
type DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL struct {
...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL) WithBasePath(bp string) *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL")
	}
...
func (o *DeleteFlowcontrolApiserverV1alpha1CollectionFlowSchemaURL) StringFull(scheme, host string) string {
