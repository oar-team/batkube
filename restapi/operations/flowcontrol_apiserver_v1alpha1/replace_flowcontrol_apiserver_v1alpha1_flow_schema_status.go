...
type ReplaceFlowcontrolApiserverV1alpha1FlowSchemaStatusHandlerFunc func(ReplaceFlowcontrolApiserverV1alpha1FlowSchemaStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceFlowcontrolApiserverV1alpha1FlowSchemaStatusHandlerFunc) Handle(params ReplaceFlowcontrolApiserverV1alpha1FlowSchemaStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceFlowcontrolApiserverV1alpha1FlowSchemaStatusHandler interface {
	Handle(ReplaceFlowcontrolApiserverV1alpha1FlowSchemaStatusParams, interface{}) middleware.Responder
}
