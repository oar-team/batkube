...
// PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams contains all the bound params for the patch flowcontrol apiserver v1alpha1 priority level configuration operation
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validatePretty(formats strfmt.Registry) error {
