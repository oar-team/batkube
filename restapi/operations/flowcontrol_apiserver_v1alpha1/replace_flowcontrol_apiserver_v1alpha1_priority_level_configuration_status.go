...
type ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusHandlerFunc func(ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusHandlerFunc) Handle(params ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusHandler interface {
	Handle(ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams, interface{}) middleware.Responder
}
