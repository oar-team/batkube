...
// NewWatchFlowcontrolApiserverV1alpha1FlowSchemaListParams creates a new WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams object
...
func NewWatchFlowcontrolApiserverV1alpha1FlowSchemaListParams() WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams {
	...
	return WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams{}
}

// WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams contains all the bound params for the watch flowcontrol apiserver v1alpha1 flow schema list operation
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchFlowcontrolApiserverV1alpha1FlowSchemaListParams) validateWatch(formats strfmt.Registry) error {
