...
type WatchFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc func(WatchFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc) Handle(params WatchFlowcontrolApiserverV1alpha1FlowSchemaParams, principal interface{}) middleware.Responder {
...
type WatchFlowcontrolApiserverV1alpha1FlowSchemaHandler interface {
	Handle(WatchFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder
}
