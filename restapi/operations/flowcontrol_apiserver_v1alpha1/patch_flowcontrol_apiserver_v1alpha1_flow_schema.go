...
type PatchFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc func(PatchFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc) Handle(params PatchFlowcontrolApiserverV1alpha1FlowSchemaParams, principal interface{}) middleware.Responder {
...
type PatchFlowcontrolApiserverV1alpha1FlowSchemaHandler interface {
	Handle(PatchFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder
}
