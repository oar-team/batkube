...
type WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc func(WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc) Handle(params WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler interface {
	Handle(WatchFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder
}
