...
type ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusHandlerFunc func(ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusHandlerFunc) Handle(params ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams, principal interface{}) middleware.Responder {
...
type ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusHandler interface {
	Handle(ReadFlowcontrolApiserverV1alpha1PriorityLevelConfigurationStatusParams, interface{}) middleware.Responder
}
