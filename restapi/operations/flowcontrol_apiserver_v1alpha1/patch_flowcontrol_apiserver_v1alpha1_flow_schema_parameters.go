...
// PatchFlowcontrolApiserverV1alpha1FlowSchemaParams contains all the bound params for the patch flowcontrol apiserver v1alpha1 flow schema operation
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchFlowcontrolApiserverV1alpha1FlowSchemaParams) validatePretty(formats strfmt.Registry) error {
