...
type DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc func(DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc) Handle(params DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler interface {
	Handle(DeleteFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder
}
