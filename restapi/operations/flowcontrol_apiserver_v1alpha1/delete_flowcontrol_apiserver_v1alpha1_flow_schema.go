...
type DeleteFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc func(DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteFlowcontrolApiserverV1alpha1FlowSchemaHandlerFunc) Handle(params DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams, principal interface{}) middleware.Responder {
...
type DeleteFlowcontrolApiserverV1alpha1FlowSchemaHandler interface {
	Handle(DeleteFlowcontrolApiserverV1alpha1FlowSchemaParams, interface{}) middleware.Responder
}
