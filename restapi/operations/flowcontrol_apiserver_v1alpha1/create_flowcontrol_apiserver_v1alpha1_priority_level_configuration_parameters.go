...
// NewCreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams creates a new CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams object
...
func NewCreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams() CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams {
	...
	return CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams{}
}

// CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams contains all the bound params for the create flowcontrol apiserver v1alpha1 priority level configuration operation
...
func (o *CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams) validatePretty(formats strfmt.Registry) error {
