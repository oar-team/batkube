...
type CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc func(CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc) Handle(params CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler interface {
	Handle(CreateFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder
}
