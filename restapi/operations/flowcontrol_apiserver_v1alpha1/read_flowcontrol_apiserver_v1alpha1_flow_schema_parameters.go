...
// ReadFlowcontrolApiserverV1alpha1FlowSchemaParams contains all the bound params for the read flowcontrol apiserver v1alpha1 flow schema operation
...
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadFlowcontrolApiserverV1alpha1FlowSchemaParams) validatePretty(formats strfmt.Registry) error {
