...
type DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationHandlerFunc func(DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationHandlerFunc) Handle(params DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationHandler interface {
	Handle(DeleteFlowcontrolApiserverV1alpha1CollectionPriorityLevelConfigurationParams, interface{}) middleware.Responder
}
