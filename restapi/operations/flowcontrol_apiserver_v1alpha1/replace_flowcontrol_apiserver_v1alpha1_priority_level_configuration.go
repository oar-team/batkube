...
type ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc func(ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandlerFunc) Handle(params ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, principal interface{}) middleware.Responder {
...
type ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler interface {
	Handle(ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams, interface{}) middleware.Responder
}
...
func NewReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfiguration(ctx *middleware.Context, handler ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationHandler) *ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfiguration {
	return &ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfiguration{Context: ctx, Handler: handler}
}
...
func (o *ReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfiguration) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewReplaceFlowcontrolApiserverV1alpha1PriorityLevelConfigurationParams()
