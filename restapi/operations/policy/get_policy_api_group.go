...
type GetPolicyAPIGroupHandlerFunc func(GetPolicyAPIGroupParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetPolicyAPIGroupHandlerFunc) Handle(params GetPolicyAPIGroupParams, principal interface{}) middleware.Responder {
...
type GetPolicyAPIGroupHandler interface {
	Handle(GetPolicyAPIGroupParams, interface{}) middleware.Responder
}
