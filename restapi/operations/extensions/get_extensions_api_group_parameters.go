...
// NewGetExtensionsAPIGroupParams creates a new GetExtensionsAPIGroupParams object
// no default values defined in spec.
func NewGetExtensionsAPIGroupParams() GetExtensionsAPIGroupParams {

	return GetExtensionsAPIGroupParams{}
}

// GetExtensionsAPIGroupParams contains all the bound params for the get extensions API group operation
