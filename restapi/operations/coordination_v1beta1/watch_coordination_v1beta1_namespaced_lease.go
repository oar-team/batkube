...
type WatchCoordinationV1beta1NamespacedLeaseHandlerFunc func(WatchCoordinationV1beta1NamespacedLeaseParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchCoordinationV1beta1NamespacedLeaseHandlerFunc) Handle(params WatchCoordinationV1beta1NamespacedLeaseParams, principal interface{}) middleware.Responder {
...
type WatchCoordinationV1beta1NamespacedLeaseHandler interface {
	Handle(WatchCoordinationV1beta1NamespacedLeaseParams, interface{}) middleware.Responder
}
