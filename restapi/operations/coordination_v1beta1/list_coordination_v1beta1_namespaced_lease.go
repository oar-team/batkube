...
type ListCoordinationV1beta1NamespacedLeaseHandlerFunc func(ListCoordinationV1beta1NamespacedLeaseParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCoordinationV1beta1NamespacedLeaseHandlerFunc) Handle(params ListCoordinationV1beta1NamespacedLeaseParams, principal interface{}) middleware.Responder {
...
type ListCoordinationV1beta1NamespacedLeaseHandler interface {
	Handle(ListCoordinationV1beta1NamespacedLeaseParams, interface{}) middleware.Responder
}
