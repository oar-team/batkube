...
func (o *DeleteCoordinationV1beta1CollectionNamespacedLeaseParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteCoordinationV1beta1CollectionNamespacedLeaseParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {
...
func (o *DeleteCoordinationV1beta1CollectionNamespacedLeaseParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteCoordinationV1beta1CollectionNamespacedLeaseParams) validateWatch(formats strfmt.Registry) error {
