...
type ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusHandlerFunc func(ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusHandlerFunc) Handle(params ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusHandler interface {
	Handle(ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusParams, interface{}) middleware.Responder
}
