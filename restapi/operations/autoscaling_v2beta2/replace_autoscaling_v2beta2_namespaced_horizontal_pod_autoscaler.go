...
type ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerHandlerFunc func(ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(ReplaceAutoscalingV2beta2NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
