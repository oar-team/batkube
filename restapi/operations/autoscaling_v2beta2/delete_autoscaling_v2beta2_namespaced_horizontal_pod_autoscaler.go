...
type DeleteAutoscalingV2beta2NamespacedHorizontalPodAutoscalerHandlerFunc func(DeleteAutoscalingV2beta2NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAutoscalingV2beta2NamespacedHorizontalPodAutoscalerHandlerFunc) Handle(params DeleteAutoscalingV2beta2NamespacedHorizontalPodAutoscalerParams, principal interface{}) middleware.Responder {
...
type DeleteAutoscalingV2beta2NamespacedHorizontalPodAutoscalerHandler interface {
	Handle(DeleteAutoscalingV2beta2NamespacedHorizontalPodAutoscalerParams, interface{}) middleware.Responder
}
