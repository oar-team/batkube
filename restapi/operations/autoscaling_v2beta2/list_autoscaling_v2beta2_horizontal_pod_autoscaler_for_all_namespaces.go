...
type ListAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespacesHandlerFunc func(ListAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespacesHandlerFunc) Handle(params ListAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespacesHandler interface {
	Handle(ListAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespacesParams, interface{}) middleware.Responder
}
