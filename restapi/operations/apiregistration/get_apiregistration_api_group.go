...
type GetApiregistrationAPIGroupHandlerFunc func(GetApiregistrationAPIGroupParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetApiregistrationAPIGroupHandlerFunc) Handle(params GetApiregistrationAPIGroupParams, principal interface{}) middleware.Responder {
...
type GetApiregistrationAPIGroupHandler interface {
	Handle(GetApiregistrationAPIGroupParams, interface{}) middleware.Responder
}
