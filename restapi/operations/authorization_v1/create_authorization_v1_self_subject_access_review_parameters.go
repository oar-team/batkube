...
// NewCreateAuthorizationV1SelfSubjectAccessReviewParams creates a new CreateAuthorizationV1SelfSubjectAccessReviewParams object
// no default values defined in spec.
func NewCreateAuthorizationV1SelfSubjectAccessReviewParams() CreateAuthorizationV1SelfSubjectAccessReviewParams {

	return CreateAuthorizationV1SelfSubjectAccessReviewParams{}
}

// CreateAuthorizationV1SelfSubjectAccessReviewParams contains all the bound params for the create authorization v1 self subject access review operation
...
func (o *CreateAuthorizationV1SelfSubjectAccessReviewParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPIAuthorizationV1SelfSubjectAccessReview
...
func (o *CreateAuthorizationV1SelfSubjectAccessReviewParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateAuthorizationV1SelfSubjectAccessReviewParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateAuthorizationV1SelfSubjectAccessReviewParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAuthorizationV1SelfSubjectAccessReviewParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateAuthorizationV1SelfSubjectAccessReviewParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAuthorizationV1SelfSubjectAccessReviewParams) validatePretty(formats strfmt.Registry) error {
