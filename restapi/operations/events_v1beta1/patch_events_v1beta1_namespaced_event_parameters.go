...
// NewPatchEventsV1beta1NamespacedEventParams creates a new PatchEventsV1beta1NamespacedEventParams object
// no default values defined in spec.
func NewPatchEventsV1beta1NamespacedEventParams() PatchEventsV1beta1NamespacedEventParams {

	return PatchEventsV1beta1NamespacedEventParams{}
}

// PatchEventsV1beta1NamespacedEventParams contains all the bound params for the patch events v1beta1 namespaced event operation
...
func (o *PatchEventsV1beta1NamespacedEventParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchEventsV1beta1NamespacedEventParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchEventsV1beta1NamespacedEventParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchEventsV1beta1NamespacedEventParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchEventsV1beta1NamespacedEventParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchEventsV1beta1NamespacedEventParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchEventsV1beta1NamespacedEventParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchEventsV1beta1NamespacedEventParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchEventsV1beta1NamespacedEventParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchEventsV1beta1NamespacedEventParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchEventsV1beta1NamespacedEventParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchEventsV1beta1NamespacedEventParams) validatePretty(formats strfmt.Registry) error {
