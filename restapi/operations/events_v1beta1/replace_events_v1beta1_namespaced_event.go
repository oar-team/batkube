...
type ReplaceEventsV1beta1NamespacedEventHandlerFunc func(ReplaceEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceEventsV1beta1NamespacedEventHandlerFunc) Handle(params ReplaceEventsV1beta1NamespacedEventParams, principal interface{}) middleware.Responder {
...
type ReplaceEventsV1beta1NamespacedEventHandler interface {
	Handle(ReplaceEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder
}
