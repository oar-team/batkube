...
type DeleteEventsV1beta1NamespacedEventHandlerFunc func(DeleteEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteEventsV1beta1NamespacedEventHandlerFunc) Handle(params DeleteEventsV1beta1NamespacedEventParams, principal interface{}) middleware.Responder {
...
type DeleteEventsV1beta1NamespacedEventHandler interface {
	Handle(DeleteEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder
}
