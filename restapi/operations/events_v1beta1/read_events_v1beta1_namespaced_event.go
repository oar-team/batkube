...
type ReadEventsV1beta1NamespacedEventHandlerFunc func(ReadEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadEventsV1beta1NamespacedEventHandlerFunc) Handle(params ReadEventsV1beta1NamespacedEventParams, principal interface{}) middleware.Responder {
...
type ReadEventsV1beta1NamespacedEventHandler interface {
	Handle(ReadEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder
}
