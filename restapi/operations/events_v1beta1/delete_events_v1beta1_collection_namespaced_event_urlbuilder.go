...
// DeleteEventsV1beta1CollectionNamespacedEventURL generates an URL for the delete events v1beta1 collection namespaced event operation
type DeleteEventsV1beta1CollectionNamespacedEventURL struct {
	Namespace string
...
func (o *DeleteEventsV1beta1CollectionNamespacedEventURL) WithBasePath(bp string) *DeleteEventsV1beta1CollectionNamespacedEventURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteEventsV1beta1CollectionNamespacedEventURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteEventsV1beta1CollectionNamespacedEventURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteEventsV1beta1CollectionNamespacedEventURL")
	}
...
func (o *DeleteEventsV1beta1CollectionNamespacedEventURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteEventsV1beta1CollectionNamespacedEventURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteEventsV1beta1CollectionNamespacedEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteEventsV1beta1CollectionNamespacedEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteEventsV1beta1CollectionNamespacedEventURL")
	}
...
func (o *DeleteEventsV1beta1CollectionNamespacedEventURL) StringFull(scheme, host string) string {
