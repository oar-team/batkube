...
// NewReadEventsV1beta1NamespacedEventParams creates a new ReadEventsV1beta1NamespacedEventParams object
// no default values defined in spec.
func NewReadEventsV1beta1NamespacedEventParams() ReadEventsV1beta1NamespacedEventParams {

	return ReadEventsV1beta1NamespacedEventParams{}
}

// ReadEventsV1beta1NamespacedEventParams contains all the bound params for the read events v1beta1 namespaced event operation
...
func (o *ReadEventsV1beta1NamespacedEventParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadEventsV1beta1NamespacedEventParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadEventsV1beta1NamespacedEventParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadEventsV1beta1NamespacedEventParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadEventsV1beta1NamespacedEventParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadEventsV1beta1NamespacedEventParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadEventsV1beta1NamespacedEventParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadEventsV1beta1NamespacedEventParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadEventsV1beta1NamespacedEventParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadEventsV1beta1NamespacedEventParams) validatePretty(formats strfmt.Registry) error {
