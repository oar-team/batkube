...
type WatchEventsV1beta1NamespacedEventListHandlerFunc func(WatchEventsV1beta1NamespacedEventListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchEventsV1beta1NamespacedEventListHandlerFunc) Handle(params WatchEventsV1beta1NamespacedEventListParams, principal interface{}) middleware.Responder {
...
type WatchEventsV1beta1NamespacedEventListHandler interface {
	Handle(WatchEventsV1beta1NamespacedEventListParams, interface{}) middleware.Responder
}
