...
type GetEventsV1beta1APIResourcesHandlerFunc func(GetEventsV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetEventsV1beta1APIResourcesHandlerFunc) Handle(params GetEventsV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetEventsV1beta1APIResourcesHandler interface {
	Handle(GetEventsV1beta1APIResourcesParams, interface{}) middleware.Responder
}
