...
type ListEventsV1beta1NamespacedEventHandlerFunc func(ListEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListEventsV1beta1NamespacedEventHandlerFunc) Handle(params ListEventsV1beta1NamespacedEventParams, principal interface{}) middleware.Responder {
...
type ListEventsV1beta1NamespacedEventHandler interface {
	Handle(ListEventsV1beta1NamespacedEventParams, interface{}) middleware.Responder
}
