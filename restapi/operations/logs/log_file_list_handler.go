...
type LogFileListHandlerHandlerFunc func(LogFileListHandlerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn LogFileListHandlerHandlerFunc) Handle(params LogFileListHandlerParams, principal interface{}) middleware.Responder {
...
type LogFileListHandlerHandler interface {
	Handle(LogFileListHandlerParams, interface{}) middleware.Responder
}
