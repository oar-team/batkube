...
type DeleteAdmissionregistrationV1CollectionMutatingWebhookConfigurationHandlerFunc func(DeleteAdmissionregistrationV1CollectionMutatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAdmissionregistrationV1CollectionMutatingWebhookConfigurationHandlerFunc) Handle(params DeleteAdmissionregistrationV1CollectionMutatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type DeleteAdmissionregistrationV1CollectionMutatingWebhookConfigurationHandler interface {
	Handle(DeleteAdmissionregistrationV1CollectionMutatingWebhookConfigurationParams, interface{}) middleware.Responder
}
