...
type ListAdmissionregistrationV1ValidatingWebhookConfigurationHandlerFunc func(ListAdmissionregistrationV1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListAdmissionregistrationV1ValidatingWebhookConfigurationHandlerFunc) Handle(params ListAdmissionregistrationV1ValidatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type ListAdmissionregistrationV1ValidatingWebhookConfigurationHandler interface {
	Handle(ListAdmissionregistrationV1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder
}
