...
type WatchAdmissionregistrationV1ValidatingWebhookConfigurationListHandlerFunc func(WatchAdmissionregistrationV1ValidatingWebhookConfigurationListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAdmissionregistrationV1ValidatingWebhookConfigurationListHandlerFunc) Handle(params WatchAdmissionregistrationV1ValidatingWebhookConfigurationListParams, principal interface{}) middleware.Responder {
...
type WatchAdmissionregistrationV1ValidatingWebhookConfigurationListHandler interface {
	Handle(WatchAdmissionregistrationV1ValidatingWebhookConfigurationListParams, interface{}) middleware.Responder
}
