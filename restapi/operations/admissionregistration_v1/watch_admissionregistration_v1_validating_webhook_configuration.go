...
type WatchAdmissionregistrationV1ValidatingWebhookConfigurationHandlerFunc func(WatchAdmissionregistrationV1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAdmissionregistrationV1ValidatingWebhookConfigurationHandlerFunc) Handle(params WatchAdmissionregistrationV1ValidatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type WatchAdmissionregistrationV1ValidatingWebhookConfigurationHandler interface {
	Handle(WatchAdmissionregistrationV1ValidatingWebhookConfigurationParams, interface{}) middleware.Responder
}
