...
// NewPatchAdmissionregistrationV1MutatingWebhookConfigurationParams creates a new PatchAdmissionregistrationV1MutatingWebhookConfigurationParams object
...
func NewPatchAdmissionregistrationV1MutatingWebhookConfigurationParams() PatchAdmissionregistrationV1MutatingWebhookConfigurationParams {
	...
	return PatchAdmissionregistrationV1MutatingWebhookConfigurationParams{}
}

// PatchAdmissionregistrationV1MutatingWebhookConfigurationParams contains all the bound params for the patch admissionregistration v1 mutating webhook configuration operation
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAdmissionregistrationV1MutatingWebhookConfigurationParams) validatePretty(formats strfmt.Registry) error {
