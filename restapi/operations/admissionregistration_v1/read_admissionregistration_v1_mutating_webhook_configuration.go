...
type ReadAdmissionregistrationV1MutatingWebhookConfigurationHandlerFunc func(ReadAdmissionregistrationV1MutatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadAdmissionregistrationV1MutatingWebhookConfigurationHandlerFunc) Handle(params ReadAdmissionregistrationV1MutatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type ReadAdmissionregistrationV1MutatingWebhookConfigurationHandler interface {
	Handle(ReadAdmissionregistrationV1MutatingWebhookConfigurationParams, interface{}) middleware.Responder
}
