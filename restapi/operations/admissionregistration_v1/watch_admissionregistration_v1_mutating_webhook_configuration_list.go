...
type WatchAdmissionregistrationV1MutatingWebhookConfigurationListHandlerFunc func(WatchAdmissionregistrationV1MutatingWebhookConfigurationListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAdmissionregistrationV1MutatingWebhookConfigurationListHandlerFunc) Handle(params WatchAdmissionregistrationV1MutatingWebhookConfigurationListParams, principal interface{}) middleware.Responder {
...
type WatchAdmissionregistrationV1MutatingWebhookConfigurationListHandler interface {
	Handle(WatchAdmissionregistrationV1MutatingWebhookConfigurationListParams, interface{}) middleware.Responder
}
