...
type CreateAdmissionregistrationV1MutatingWebhookConfigurationHandlerFunc func(CreateAdmissionregistrationV1MutatingWebhookConfigurationParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateAdmissionregistrationV1MutatingWebhookConfigurationHandlerFunc) Handle(params CreateAdmissionregistrationV1MutatingWebhookConfigurationParams, principal interface{}) middleware.Responder {
...
type CreateAdmissionregistrationV1MutatingWebhookConfigurationHandler interface {
	Handle(CreateAdmissionregistrationV1MutatingWebhookConfigurationParams, interface{}) middleware.Responder
}
