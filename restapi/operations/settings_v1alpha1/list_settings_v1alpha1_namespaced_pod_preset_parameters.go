...
// NewListSettingsV1alpha1NamespacedPodPresetParams creates a new ListSettingsV1alpha1NamespacedPodPresetParams object
// no default values defined in spec.
func NewListSettingsV1alpha1NamespacedPodPresetParams() ListSettingsV1alpha1NamespacedPodPresetParams {

	return ListSettingsV1alpha1NamespacedPodPresetParams{}
}

// ListSettingsV1alpha1NamespacedPodPresetParams contains all the bound params for the list settings v1alpha1 namespaced pod preset operation
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListSettingsV1alpha1NamespacedPodPresetParams) validateWatch(formats strfmt.Registry) error {
