...
type ListSettingsV1alpha1PodPresetForAllNamespacesHandlerFunc func(ListSettingsV1alpha1PodPresetForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListSettingsV1alpha1PodPresetForAllNamespacesHandlerFunc) Handle(params ListSettingsV1alpha1PodPresetForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListSettingsV1alpha1PodPresetForAllNamespacesHandler interface {
	Handle(ListSettingsV1alpha1PodPresetForAllNamespacesParams, interface{}) middleware.Responder
}
