...
type WatchSettingsV1alpha1NamespacedPodPresetListHandlerFunc func(WatchSettingsV1alpha1NamespacedPodPresetListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchSettingsV1alpha1NamespacedPodPresetListHandlerFunc) Handle(params WatchSettingsV1alpha1NamespacedPodPresetListParams, principal interface{}) middleware.Responder {
...
type WatchSettingsV1alpha1NamespacedPodPresetListHandler interface {
	Handle(WatchSettingsV1alpha1NamespacedPodPresetListParams, interface{}) middleware.Responder
}
