...
type GetSettingsV1alpha1APIResourcesHandlerFunc func(GetSettingsV1alpha1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetSettingsV1alpha1APIResourcesHandlerFunc) Handle(params GetSettingsV1alpha1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetSettingsV1alpha1APIResourcesHandler interface {
	Handle(GetSettingsV1alpha1APIResourcesParams, interface{}) middleware.Responder
}
