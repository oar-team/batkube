...
type ReplaceSettingsV1alpha1NamespacedPodPresetHandlerFunc func(ReplaceSettingsV1alpha1NamespacedPodPresetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceSettingsV1alpha1NamespacedPodPresetHandlerFunc) Handle(params ReplaceSettingsV1alpha1NamespacedPodPresetParams, principal interface{}) middleware.Responder {
...
type ReplaceSettingsV1alpha1NamespacedPodPresetHandler interface {
	Handle(ReplaceSettingsV1alpha1NamespacedPodPresetParams, interface{}) middleware.Responder
}
