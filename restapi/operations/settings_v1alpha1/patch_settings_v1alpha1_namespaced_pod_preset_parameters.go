...
// NewPatchSettingsV1alpha1NamespacedPodPresetParams creates a new PatchSettingsV1alpha1NamespacedPodPresetParams object
// no default values defined in spec.
func NewPatchSettingsV1alpha1NamespacedPodPresetParams() PatchSettingsV1alpha1NamespacedPodPresetParams {

	return PatchSettingsV1alpha1NamespacedPodPresetParams{}
}

// PatchSettingsV1alpha1NamespacedPodPresetParams contains all the bound params for the patch settings v1alpha1 namespaced pod preset operation
...
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchSettingsV1alpha1NamespacedPodPresetParams) validatePretty(formats strfmt.Registry) error {
