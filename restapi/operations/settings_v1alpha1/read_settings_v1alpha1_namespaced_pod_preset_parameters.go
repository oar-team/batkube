...
// ReadSettingsV1alpha1NamespacedPodPresetParams contains all the bound params for the read settings v1alpha1 namespaced pod preset operation
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadSettingsV1alpha1NamespacedPodPresetParams) validatePretty(formats strfmt.Registry) error {
