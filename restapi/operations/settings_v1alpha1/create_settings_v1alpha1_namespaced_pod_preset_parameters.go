...
// NewCreateSettingsV1alpha1NamespacedPodPresetParams creates a new CreateSettingsV1alpha1NamespacedPodPresetParams object
// no default values defined in spec.
func NewCreateSettingsV1alpha1NamespacedPodPresetParams() CreateSettingsV1alpha1NamespacedPodPresetParams {

	return CreateSettingsV1alpha1NamespacedPodPresetParams{}
}

// CreateSettingsV1alpha1NamespacedPodPresetParams contains all the bound params for the create settings v1alpha1 namespaced pod preset operation
...
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSettingsV1alpha1NamespacedPodPresetParams) validatePretty(formats strfmt.Registry) error {
