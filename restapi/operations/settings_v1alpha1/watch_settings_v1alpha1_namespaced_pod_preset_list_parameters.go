...
// NewWatchSettingsV1alpha1NamespacedPodPresetListParams creates a new WatchSettingsV1alpha1NamespacedPodPresetListParams object
// no default values defined in spec.
func NewWatchSettingsV1alpha1NamespacedPodPresetListParams() WatchSettingsV1alpha1NamespacedPodPresetListParams {

	return WatchSettingsV1alpha1NamespacedPodPresetListParams{}
}

// WatchSettingsV1alpha1NamespacedPodPresetListParams contains all the bound params for the watch settings v1alpha1 namespaced pod preset list operation
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindAllowWatchBookmarks(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateAllowWatchBookmarks(formats strfmt.Registry) error {

	return nil
}

// bindContinue binds and validates parameter Continue from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindContinue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateContinue(formats strfmt.Registry) error {

	return nil
}

// bindFieldSelector binds and validates parameter FieldSelector from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindFieldSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateFieldSelector(formats strfmt.Registry) error {

	return nil
}

// bindLabelSelector binds and validates parameter LabelSelector from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindLabelSelector(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateLabelSelector(formats strfmt.Registry) error {

	return nil
}

// bindLimit binds and validates parameter Limit from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateLimit(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindResourceVersion binds and validates parameter ResourceVersion from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindResourceVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateResourceVersion(formats strfmt.Registry) error {

	return nil
}

// bindTimeoutSeconds binds and validates parameter TimeoutSeconds from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindTimeoutSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateTimeoutSeconds(formats strfmt.Registry) error {

	return nil
}

// bindWatch binds and validates parameter Watch from query.
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) bindWatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WatchSettingsV1alpha1NamespacedPodPresetListParams) validateWatch(formats strfmt.Registry) error {
