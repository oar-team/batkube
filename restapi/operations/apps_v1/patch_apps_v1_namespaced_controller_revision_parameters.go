...
// NewPatchAppsV1NamespacedControllerRevisionParams creates a new PatchAppsV1NamespacedControllerRevisionParams object
// no default values defined in spec.
func NewPatchAppsV1NamespacedControllerRevisionParams() PatchAppsV1NamespacedControllerRevisionParams {

	return PatchAppsV1NamespacedControllerRevisionParams{}
}

// PatchAppsV1NamespacedControllerRevisionParams contains all the bound params for the patch apps v1 namespaced controller revision operation
...
func (o *PatchAppsV1NamespacedControllerRevisionParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchAppsV1NamespacedControllerRevisionParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchAppsV1NamespacedControllerRevisionParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedControllerRevisionParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchAppsV1NamespacedControllerRevisionParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedControllerRevisionParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchAppsV1NamespacedControllerRevisionParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedControllerRevisionParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchAppsV1NamespacedControllerRevisionParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedControllerRevisionParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchAppsV1NamespacedControllerRevisionParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedControllerRevisionParams) validatePretty(formats strfmt.Registry) error {
