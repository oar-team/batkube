...
type PatchAppsV1NamespacedDeploymentScaleHandlerFunc func(PatchAppsV1NamespacedDeploymentScaleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchAppsV1NamespacedDeploymentScaleHandlerFunc) Handle(params PatchAppsV1NamespacedDeploymentScaleParams, principal interface{}) middleware.Responder {
...
type PatchAppsV1NamespacedDeploymentScaleHandler interface {
	Handle(PatchAppsV1NamespacedDeploymentScaleParams, interface{}) middleware.Responder
}
