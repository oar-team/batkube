...
type WatchAppsV1DaemonSetListForAllNamespacesHandlerFunc func(WatchAppsV1DaemonSetListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAppsV1DaemonSetListForAllNamespacesHandlerFunc) Handle(params WatchAppsV1DaemonSetListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchAppsV1DaemonSetListForAllNamespacesHandler interface {
	Handle(WatchAppsV1DaemonSetListForAllNamespacesParams, interface{}) middleware.Responder
}
