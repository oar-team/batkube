...
// NewReadAppsV1NamespacedReplicaSetParams creates a new ReadAppsV1NamespacedReplicaSetParams object
// no default values defined in spec.
func NewReadAppsV1NamespacedReplicaSetParams() ReadAppsV1NamespacedReplicaSetParams {

	return ReadAppsV1NamespacedReplicaSetParams{}
}

// ReadAppsV1NamespacedReplicaSetParams contains all the bound params for the read apps v1 namespaced replica set operation
...
func (o *ReadAppsV1NamespacedReplicaSetParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadAppsV1NamespacedReplicaSetParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadAppsV1NamespacedReplicaSetParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadAppsV1NamespacedReplicaSetParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadAppsV1NamespacedReplicaSetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadAppsV1NamespacedReplicaSetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadAppsV1NamespacedReplicaSetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadAppsV1NamespacedReplicaSetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadAppsV1NamespacedReplicaSetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadAppsV1NamespacedReplicaSetParams) validatePretty(formats strfmt.Registry) error {
