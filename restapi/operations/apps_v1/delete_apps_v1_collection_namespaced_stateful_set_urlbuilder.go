...
// DeleteAppsV1CollectionNamespacedStatefulSetURL generates an URL for the delete apps v1 collection namespaced stateful set operation
type DeleteAppsV1CollectionNamespacedStatefulSetURL struct {
	Namespace string
...
func (o *DeleteAppsV1CollectionNamespacedStatefulSetURL) WithBasePath(bp string) *DeleteAppsV1CollectionNamespacedStatefulSetURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteAppsV1CollectionNamespacedStatefulSetURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteAppsV1CollectionNamespacedStatefulSetURL) Build() (*url.URL, error) {
	var _result url.URL
	...
	if namespace != "" {
		...
		return nil, errors.New("namespace is required on DeleteAppsV1CollectionNamespacedStatefulSetURL")
	}
...
func (o *DeleteAppsV1CollectionNamespacedStatefulSetURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteAppsV1CollectionNamespacedStatefulSetURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteAppsV1CollectionNamespacedStatefulSetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteAppsV1CollectionNamespacedStatefulSetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteAppsV1CollectionNamespacedStatefulSetURL")
	}
...
func (o *DeleteAppsV1CollectionNamespacedStatefulSetURL) StringFull(scheme, host string) string {
