...
type PatchAppsV1NamespacedStatefulSetStatusHandlerFunc func(PatchAppsV1NamespacedStatefulSetStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchAppsV1NamespacedStatefulSetStatusHandlerFunc) Handle(params PatchAppsV1NamespacedStatefulSetStatusParams, principal interface{}) middleware.Responder {
...
type PatchAppsV1NamespacedStatefulSetStatusHandler interface {
	Handle(PatchAppsV1NamespacedStatefulSetStatusParams, interface{}) middleware.Responder
}
