...
type ReplaceAppsV1NamespacedDaemonSetStatusHandlerFunc func(ReplaceAppsV1NamespacedDaemonSetStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceAppsV1NamespacedDaemonSetStatusHandlerFunc) Handle(params ReplaceAppsV1NamespacedDaemonSetStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceAppsV1NamespacedDaemonSetStatusHandler interface {
	Handle(ReplaceAppsV1NamespacedDaemonSetStatusParams, interface{}) middleware.Responder
}
