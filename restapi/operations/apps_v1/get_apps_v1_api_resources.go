...
type GetAppsV1APIResourcesHandlerFunc func(GetAppsV1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAppsV1APIResourcesHandlerFunc) Handle(params GetAppsV1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetAppsV1APIResourcesHandler interface {
	Handle(GetAppsV1APIResourcesParams, interface{}) middleware.Responder
}
