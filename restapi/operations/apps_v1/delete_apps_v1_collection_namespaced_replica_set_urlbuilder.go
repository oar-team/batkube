...
// DeleteAppsV1CollectionNamespacedReplicaSetURL generates an URL for the delete apps v1 collection namespaced replica set operation
type DeleteAppsV1CollectionNamespacedReplicaSetURL struct {
	Namespace string
...
func (o *DeleteAppsV1CollectionNamespacedReplicaSetURL) WithBasePath(bp string) *DeleteAppsV1CollectionNamespacedReplicaSetURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteAppsV1CollectionNamespacedReplicaSetURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteAppsV1CollectionNamespacedReplicaSetURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/apps/v1/namespaces/{namespace}/replicasets"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteAppsV1CollectionNamespacedReplicaSetURL")
	}
...
func (o *DeleteAppsV1CollectionNamespacedReplicaSetURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteAppsV1CollectionNamespacedReplicaSetURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteAppsV1CollectionNamespacedReplicaSetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteAppsV1CollectionNamespacedReplicaSetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteAppsV1CollectionNamespacedReplicaSetURL")
	}
...
func (o *DeleteAppsV1CollectionNamespacedReplicaSetURL) StringFull(scheme, host string) string {
