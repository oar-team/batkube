...
type WatchAppsV1StatefulSetListForAllNamespacesHandlerFunc func(WatchAppsV1StatefulSetListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAppsV1StatefulSetListForAllNamespacesHandlerFunc) Handle(params WatchAppsV1StatefulSetListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchAppsV1StatefulSetListForAllNamespacesHandler interface {
	Handle(WatchAppsV1StatefulSetListForAllNamespacesParams, interface{}) middleware.Responder
}
