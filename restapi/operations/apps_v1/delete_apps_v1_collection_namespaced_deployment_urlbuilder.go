...
// DeleteAppsV1CollectionNamespacedDeploymentURL generates an URL for the delete apps v1 collection namespaced deployment operation
type DeleteAppsV1CollectionNamespacedDeploymentURL struct {
	Namespace string
...
func (o *DeleteAppsV1CollectionNamespacedDeploymentURL) WithBasePath(bp string) *DeleteAppsV1CollectionNamespacedDeploymentURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteAppsV1CollectionNamespacedDeploymentURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteAppsV1CollectionNamespacedDeploymentURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/apps/v1/namespaces/{namespace}/deployments"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteAppsV1CollectionNamespacedDeploymentURL")
	}
...
func (o *DeleteAppsV1CollectionNamespacedDeploymentURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteAppsV1CollectionNamespacedDeploymentURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteAppsV1CollectionNamespacedDeploymentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteAppsV1CollectionNamespacedDeploymentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteAppsV1CollectionNamespacedDeploymentURL")
	}
...
func (o *DeleteAppsV1CollectionNamespacedDeploymentURL) StringFull(scheme, host string) string {
