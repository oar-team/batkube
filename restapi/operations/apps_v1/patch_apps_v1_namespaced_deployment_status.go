...
type PatchAppsV1NamespacedDeploymentStatusHandlerFunc func(PatchAppsV1NamespacedDeploymentStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchAppsV1NamespacedDeploymentStatusHandlerFunc) Handle(params PatchAppsV1NamespacedDeploymentStatusParams, principal interface{}) middleware.Responder {
...
type PatchAppsV1NamespacedDeploymentStatusHandler interface {
	Handle(PatchAppsV1NamespacedDeploymentStatusParams, interface{}) middleware.Responder
}
