...
// NewPatchAppsV1NamespacedDeploymentParams creates a new PatchAppsV1NamespacedDeploymentParams object
// no default values defined in spec.
func NewPatchAppsV1NamespacedDeploymentParams() PatchAppsV1NamespacedDeploymentParams {

	return PatchAppsV1NamespacedDeploymentParams{}
}

// PatchAppsV1NamespacedDeploymentParams contains all the bound params for the patch apps v1 namespaced deployment operation
...
func (o *PatchAppsV1NamespacedDeploymentParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchAppsV1NamespacedDeploymentParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchAppsV1NamespacedDeploymentParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDeploymentParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchAppsV1NamespacedDeploymentParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDeploymentParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchAppsV1NamespacedDeploymentParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDeploymentParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchAppsV1NamespacedDeploymentParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDeploymentParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchAppsV1NamespacedDeploymentParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDeploymentParams) validatePretty(formats strfmt.Registry) error {
