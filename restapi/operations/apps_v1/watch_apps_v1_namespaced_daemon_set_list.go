...
type WatchAppsV1NamespacedDaemonSetListHandlerFunc func(WatchAppsV1NamespacedDaemonSetListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchAppsV1NamespacedDaemonSetListHandlerFunc) Handle(params WatchAppsV1NamespacedDaemonSetListParams, principal interface{}) middleware.Responder {
...
type WatchAppsV1NamespacedDaemonSetListHandler interface {
	Handle(WatchAppsV1NamespacedDaemonSetListParams, interface{}) middleware.Responder
}
