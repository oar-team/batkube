...
type ReplaceAppsV1NamespacedStatefulSetStatusHandlerFunc func(ReplaceAppsV1NamespacedStatefulSetStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceAppsV1NamespacedStatefulSetStatusHandlerFunc) Handle(params ReplaceAppsV1NamespacedStatefulSetStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceAppsV1NamespacedStatefulSetStatusHandler interface {
	Handle(ReplaceAppsV1NamespacedStatefulSetStatusParams, interface{}) middleware.Responder
}
