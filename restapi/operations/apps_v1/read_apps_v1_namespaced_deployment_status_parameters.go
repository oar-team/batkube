...
// ReadAppsV1NamespacedDeploymentStatusParams contains all the bound params for the read apps v1 namespaced deployment status operation
...
func (o *ReadAppsV1NamespacedDeploymentStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadAppsV1NamespacedDeploymentStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadAppsV1NamespacedDeploymentStatusParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadAppsV1NamespacedDeploymentStatusParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadAppsV1NamespacedDeploymentStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadAppsV1NamespacedDeploymentStatusParams) validatePretty(formats strfmt.Registry) error {
