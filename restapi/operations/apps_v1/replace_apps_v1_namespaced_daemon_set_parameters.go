...
// NewReplaceAppsV1NamespacedDaemonSetParams creates a new ReplaceAppsV1NamespacedDaemonSetParams object
// no default values defined in spec.
func NewReplaceAppsV1NamespacedDaemonSetParams() ReplaceAppsV1NamespacedDaemonSetParams {

	return ReplaceAppsV1NamespacedDaemonSetParams{}
}

// ReplaceAppsV1NamespacedDaemonSetParams contains all the bound params for the replace apps v1 namespaced daemon set operation
...
func (o *ReplaceAppsV1NamespacedDaemonSetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceAppsV1NamespacedDaemonSetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceAppsV1NamespacedDaemonSetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedDaemonSetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceAppsV1NamespacedDaemonSetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedDaemonSetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReplaceAppsV1NamespacedDaemonSetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedDaemonSetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceAppsV1NamespacedDaemonSetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedDaemonSetParams) validatePretty(formats strfmt.Registry) error {
