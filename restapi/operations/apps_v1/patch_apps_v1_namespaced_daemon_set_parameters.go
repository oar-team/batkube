...
// NewPatchAppsV1NamespacedDaemonSetParams creates a new PatchAppsV1NamespacedDaemonSetParams object
// no default values defined in spec.
func NewPatchAppsV1NamespacedDaemonSetParams() PatchAppsV1NamespacedDaemonSetParams {

	return PatchAppsV1NamespacedDaemonSetParams{}
}

// PatchAppsV1NamespacedDaemonSetParams contains all the bound params for the patch apps v1 namespaced daemon set operation
...
func (o *PatchAppsV1NamespacedDaemonSetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchAppsV1NamespacedDaemonSetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchAppsV1NamespacedDaemonSetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDaemonSetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchAppsV1NamespacedDaemonSetParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDaemonSetParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchAppsV1NamespacedDaemonSetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDaemonSetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchAppsV1NamespacedDaemonSetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDaemonSetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchAppsV1NamespacedDaemonSetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedDaemonSetParams) validatePretty(formats strfmt.Registry) error {
