...
// NewCreateAppsV1NamespacedStatefulSetParams creates a new CreateAppsV1NamespacedStatefulSetParams object
// no default values defined in spec.
func NewCreateAppsV1NamespacedStatefulSetParams() CreateAppsV1NamespacedStatefulSetParams {

	return CreateAppsV1NamespacedStatefulSetParams{}
}

// CreateAppsV1NamespacedStatefulSetParams contains all the bound params for the create apps v1 namespaced stateful set operation
...
func (o *CreateAppsV1NamespacedStatefulSetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateAppsV1NamespacedStatefulSetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateAppsV1NamespacedStatefulSetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAppsV1NamespacedStatefulSetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateAppsV1NamespacedStatefulSetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAppsV1NamespacedStatefulSetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateAppsV1NamespacedStatefulSetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateAppsV1NamespacedStatefulSetParams) validatePretty(formats strfmt.Registry) error {
