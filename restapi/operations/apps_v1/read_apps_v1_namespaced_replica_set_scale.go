...
type ReadAppsV1NamespacedReplicaSetScaleHandlerFunc func(ReadAppsV1NamespacedReplicaSetScaleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadAppsV1NamespacedReplicaSetScaleHandlerFunc) Handle(params ReadAppsV1NamespacedReplicaSetScaleParams, principal interface{}) middleware.Responder {
...
type ReadAppsV1NamespacedReplicaSetScaleHandler interface {
	Handle(ReadAppsV1NamespacedReplicaSetScaleParams, interface{}) middleware.Responder
}
