...
// NewPatchAppsV1NamespacedStatefulSetParams creates a new PatchAppsV1NamespacedStatefulSetParams object
// no default values defined in spec.
func NewPatchAppsV1NamespacedStatefulSetParams() PatchAppsV1NamespacedStatefulSetParams {

	return PatchAppsV1NamespacedStatefulSetParams{}
}

// PatchAppsV1NamespacedStatefulSetParams contains all the bound params for the patch apps v1 namespaced stateful set operation
...
func (o *PatchAppsV1NamespacedStatefulSetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchAppsV1NamespacedStatefulSetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchAppsV1NamespacedStatefulSetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedStatefulSetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchAppsV1NamespacedStatefulSetParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedStatefulSetParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchAppsV1NamespacedStatefulSetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedStatefulSetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchAppsV1NamespacedStatefulSetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedStatefulSetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchAppsV1NamespacedStatefulSetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchAppsV1NamespacedStatefulSetParams) validatePretty(formats strfmt.Registry) error {
