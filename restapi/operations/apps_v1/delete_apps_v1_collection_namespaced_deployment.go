...
type DeleteAppsV1CollectionNamespacedDeploymentHandlerFunc func(DeleteAppsV1CollectionNamespacedDeploymentParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAppsV1CollectionNamespacedDeploymentHandlerFunc) Handle(params DeleteAppsV1CollectionNamespacedDeploymentParams, principal interface{}) middleware.Responder {
...
type DeleteAppsV1CollectionNamespacedDeploymentHandler interface {
	Handle(DeleteAppsV1CollectionNamespacedDeploymentParams, interface{}) middleware.Responder
}
