...
// NewReplaceAppsV1NamespacedReplicaSetParams creates a new ReplaceAppsV1NamespacedReplicaSetParams object
// no default values defined in spec.
func NewReplaceAppsV1NamespacedReplicaSetParams() ReplaceAppsV1NamespacedReplicaSetParams {

	return ReplaceAppsV1NamespacedReplicaSetParams{}
}

// ReplaceAppsV1NamespacedReplicaSetParams contains all the bound params for the replace apps v1 namespaced replica set operation
...
func (o *ReplaceAppsV1NamespacedReplicaSetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceAppsV1NamespacedReplicaSetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceAppsV1NamespacedReplicaSetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedReplicaSetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceAppsV1NamespacedReplicaSetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedReplicaSetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReplaceAppsV1NamespacedReplicaSetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedReplicaSetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceAppsV1NamespacedReplicaSetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAppsV1NamespacedReplicaSetParams) validatePretty(formats strfmt.Registry) error {
