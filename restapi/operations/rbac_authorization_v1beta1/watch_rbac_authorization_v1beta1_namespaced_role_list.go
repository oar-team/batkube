...
type WatchRbacAuthorizationV1beta1NamespacedRoleListHandlerFunc func(WatchRbacAuthorizationV1beta1NamespacedRoleListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1beta1NamespacedRoleListHandlerFunc) Handle(params WatchRbacAuthorizationV1beta1NamespacedRoleListParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1beta1NamespacedRoleListHandler interface {
	Handle(WatchRbacAuthorizationV1beta1NamespacedRoleListParams, interface{}) middleware.Responder
}
