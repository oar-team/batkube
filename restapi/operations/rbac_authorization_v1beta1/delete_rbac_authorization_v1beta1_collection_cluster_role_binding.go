...
type DeleteRbacAuthorizationV1beta1CollectionClusterRoleBindingHandlerFunc func(DeleteRbacAuthorizationV1beta1CollectionClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1beta1CollectionClusterRoleBindingHandlerFunc) Handle(params DeleteRbacAuthorizationV1beta1CollectionClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1beta1CollectionClusterRoleBindingHandler interface {
	Handle(DeleteRbacAuthorizationV1beta1CollectionClusterRoleBindingParams, interface{}) middleware.Responder
}
