...
// NewCreateRbacAuthorizationV1beta1ClusterRoleBindingParams creates a new CreateRbacAuthorizationV1beta1ClusterRoleBindingParams object
...
func NewCreateRbacAuthorizationV1beta1ClusterRoleBindingParams() CreateRbacAuthorizationV1beta1ClusterRoleBindingParams {
	...
	return CreateRbacAuthorizationV1beta1ClusterRoleBindingParams{}
}

// CreateRbacAuthorizationV1beta1ClusterRoleBindingParams contains all the bound params for the create rbac authorization v1beta1 cluster role binding operation
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateRbacAuthorizationV1beta1ClusterRoleBindingParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleBindingParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateRbacAuthorizationV1beta1ClusterRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleBindingParams) validatePretty(formats strfmt.Registry) error {
