...
type WatchRbacAuthorizationV1beta1ClusterRoleListHandlerFunc func(WatchRbacAuthorizationV1beta1ClusterRoleListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1beta1ClusterRoleListHandlerFunc) Handle(params WatchRbacAuthorizationV1beta1ClusterRoleListParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1beta1ClusterRoleListHandler interface {
	Handle(WatchRbacAuthorizationV1beta1ClusterRoleListParams, interface{}) middleware.Responder
}
...
func NewWatchRbacAuthorizationV1beta1ClusterRoleList(ctx *middleware.Context, handler WatchRbacAuthorizationV1beta1ClusterRoleListHandler) *WatchRbacAuthorizationV1beta1ClusterRoleList {
	return &WatchRbacAuthorizationV1beta1ClusterRoleList{Context: ctx, Handler: handler}
}
...
func (o *WatchRbacAuthorizationV1beta1ClusterRoleList) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewWatchRbacAuthorizationV1beta1ClusterRoleListParams()
