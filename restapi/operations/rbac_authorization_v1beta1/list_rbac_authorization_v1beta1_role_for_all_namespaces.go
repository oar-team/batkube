...
type ListRbacAuthorizationV1beta1RoleForAllNamespacesHandlerFunc func(ListRbacAuthorizationV1beta1RoleForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1beta1RoleForAllNamespacesHandlerFunc) Handle(params ListRbacAuthorizationV1beta1RoleForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1beta1RoleForAllNamespacesHandler interface {
	Handle(ListRbacAuthorizationV1beta1RoleForAllNamespacesParams, interface{}) middleware.Responder
}
