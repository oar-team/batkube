...
type WatchRbacAuthorizationV1beta1ClusterRoleHandlerFunc func(WatchRbacAuthorizationV1beta1ClusterRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1beta1ClusterRoleHandlerFunc) Handle(params WatchRbacAuthorizationV1beta1ClusterRoleParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1beta1ClusterRoleHandler interface {
	Handle(WatchRbacAuthorizationV1beta1ClusterRoleParams, interface{}) middleware.Responder
}
