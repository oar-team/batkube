...
type ReplaceRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc func(ReplaceRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc) Handle(params ReplaceRbacAuthorizationV1beta1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type ReplaceRbacAuthorizationV1beta1NamespacedRoleBindingHandler interface {
	Handle(ReplaceRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
