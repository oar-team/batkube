...
type ReadRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc func(ReadRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc) Handle(params ReadRbacAuthorizationV1beta1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type ReadRbacAuthorizationV1beta1ClusterRoleBindingHandler interface {
	Handle(ReadRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder
}
