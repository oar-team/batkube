...
type ListRbacAuthorizationV1beta1NamespacedRoleHandlerFunc func(ListRbacAuthorizationV1beta1NamespacedRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1beta1NamespacedRoleHandlerFunc) Handle(params ListRbacAuthorizationV1beta1NamespacedRoleParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1beta1NamespacedRoleHandler interface {
	Handle(ListRbacAuthorizationV1beta1NamespacedRoleParams, interface{}) middleware.Responder
}
