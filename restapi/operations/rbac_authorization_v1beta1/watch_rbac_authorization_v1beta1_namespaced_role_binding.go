...
type WatchRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc func(WatchRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc) Handle(params WatchRbacAuthorizationV1beta1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1beta1NamespacedRoleBindingHandler interface {
	Handle(WatchRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
