...
type ListRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc func(ListRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc) Handle(params ListRbacAuthorizationV1beta1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1beta1NamespacedRoleBindingHandler interface {
	Handle(ListRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
