...
type CreateRbacAuthorizationV1beta1ClusterRoleHandlerFunc func(CreateRbacAuthorizationV1beta1ClusterRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateRbacAuthorizationV1beta1ClusterRoleHandlerFunc) Handle(params CreateRbacAuthorizationV1beta1ClusterRoleParams, principal interface{}) middleware.Responder {
...
type CreateRbacAuthorizationV1beta1ClusterRoleHandler interface {
	Handle(CreateRbacAuthorizationV1beta1ClusterRoleParams, interface{}) middleware.Responder
}
