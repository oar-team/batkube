...
type ListRbacAuthorizationV1beta1RoleBindingForAllNamespacesHandlerFunc func(ListRbacAuthorizationV1beta1RoleBindingForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1beta1RoleBindingForAllNamespacesHandlerFunc) Handle(params ListRbacAuthorizationV1beta1RoleBindingForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1beta1RoleBindingForAllNamespacesHandler interface {
	Handle(ListRbacAuthorizationV1beta1RoleBindingForAllNamespacesParams, interface{}) middleware.Responder
}
