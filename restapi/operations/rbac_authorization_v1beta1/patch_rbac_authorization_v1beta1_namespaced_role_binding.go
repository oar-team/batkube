...
type PatchRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc func(PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc) Handle(params PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type PatchRbacAuthorizationV1beta1NamespacedRoleBindingHandler interface {
	Handle(PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
