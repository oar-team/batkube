...
type ListRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc func(ListRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc) Handle(params ListRbacAuthorizationV1beta1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type ListRbacAuthorizationV1beta1ClusterRoleBindingHandler interface {
	Handle(ListRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder
}
