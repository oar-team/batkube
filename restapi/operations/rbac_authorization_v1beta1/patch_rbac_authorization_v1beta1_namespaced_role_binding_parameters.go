...
func NewPatchRbacAuthorizationV1beta1NamespacedRoleBindingParams() PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams {
	...
	return PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams{}
}

// PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams contains all the bound params for the patch rbac authorization v1beta1 namespaced role binding operation
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1NamespacedRoleBindingParams) validatePretty(formats strfmt.Registry) error {
