...
type WatchRbacAuthorizationV1beta1NamespacedRoleBindingListHandlerFunc func(WatchRbacAuthorizationV1beta1NamespacedRoleBindingListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1beta1NamespacedRoleBindingListHandlerFunc) Handle(params WatchRbacAuthorizationV1beta1NamespacedRoleBindingListParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1beta1NamespacedRoleBindingListHandler interface {
	Handle(WatchRbacAuthorizationV1beta1NamespacedRoleBindingListParams, interface{}) middleware.Responder
}
