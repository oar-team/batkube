...
type ReadRbacAuthorizationV1beta1ClusterRoleHandlerFunc func(ReadRbacAuthorizationV1beta1ClusterRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadRbacAuthorizationV1beta1ClusterRoleHandlerFunc) Handle(params ReadRbacAuthorizationV1beta1ClusterRoleParams, principal interface{}) middleware.Responder {
...
type ReadRbacAuthorizationV1beta1ClusterRoleHandler interface {
	Handle(ReadRbacAuthorizationV1beta1ClusterRoleParams, interface{}) middleware.Responder
}
