...
// CreateRbacAuthorizationV1beta1ClusterRoleParams contains all the bound params for the create rbac authorization v1beta1 cluster role operation
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateRbacAuthorizationV1beta1ClusterRoleParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateRbacAuthorizationV1beta1ClusterRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1ClusterRoleParams) validatePretty(formats strfmt.Registry) error {
