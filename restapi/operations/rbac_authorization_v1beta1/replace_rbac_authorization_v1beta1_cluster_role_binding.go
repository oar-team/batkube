...
type ReplaceRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc func(ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc) Handle(params ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type ReplaceRbacAuthorizationV1beta1ClusterRoleBindingHandler interface {
	Handle(ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder
}
...
func NewReplaceRbacAuthorizationV1beta1ClusterRoleBinding(ctx *middleware.Context, handler ReplaceRbacAuthorizationV1beta1ClusterRoleBindingHandler) *ReplaceRbacAuthorizationV1beta1ClusterRoleBinding {
	return &ReplaceRbacAuthorizationV1beta1ClusterRoleBinding{Context: ctx, Handler: handler}
}
...
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBinding) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams()
