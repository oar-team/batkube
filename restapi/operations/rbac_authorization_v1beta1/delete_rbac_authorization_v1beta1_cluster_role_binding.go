...
type DeleteRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc func(DeleteRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc) Handle(params DeleteRbacAuthorizationV1beta1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1beta1ClusterRoleBindingHandler interface {
	Handle(DeleteRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder
}
