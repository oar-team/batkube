...
// NewDeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams creates a new DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams object
...
func NewDeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams() DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams {
	...
	return DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams{}
}

// DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams contains all the bound params for the delete rbac authorization v1beta1 namespaced role binding operation
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams) validatePropagationPolicy(formats strfmt.Registry) error {
