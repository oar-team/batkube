...
// ReadRbacAuthorizationV1beta1ClusterRoleParams contains all the bound params for the read rbac authorization v1beta1 cluster role operation
...
func (o *ReadRbacAuthorizationV1beta1ClusterRoleParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadRbacAuthorizationV1beta1ClusterRoleParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadRbacAuthorizationV1beta1ClusterRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadRbacAuthorizationV1beta1ClusterRoleParams) validatePretty(formats strfmt.Registry) error {
