...
type ReplaceRbacAuthorizationV1beta1NamespacedRoleHandlerFunc func(ReplaceRbacAuthorizationV1beta1NamespacedRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceRbacAuthorizationV1beta1NamespacedRoleHandlerFunc) Handle(params ReplaceRbacAuthorizationV1beta1NamespacedRoleParams, principal interface{}) middleware.Responder {
...
type ReplaceRbacAuthorizationV1beta1NamespacedRoleHandler interface {
	Handle(ReplaceRbacAuthorizationV1beta1NamespacedRoleParams, interface{}) middleware.Responder
}
