...
// NewPatchRbacAuthorizationV1beta1ClusterRoleParams creates a new PatchRbacAuthorizationV1beta1ClusterRoleParams object
// no default values defined in spec.
func NewPatchRbacAuthorizationV1beta1ClusterRoleParams() PatchRbacAuthorizationV1beta1ClusterRoleParams {

	return PatchRbacAuthorizationV1beta1ClusterRoleParams{}
}

// PatchRbacAuthorizationV1beta1ClusterRoleParams contains all the bound params for the patch rbac authorization v1beta1 cluster role operation
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleParams) validatePretty(formats strfmt.Registry) error {
