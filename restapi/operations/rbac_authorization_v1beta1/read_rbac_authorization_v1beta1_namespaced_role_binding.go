...
type ReadRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc func(ReadRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc) Handle(params ReadRbacAuthorizationV1beta1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type ReadRbacAuthorizationV1beta1NamespacedRoleBindingHandler interface {
	Handle(ReadRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
