...
type CreateRbacAuthorizationV1beta1NamespacedRoleHandlerFunc func(CreateRbacAuthorizationV1beta1NamespacedRoleParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateRbacAuthorizationV1beta1NamespacedRoleHandlerFunc) Handle(params CreateRbacAuthorizationV1beta1NamespacedRoleParams, principal interface{}) middleware.Responder {
...
type CreateRbacAuthorizationV1beta1NamespacedRoleHandler interface {
	Handle(CreateRbacAuthorizationV1beta1NamespacedRoleParams, interface{}) middleware.Responder
}
