...
// NewCreateRbacAuthorizationV1beta1NamespacedRoleParams creates a new CreateRbacAuthorizationV1beta1NamespacedRoleParams object
// no default values defined in spec.
func NewCreateRbacAuthorizationV1beta1NamespacedRoleParams() CreateRbacAuthorizationV1beta1NamespacedRoleParams {

	return CreateRbacAuthorizationV1beta1NamespacedRoleParams{}
}

// CreateRbacAuthorizationV1beta1NamespacedRoleParams contains all the bound params for the create rbac authorization v1beta1 namespaced role operation
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleParams) validatePretty(formats strfmt.Registry) error {
