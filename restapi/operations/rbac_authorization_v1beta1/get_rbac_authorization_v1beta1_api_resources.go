...
type GetRbacAuthorizationV1beta1APIResourcesHandlerFunc func(GetRbacAuthorizationV1beta1APIResourcesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRbacAuthorizationV1beta1APIResourcesHandlerFunc) Handle(params GetRbacAuthorizationV1beta1APIResourcesParams, principal interface{}) middleware.Responder {
...
type GetRbacAuthorizationV1beta1APIResourcesHandler interface {
	Handle(GetRbacAuthorizationV1beta1APIResourcesParams, interface{}) middleware.Responder
}
