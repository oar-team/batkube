...
// NewPatchRbacAuthorizationV1beta1ClusterRoleBindingParams creates a new PatchRbacAuthorizationV1beta1ClusterRoleBindingParams object
...
func NewPatchRbacAuthorizationV1beta1ClusterRoleBindingParams() PatchRbacAuthorizationV1beta1ClusterRoleBindingParams {
	...
	return PatchRbacAuthorizationV1beta1ClusterRoleBindingParams{}
}

// PatchRbacAuthorizationV1beta1ClusterRoleBindingParams contains all the bound params for the patch rbac authorization v1beta1 cluster role binding operation
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchRbacAuthorizationV1beta1ClusterRoleBindingParams) validatePretty(formats strfmt.Registry) error {
