...
type WatchRbacAuthorizationV1beta1ClusterRoleBindingListHandlerFunc func(WatchRbacAuthorizationV1beta1ClusterRoleBindingListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1beta1ClusterRoleBindingListHandlerFunc) Handle(params WatchRbacAuthorizationV1beta1ClusterRoleBindingListParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1beta1ClusterRoleBindingListHandler interface {
	Handle(WatchRbacAuthorizationV1beta1ClusterRoleBindingListParams, interface{}) middleware.Responder
}
