...
type CreateRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc func(CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc) Handle(params CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type CreateRbacAuthorizationV1beta1NamespacedRoleBindingHandler interface {
	Handle(CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
