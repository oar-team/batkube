...
// NewCreateRbacAuthorizationV1beta1NamespacedRoleBindingParams creates a new CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams object
...
func NewCreateRbacAuthorizationV1beta1NamespacedRoleBindingParams() CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams {
	...
	return CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams{}
}

// CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams contains all the bound params for the create rbac authorization v1beta1 namespaced role binding operation
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateRbacAuthorizationV1beta1NamespacedRoleBindingParams) validatePretty(formats strfmt.Registry) error {
