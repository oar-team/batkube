...
type WatchRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc func(WatchRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchRbacAuthorizationV1beta1ClusterRoleBindingHandlerFunc) Handle(params WatchRbacAuthorizationV1beta1ClusterRoleBindingParams, principal interface{}) middleware.Responder {
...
type WatchRbacAuthorizationV1beta1ClusterRoleBindingHandler interface {
	Handle(WatchRbacAuthorizationV1beta1ClusterRoleBindingParams, interface{}) middleware.Responder
}
