...
// NewReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams creates a new ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams object
...
func NewReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams() ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams {
	...
	return ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams{}
}

// ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams contains all the bound params for the replace rbac authorization v1beta1 cluster role binding operation
...
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPIRbacV1beta1ClusterRoleBinding
...
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceRbacAuthorizationV1beta1ClusterRoleBindingParams) validatePretty(formats strfmt.Registry) error {
