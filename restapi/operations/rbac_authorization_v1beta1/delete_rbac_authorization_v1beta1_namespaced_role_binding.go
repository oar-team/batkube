...
type DeleteRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc func(DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRbacAuthorizationV1beta1NamespacedRoleBindingHandlerFunc) Handle(params DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams, principal interface{}) middleware.Responder {
...
type DeleteRbacAuthorizationV1beta1NamespacedRoleBindingHandler interface {
	Handle(DeleteRbacAuthorizationV1beta1NamespacedRoleBindingParams, interface{}) middleware.Responder
}
