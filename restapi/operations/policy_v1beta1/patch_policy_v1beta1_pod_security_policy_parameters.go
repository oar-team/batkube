...
// NewPatchPolicyV1beta1PodSecurityPolicyParams creates a new PatchPolicyV1beta1PodSecurityPolicyParams object
// no default values defined in spec.
func NewPatchPolicyV1beta1PodSecurityPolicyParams() PatchPolicyV1beta1PodSecurityPolicyParams {

	return PatchPolicyV1beta1PodSecurityPolicyParams{}
}

// PatchPolicyV1beta1PodSecurityPolicyParams contains all the bound params for the patch policy v1beta1 pod security policy operation
...
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1PodSecurityPolicyParams) validatePretty(formats strfmt.Registry) error {
