...
type CreatePolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc func(CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreatePolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc) Handle(params CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams, principal interface{}) middleware.Responder {
...
type CreatePolicyV1beta1NamespacedPodDisruptionBudgetHandler interface {
	Handle(CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder
}
