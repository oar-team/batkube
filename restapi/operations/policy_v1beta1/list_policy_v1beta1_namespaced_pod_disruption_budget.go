...
type ListPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc func(ListPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc) Handle(params ListPolicyV1beta1NamespacedPodDisruptionBudgetParams, principal interface{}) middleware.Responder {
...
type ListPolicyV1beta1NamespacedPodDisruptionBudgetHandler interface {
	Handle(ListPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder
}
