...
// NewPatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams creates a new PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams object
...
func NewPatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams() PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams {
	...
	return PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams{}
}

// PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams contains all the bound params for the patch policy v1beta1 namespaced pod disruption budget status operation
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetStatusParams) validatePretty(formats strfmt.Registry) error {
