...
// DeletePolicyV1beta1CollectionPodSecurityPolicyURL generates an URL for the delete policy v1beta1 collection pod security policy operation
type DeletePolicyV1beta1CollectionPodSecurityPolicyURL struct {
...
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyURL) WithBasePath(bp string) *DeletePolicyV1beta1CollectionPodSecurityPolicyURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeletePolicyV1beta1CollectionPodSecurityPolicyURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeletePolicyV1beta1CollectionPodSecurityPolicyURL")
	}
...
func (o *DeletePolicyV1beta1CollectionPodSecurityPolicyURL) StringFull(scheme, host string) string {
