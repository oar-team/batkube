...
type ReadPolicyV1beta1PodSecurityPolicyHandlerFunc func(ReadPolicyV1beta1PodSecurityPolicyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadPolicyV1beta1PodSecurityPolicyHandlerFunc) Handle(params ReadPolicyV1beta1PodSecurityPolicyParams, principal interface{}) middleware.Responder {
...
type ReadPolicyV1beta1PodSecurityPolicyHandler interface {
	Handle(ReadPolicyV1beta1PodSecurityPolicyParams, interface{}) middleware.Responder
}
