...
type DeletePolicyV1beta1PodSecurityPolicyHandlerFunc func(DeletePolicyV1beta1PodSecurityPolicyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeletePolicyV1beta1PodSecurityPolicyHandlerFunc) Handle(params DeletePolicyV1beta1PodSecurityPolicyParams, principal interface{}) middleware.Responder {
...
type DeletePolicyV1beta1PodSecurityPolicyHandler interface {
	Handle(DeletePolicyV1beta1PodSecurityPolicyParams, interface{}) middleware.Responder
}
