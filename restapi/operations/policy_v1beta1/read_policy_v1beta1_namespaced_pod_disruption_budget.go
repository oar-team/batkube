...
type ReadPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc func(ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc) Handle(params ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams, principal interface{}) middleware.Responder {
...
type ReadPolicyV1beta1NamespacedPodDisruptionBudgetHandler interface {
	Handle(ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder
}
