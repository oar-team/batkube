...
// NewCreatePolicyV1beta1PodSecurityPolicyParams creates a new CreatePolicyV1beta1PodSecurityPolicyParams object
// no default values defined in spec.
func NewCreatePolicyV1beta1PodSecurityPolicyParams() CreatePolicyV1beta1PodSecurityPolicyParams {

	return CreatePolicyV1beta1PodSecurityPolicyParams{}
}

// CreatePolicyV1beta1PodSecurityPolicyParams contains all the bound params for the create policy v1beta1 pod security policy operation
...
func (o *CreatePolicyV1beta1PodSecurityPolicyParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreatePolicyV1beta1PodSecurityPolicyParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreatePolicyV1beta1PodSecurityPolicyParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreatePolicyV1beta1PodSecurityPolicyParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreatePolicyV1beta1PodSecurityPolicyParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreatePolicyV1beta1PodSecurityPolicyParams) validatePretty(formats strfmt.Registry) error {
