...
type WatchPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc func(WatchPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc) Handle(params WatchPolicyV1beta1NamespacedPodDisruptionBudgetParams, principal interface{}) middleware.Responder {
...
type WatchPolicyV1beta1NamespacedPodDisruptionBudgetHandler interface {
	Handle(WatchPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder
}
