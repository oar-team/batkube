...
// NewPatchPolicyV1beta1NamespacedPodDisruptionBudgetParams creates a new PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams object
...
func NewPatchPolicyV1beta1NamespacedPodDisruptionBudgetParams() PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams {
	...
	return PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams{}
}

// PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams contains all the bound params for the patch policy v1beta1 namespaced pod disruption budget operation
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams) validatePretty(formats strfmt.Registry) error {
