...
type WatchPolicyV1beta1PodDisruptionBudgetListForAllNamespacesHandlerFunc func(WatchPolicyV1beta1PodDisruptionBudgetListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchPolicyV1beta1PodDisruptionBudgetListForAllNamespacesHandlerFunc) Handle(params WatchPolicyV1beta1PodDisruptionBudgetListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchPolicyV1beta1PodDisruptionBudgetListForAllNamespacesHandler interface {
	Handle(WatchPolicyV1beta1PodDisruptionBudgetListForAllNamespacesParams, interface{}) middleware.Responder
}
