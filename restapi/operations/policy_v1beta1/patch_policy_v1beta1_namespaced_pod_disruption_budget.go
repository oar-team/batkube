...
type PatchPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc func(PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchPolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc) Handle(params PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams, principal interface{}) middleware.Responder {
...
type PatchPolicyV1beta1NamespacedPodDisruptionBudgetHandler interface {
	Handle(PatchPolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder
}
