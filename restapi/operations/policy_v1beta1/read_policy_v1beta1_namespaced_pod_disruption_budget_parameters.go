...
// ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams contains all the bound params for the read policy v1beta1 namespaced pod disruption budget operation
...
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadPolicyV1beta1NamespacedPodDisruptionBudgetParams) validatePretty(formats strfmt.Registry) error {
