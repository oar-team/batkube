...
// NewCreatePolicyV1beta1NamespacedPodDisruptionBudgetParams creates a new CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams object
...
func NewCreatePolicyV1beta1NamespacedPodDisruptionBudgetParams() CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams {
	...
	return CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams{}
}

// CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams contains all the bound params for the create policy v1beta1 namespaced pod disruption budget operation
...
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreatePolicyV1beta1NamespacedPodDisruptionBudgetParams) validatePretty(formats strfmt.Registry) error {
