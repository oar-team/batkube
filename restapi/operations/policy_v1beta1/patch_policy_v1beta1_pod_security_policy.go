...
type PatchPolicyV1beta1PodSecurityPolicyHandlerFunc func(PatchPolicyV1beta1PodSecurityPolicyParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchPolicyV1beta1PodSecurityPolicyHandlerFunc) Handle(params PatchPolicyV1beta1PodSecurityPolicyParams, principal interface{}) middleware.Responder {
...
type PatchPolicyV1beta1PodSecurityPolicyHandler interface {
	Handle(PatchPolicyV1beta1PodSecurityPolicyParams, interface{}) middleware.Responder
}
