...
type DeletePolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc func(DeletePolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeletePolicyV1beta1NamespacedPodDisruptionBudgetHandlerFunc) Handle(params DeletePolicyV1beta1NamespacedPodDisruptionBudgetParams, principal interface{}) middleware.Responder {
...
type DeletePolicyV1beta1NamespacedPodDisruptionBudgetHandler interface {
	Handle(DeletePolicyV1beta1NamespacedPodDisruptionBudgetParams, interface{}) middleware.Responder
}
...
func NewDeletePolicyV1beta1NamespacedPodDisruptionBudget(ctx *middleware.Context, handler DeletePolicyV1beta1NamespacedPodDisruptionBudgetHandler) *DeletePolicyV1beta1NamespacedPodDisruptionBudget {
	return &DeletePolicyV1beta1NamespacedPodDisruptionBudget{Context: ctx, Handler: handler}
}
...
func (o *DeletePolicyV1beta1NamespacedPodDisruptionBudget) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewDeletePolicyV1beta1NamespacedPodDisruptionBudgetParams()
