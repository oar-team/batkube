...
// NewDeletePolicyV1beta1PodSecurityPolicyParams creates a new DeletePolicyV1beta1PodSecurityPolicyParams object
// no default values defined in spec.
func NewDeletePolicyV1beta1PodSecurityPolicyParams() DeletePolicyV1beta1PodSecurityPolicyParams {

	return DeletePolicyV1beta1PodSecurityPolicyParams{}
}

// DeletePolicyV1beta1PodSecurityPolicyParams contains all the bound params for the delete policy v1beta1 pod security policy operation
...
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindGracePeriodSeconds binds and validates parameter GracePeriodSeconds from query.
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) bindGracePeriodSeconds(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) validateGracePeriodSeconds(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindOrphanDependents binds and validates parameter OrphanDependents from query.
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) bindOrphanDependents(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) validateOrphanDependents(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) validatePretty(formats strfmt.Registry) error {

	return nil
}

// bindPropagationPolicy binds and validates parameter PropagationPolicy from query.
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) bindPropagationPolicy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeletePolicyV1beta1PodSecurityPolicyParams) validatePropagationPolicy(formats strfmt.Registry) error {
