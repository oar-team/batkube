...
// ReadPolicyV1beta1PodSecurityPolicyParams contains all the bound params for the read policy v1beta1 pod security policy operation
...
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) bindExact(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) validateExact(formats strfmt.Registry) error {

	return nil
}

// bindExport binds and validates parameter Export from query.
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) bindExport(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) validateExport(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReadPolicyV1beta1PodSecurityPolicyParams) validatePretty(formats strfmt.Registry) error {
