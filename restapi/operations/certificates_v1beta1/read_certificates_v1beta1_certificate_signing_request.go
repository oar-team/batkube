...
type ReadCertificatesV1beta1CertificateSigningRequestHandlerFunc func(ReadCertificatesV1beta1CertificateSigningRequestParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCertificatesV1beta1CertificateSigningRequestHandlerFunc) Handle(params ReadCertificatesV1beta1CertificateSigningRequestParams, principal interface{}) middleware.Responder {
...
type ReadCertificatesV1beta1CertificateSigningRequestHandler interface {
	Handle(ReadCertificatesV1beta1CertificateSigningRequestParams, interface{}) middleware.Responder
}
