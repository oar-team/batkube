...
type PatchCertificatesV1beta1CertificateSigningRequestHandlerFunc func(PatchCertificatesV1beta1CertificateSigningRequestParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchCertificatesV1beta1CertificateSigningRequestHandlerFunc) Handle(params PatchCertificatesV1beta1CertificateSigningRequestParams, principal interface{}) middleware.Responder {
...
type PatchCertificatesV1beta1CertificateSigningRequestHandler interface {
	Handle(PatchCertificatesV1beta1CertificateSigningRequestParams, interface{}) middleware.Responder
}
