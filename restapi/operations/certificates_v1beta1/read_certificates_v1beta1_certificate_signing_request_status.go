...
type ReadCertificatesV1beta1CertificateSigningRequestStatusHandlerFunc func(ReadCertificatesV1beta1CertificateSigningRequestStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadCertificatesV1beta1CertificateSigningRequestStatusHandlerFunc) Handle(params ReadCertificatesV1beta1CertificateSigningRequestStatusParams, principal interface{}) middleware.Responder {
...
type ReadCertificatesV1beta1CertificateSigningRequestStatusHandler interface {
	Handle(ReadCertificatesV1beta1CertificateSigningRequestStatusParams, interface{}) middleware.Responder
}
