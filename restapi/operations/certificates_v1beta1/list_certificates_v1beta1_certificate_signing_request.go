...
type ListCertificatesV1beta1CertificateSigningRequestHandlerFunc func(ListCertificatesV1beta1CertificateSigningRequestParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListCertificatesV1beta1CertificateSigningRequestHandlerFunc) Handle(params ListCertificatesV1beta1CertificateSigningRequestParams, principal interface{}) middleware.Responder {
...
type ListCertificatesV1beta1CertificateSigningRequestHandler interface {
	Handle(ListCertificatesV1beta1CertificateSigningRequestParams, interface{}) middleware.Responder
}
