...
type GetCodeVersionHandlerFunc func(GetCodeVersionParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetCodeVersionHandlerFunc) Handle(params GetCodeVersionParams, principal interface{}) middleware.Responder {
...
type GetCodeVersionHandler interface {
	Handle(GetCodeVersionParams, interface{}) middleware.Responder
}
