...
type ListExtensionsV1beta1IngressForAllNamespacesHandlerFunc func(ListExtensionsV1beta1IngressForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListExtensionsV1beta1IngressForAllNamespacesHandlerFunc) Handle(params ListExtensionsV1beta1IngressForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type ListExtensionsV1beta1IngressForAllNamespacesHandler interface {
	Handle(ListExtensionsV1beta1IngressForAllNamespacesParams, interface{}) middleware.Responder
}
