...
type ReplaceExtensionsV1beta1NamespacedIngressHandlerFunc func(ReplaceExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceExtensionsV1beta1NamespacedIngressHandlerFunc) Handle(params ReplaceExtensionsV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type ReplaceExtensionsV1beta1NamespacedIngressHandler interface {
	Handle(ReplaceExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
