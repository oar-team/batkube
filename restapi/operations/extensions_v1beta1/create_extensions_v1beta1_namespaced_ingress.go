...
type CreateExtensionsV1beta1NamespacedIngressHandlerFunc func(CreateExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateExtensionsV1beta1NamespacedIngressHandlerFunc) Handle(params CreateExtensionsV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type CreateExtensionsV1beta1NamespacedIngressHandler interface {
	Handle(CreateExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
