...
type WatchExtensionsV1beta1IngressListForAllNamespacesHandlerFunc func(WatchExtensionsV1beta1IngressListForAllNamespacesParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WatchExtensionsV1beta1IngressListForAllNamespacesHandlerFunc) Handle(params WatchExtensionsV1beta1IngressListForAllNamespacesParams, principal interface{}) middleware.Responder {
...
type WatchExtensionsV1beta1IngressListForAllNamespacesHandler interface {
	Handle(WatchExtensionsV1beta1IngressListForAllNamespacesParams, interface{}) middleware.Responder
}
