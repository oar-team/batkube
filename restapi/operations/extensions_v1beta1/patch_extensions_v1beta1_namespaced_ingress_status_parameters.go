...
// NewPatchExtensionsV1beta1NamespacedIngressStatusParams creates a new PatchExtensionsV1beta1NamespacedIngressStatusParams object
// no default values defined in spec.
func NewPatchExtensionsV1beta1NamespacedIngressStatusParams() PatchExtensionsV1beta1NamespacedIngressStatusParams {

	return PatchExtensionsV1beta1NamespacedIngressStatusParams{}
}

// PatchExtensionsV1beta1NamespacedIngressStatusParams contains all the bound params for the patch extensions v1beta1 namespaced ingress status operation
...
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchExtensionsV1beta1NamespacedIngressStatusParams) validatePretty(formats strfmt.Registry) error {
