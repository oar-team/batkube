...
type PatchExtensionsV1beta1NamespacedIngressHandlerFunc func(PatchExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PatchExtensionsV1beta1NamespacedIngressHandlerFunc) Handle(params PatchExtensionsV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type PatchExtensionsV1beta1NamespacedIngressHandler interface {
	Handle(PatchExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
