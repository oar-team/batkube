...
type ReadExtensionsV1beta1NamespacedIngressHandlerFunc func(ReadExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadExtensionsV1beta1NamespacedIngressHandlerFunc) Handle(params ReadExtensionsV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type ReadExtensionsV1beta1NamespacedIngressHandler interface {
	Handle(ReadExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
