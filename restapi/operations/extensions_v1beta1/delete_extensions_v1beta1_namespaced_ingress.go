...
type DeleteExtensionsV1beta1NamespacedIngressHandlerFunc func(DeleteExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteExtensionsV1beta1NamespacedIngressHandlerFunc) Handle(params DeleteExtensionsV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type DeleteExtensionsV1beta1NamespacedIngressHandler interface {
	Handle(DeleteExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
