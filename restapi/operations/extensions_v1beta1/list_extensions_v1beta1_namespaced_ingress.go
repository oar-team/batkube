...
type ListExtensionsV1beta1NamespacedIngressHandlerFunc func(ListExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListExtensionsV1beta1NamespacedIngressHandlerFunc) Handle(params ListExtensionsV1beta1NamespacedIngressParams, principal interface{}) middleware.Responder {
...
type ListExtensionsV1beta1NamespacedIngressHandler interface {
	Handle(ListExtensionsV1beta1NamespacedIngressParams, interface{}) middleware.Responder
}
