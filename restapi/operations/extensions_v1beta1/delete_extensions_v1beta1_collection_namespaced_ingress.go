...
type DeleteExtensionsV1beta1CollectionNamespacedIngressHandlerFunc func(DeleteExtensionsV1beta1CollectionNamespacedIngressParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteExtensionsV1beta1CollectionNamespacedIngressHandlerFunc) Handle(params DeleteExtensionsV1beta1CollectionNamespacedIngressParams, principal interface{}) middleware.Responder {
...
type DeleteExtensionsV1beta1CollectionNamespacedIngressHandler interface {
	Handle(DeleteExtensionsV1beta1CollectionNamespacedIngressParams, interface{}) middleware.Responder
}
