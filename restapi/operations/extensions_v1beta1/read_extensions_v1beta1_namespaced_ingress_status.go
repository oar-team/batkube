...
type ReadExtensionsV1beta1NamespacedIngressStatusHandlerFunc func(ReadExtensionsV1beta1NamespacedIngressStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadExtensionsV1beta1NamespacedIngressStatusHandlerFunc) Handle(params ReadExtensionsV1beta1NamespacedIngressStatusParams, principal interface{}) middleware.Responder {
...
type ReadExtensionsV1beta1NamespacedIngressStatusHandler interface {
	Handle(ReadExtensionsV1beta1NamespacedIngressStatusParams, interface{}) middleware.Responder
}
