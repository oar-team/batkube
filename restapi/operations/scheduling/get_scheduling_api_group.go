...
type GetSchedulingAPIGroupHandlerFunc func(GetSchedulingAPIGroupParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetSchedulingAPIGroupHandlerFunc) Handle(params GetSchedulingAPIGroupParams, principal interface{}) middleware.Responder {
...
type GetSchedulingAPIGroupHandler interface {
	Handle(GetSchedulingAPIGroupParams, interface{}) middleware.Responder
}
