...
type ReplaceBatchV2alpha1NamespacedCronJobHandlerFunc func(ReplaceBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceBatchV2alpha1NamespacedCronJobHandlerFunc) Handle(params ReplaceBatchV2alpha1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type ReplaceBatchV2alpha1NamespacedCronJobHandler interface {
	Handle(ReplaceBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder
}
