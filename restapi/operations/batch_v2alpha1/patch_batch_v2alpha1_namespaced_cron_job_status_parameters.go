...
// NewPatchBatchV2alpha1NamespacedCronJobStatusParams creates a new PatchBatchV2alpha1NamespacedCronJobStatusParams object
// no default values defined in spec.
func NewPatchBatchV2alpha1NamespacedCronJobStatusParams() PatchBatchV2alpha1NamespacedCronJobStatusParams {

	return PatchBatchV2alpha1NamespacedCronJobStatusParams{}
}

// PatchBatchV2alpha1NamespacedCronJobStatusParams contains all the bound params for the patch batch v2alpha1 namespaced cron job status operation
...
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobStatusParams) validatePretty(formats strfmt.Registry) error {
