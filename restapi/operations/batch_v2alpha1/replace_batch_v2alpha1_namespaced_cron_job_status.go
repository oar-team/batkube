...
type ReplaceBatchV2alpha1NamespacedCronJobStatusHandlerFunc func(ReplaceBatchV2alpha1NamespacedCronJobStatusParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceBatchV2alpha1NamespacedCronJobStatusHandlerFunc) Handle(params ReplaceBatchV2alpha1NamespacedCronJobStatusParams, principal interface{}) middleware.Responder {
...
type ReplaceBatchV2alpha1NamespacedCronJobStatusHandler interface {
	Handle(ReplaceBatchV2alpha1NamespacedCronJobStatusParams, interface{}) middleware.Responder
}
