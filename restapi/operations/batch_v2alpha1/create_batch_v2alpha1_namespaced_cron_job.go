...
type CreateBatchV2alpha1NamespacedCronJobHandlerFunc func(CreateBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateBatchV2alpha1NamespacedCronJobHandlerFunc) Handle(params CreateBatchV2alpha1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type CreateBatchV2alpha1NamespacedCronJobHandler interface {
	Handle(CreateBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder
}
