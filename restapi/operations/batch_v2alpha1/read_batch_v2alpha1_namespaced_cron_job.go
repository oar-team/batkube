...
type ReadBatchV2alpha1NamespacedCronJobHandlerFunc func(ReadBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReadBatchV2alpha1NamespacedCronJobHandlerFunc) Handle(params ReadBatchV2alpha1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type ReadBatchV2alpha1NamespacedCronJobHandler interface {
	Handle(ReadBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder
}
