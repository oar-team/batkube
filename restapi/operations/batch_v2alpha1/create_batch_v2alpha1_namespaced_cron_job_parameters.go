...
// NewCreateBatchV2alpha1NamespacedCronJobParams creates a new CreateBatchV2alpha1NamespacedCronJobParams object
// no default values defined in spec.
func NewCreateBatchV2alpha1NamespacedCronJobParams() CreateBatchV2alpha1NamespacedCronJobParams {

	return CreateBatchV2alpha1NamespacedCronJobParams{}
}

// CreateBatchV2alpha1NamespacedCronJobParams contains all the bound params for the create batch v2alpha1 namespaced cron job operation
...
func (o *CreateBatchV2alpha1NamespacedCronJobParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateBatchV2alpha1NamespacedCronJobParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *CreateBatchV2alpha1NamespacedCronJobParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateBatchV2alpha1NamespacedCronJobParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *CreateBatchV2alpha1NamespacedCronJobParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateBatchV2alpha1NamespacedCronJobParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *CreateBatchV2alpha1NamespacedCronJobParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateBatchV2alpha1NamespacedCronJobParams) validatePretty(formats strfmt.Registry) error {
