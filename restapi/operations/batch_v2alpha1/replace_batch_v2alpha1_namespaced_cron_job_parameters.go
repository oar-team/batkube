...
// NewReplaceBatchV2alpha1NamespacedCronJobParams creates a new ReplaceBatchV2alpha1NamespacedCronJobParams object
// no default values defined in spec.
func NewReplaceBatchV2alpha1NamespacedCronJobParams() ReplaceBatchV2alpha1NamespacedCronJobParams {

	return ReplaceBatchV2alpha1NamespacedCronJobParams{}
}

// ReplaceBatchV2alpha1NamespacedCronJobParams contains all the bound params for the replace batch v2alpha1 namespaced cron job operation
...
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IoK8sAPIBatchV2alpha1CronJob
...
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceBatchV2alpha1NamespacedCronJobParams) validatePretty(formats strfmt.Registry) error {
