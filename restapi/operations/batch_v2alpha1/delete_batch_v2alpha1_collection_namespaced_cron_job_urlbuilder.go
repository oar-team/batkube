...
// DeleteBatchV2alpha1CollectionNamespacedCronJobURL generates an URL for the delete batch v2alpha1 collection namespaced cron job operation
type DeleteBatchV2alpha1CollectionNamespacedCronJobURL struct {
	Namespace string
...
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobURL) WithBasePath(bp string) *DeleteBatchV2alpha1CollectionNamespacedCronJobURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs"

	namespace := o.Namespace
	if namespace != "" {
		_path = strings.Replace(_path, "{namespace}", namespace, -1)
	} else {
		return nil, errors.New("namespace is required on DeleteBatchV2alpha1CollectionNamespacedCronJobURL")
	}
...
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteBatchV2alpha1CollectionNamespacedCronJobURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteBatchV2alpha1CollectionNamespacedCronJobURL")
	}
...
func (o *DeleteBatchV2alpha1CollectionNamespacedCronJobURL) StringFull(scheme, host string) string {
