...
// NewPatchBatchV2alpha1NamespacedCronJobParams creates a new PatchBatchV2alpha1NamespacedCronJobParams object
// no default values defined in spec.
func NewPatchBatchV2alpha1NamespacedCronJobParams() PatchBatchV2alpha1NamespacedCronJobParams {

	return PatchBatchV2alpha1NamespacedCronJobParams{}
}

// PatchBatchV2alpha1NamespacedCronJobParams contains all the bound params for the patch batch v2alpha1 namespaced cron job operation
...
func (o *PatchBatchV2alpha1NamespacedCronJobParams) bindDryRun(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PatchBatchV2alpha1NamespacedCronJobParams) validateDryRun(formats strfmt.Registry) error {

	return nil
}

// bindFieldManager binds and validates parameter FieldManager from query.
func (o *PatchBatchV2alpha1NamespacedCronJobParams) bindFieldManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobParams) validateFieldManager(formats strfmt.Registry) error {

	return nil
}

// bindForce binds and validates parameter Force from query.
func (o *PatchBatchV2alpha1NamespacedCronJobParams) bindForce(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobParams) validateForce(formats strfmt.Registry) error {

	return nil
}

// bindName binds and validates parameter Name from path.
func (o *PatchBatchV2alpha1NamespacedCronJobParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobParams) validateName(formats strfmt.Registry) error {

	return nil
}

// bindNamespace binds and validates parameter Namespace from path.
func (o *PatchBatchV2alpha1NamespacedCronJobParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobParams) validateNamespace(formats strfmt.Registry) error {

	return nil
}

// bindPretty binds and validates parameter Pretty from query.
func (o *PatchBatchV2alpha1NamespacedCronJobParams) bindPretty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PatchBatchV2alpha1NamespacedCronJobParams) validatePretty(formats strfmt.Registry) error {
