...
type DeleteBatchV2alpha1NamespacedCronJobHandlerFunc func(DeleteBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteBatchV2alpha1NamespacedCronJobHandlerFunc) Handle(params DeleteBatchV2alpha1NamespacedCronJobParams, principal interface{}) middleware.Responder {
...
type DeleteBatchV2alpha1NamespacedCronJobHandler interface {
	Handle(DeleteBatchV2alpha1NamespacedCronJobParams, interface{}) middleware.Responder
}
