...
type GetSettingsAPIGroupHandlerFunc func(GetSettingsAPIGroupParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetSettingsAPIGroupHandlerFunc) Handle(params GetSettingsAPIGroupParams, principal interface{}) middleware.Responder {
...
type GetSettingsAPIGroupHandler interface {
	Handle(GetSettingsAPIGroupParams, interface{}) middleware.Responder
}
