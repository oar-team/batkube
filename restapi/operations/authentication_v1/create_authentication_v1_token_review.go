...
type CreateAuthenticationV1TokenReviewHandlerFunc func(CreateAuthenticationV1TokenReviewParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateAuthenticationV1TokenReviewHandlerFunc) Handle(params CreateAuthenticationV1TokenReviewParams, principal interface{}) middleware.Responder {
...
type CreateAuthenticationV1TokenReviewHandler interface {
	Handle(CreateAuthenticationV1TokenReviewParams, interface{}) middleware.Responder
}
